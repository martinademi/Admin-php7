...
$(document).ready(function () {
    ...
    var CURRENT_URL_split = CURRENT_URL.replace('http:', '');
    console.log('CURRENT_URL_split', CURRENT_URL_split);
    var current_menu = $SIDEBAR_MENU.find('a[href="' + CURRENT_URL_split + '"]').parent("li");
    console.log(current_menu);
    var minus_height = $(current_menu).offset().top - 302;
    if (minus_height < 0) {
        var sub_current_menu = $SIDEBAR_MENU.find('a[href="' + CURRENT_URL_split + '"]').closest(".child_menu");
        minus_height = $('.current-page').offset().top - 302;
        console.log(minus_height);
    }
    console.log(minus_height);
    $('.leftSideMenu').animate({
        scrollTop: minus_height
    }, 800, function () {
