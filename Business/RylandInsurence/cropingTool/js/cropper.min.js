...
//    var contWdt = $('.img-container').width();
    ...
    v.prototype = {
        ...
        init: function () {
            ...
            if (i.is("img")) {
                ...
                i.is("canvas") && ft && (t = i[0].toDataURL());
            this.load(t)
        },
        ...
        cropStart: function (i) {
            ...
            if (!this.isDisabled) {
                if (h) {
                    if (e = h.length, e > 1) {
                        if (!a.zoomable || !a.zoomOnTouch || 2 !== e)
                            return;
        ...
        cropMove: function (t) {
            ...
            if (!this.isDisabled) {
                if (a) {
                    if (i = a.length, i > 1) {
                        if (!e.zoomable || !e.zoomOnTouch || 2 !== i)
                            return;
            ...
            switch (!o && t && (o = l && c ? l / c : 1), this.limited && (m = p.minLeft, v = p.minTop, w = m + wt(n.width, r.left + r.width), x = v + wt(n.height, r.top + r.height)), s = {
                ...
                case rt:
                    if (o) {
                        ...
                        s.x >= 0 ? w > u ? l += s.x : s.y <= 0 && v >= g && (C = !1) : l += s.x, s.y <= 0 ? g > v && (c -= s.y, g += s.y) : (c -= s.y, g += s.y);
                ...
                case pt:
                    if (o) {
                        ...
                        s.x <= 0 ? d > m ? (l -= s.x, d += s.x) : s.y <= 0 && v >= g && (C = !1) : (l -= s.x, d += s.x), s.y <= 0 ? g > v && (c -= s.y, g += s.y) : (c -= s.y, g += s.y);
                ...
                case nt:
                    if (o) {
                        ...
                        s.x <= 0 ? d > m ? (l -= s.x, d += s.x) : s.y >= 0 && f >= x && (C = !1) : (l -= s.x, d += s.x), s.y >= 0 ? x > f && (c += s.y) : c += s.y;
                ...
                case ht:
                    if (o) {
                        ...
                        s.x >= 0 ? w > u ? l += s.x : s.y >= 0 && f >= x && (C = !1) : l += s.x, s.y >= 0 ? x > f && (c += s.y) : c += s.y;
