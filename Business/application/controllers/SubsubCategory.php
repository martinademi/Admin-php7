...
class SubsubCategory extends CI_Controller {
    ...
    public function getProductsBySerach(){
      ...
      public function subSubCategory( $params = '' , $id = '') {
        ...
        $this->table->set_heading('SL NO', 'IMAGE', 'SUB-SUBCATEGORY NAME','DESCRIPTION', 'SORT','ACTION');
    ...
    public function operationSubSubCategory($param = '',$status = ''){      
        
       
        switch ($param) {
     
         case 'delete':$this->SubsubCategorymodal->deleteCategory();
                break;
        case 'active': $this->SubsubCategorymodal->activeCategory($status);
                break;
        }
    }
