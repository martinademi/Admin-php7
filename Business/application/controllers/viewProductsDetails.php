<script src="https://superadmin.deliv-x.com/vendors/bootstrap/dist/js/bootstrap-multiselect.js"></script>
<link href="https://superadmin.deliv-x.com/vendors/bootstrap/dist/css/bootstrap-multiselect.css" rel="stylesheet">
...
//                    console.log(z);
                    ...
                    var divElement1 = '<div class="customPriceField row"><div class="form-group pos_relative2 customPriceField' + z + '">'
                            ...
                            + '<input type="text" name="units[' + z + '][name][en]" value="' + row.name.en + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title" disabled>'
                            + '</div>'
                            + ' <div class="col-sm-3 pos_relative2">'
                            + ' <span  class="abs_text"><b>$</b></span>'
                            + ' <input type="text" name="units[' + z + '][price][en]" value="' + row.price.en + '"  class="form-control productValue" id="value' + z + '" placeholder="Enter value" onkeypress="return isNumberKey(event)" disabled>'
                            + ' </div>'
                            + '<div class=""></div>'
                            + '</div>'
                            + '<?php
foreach ($language as $val) {
    if ($val["Active"] == 1) {
        ?>'
                                    ...
                                    + '<div class="col-sm-3 pos_relative2">'
                                    + '<span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>'
                                    + '<input type="text" name="units[' + z + '][name][<?php echo $val['langCode']; ?>]" value="' + row.name.<?php echo $val['langCode']; ?> + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title" disabled>'
                                    + '</div>'
                                    + ' <div class="col-sm-3 pos_relative2">'
                                    + ' <span  class="abs_text"><b>$</b></span>'
                                    + ' <input type="text" name="units[' + z + '][price][<?php echo $val['langCode']; ?>]" value="' + row.price.<?php echo $val['langCode']; ?> + '" class="form-control productValue" id="value' + z + '" placeholder="Enter value" onkeypress="return isNumberKey(event)" disabled>'
                                    + ' </div>'
                                    + '<div class=""></div>'
                                    + '</div>'
                                    + '<?php } else { ?>'
...
//                    console.log(k);
                    var divElement = '<div class="form-group pos_relative2 imageTag">'
                            ...
                            + '<input type="file" name="imageupload" attrId="' + k + '" class="form-control imagesProduct" disabled>'
...
<div class="page-content-wrapper">
    ...
    <ul class="breadcrumb" style="margin-left: 0px; margin-top: 5%;">
        <li><a
                href="<?php echo base_url(); ?>index.php?/GridProduct_controller"
                class="">PRODUCTSD</a></li>

        <li style="width: 100px"><a href="#" class="active">VIEW</a>
        </li>
                    ...
                    <ul class="navbar-nav navbar-left nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" id="mytabss" style=" -webkit-transition: top .5s; transition: top .5s;">
                        ...
                        <li>
                            <a class="" data-toggle="tab" role="tab" href="#tab5" >
                                <span>ADDITIONAL DETAILS</span></a>
                        </li>
						

                    </ul>
					<button class="btn btn-success editbutton pull-right" type="button" onclick="editredirect()"><span>EDIT</button>
                            ...
                            <section class="" id="tab1">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="name_0" name="productName[0]"
                                                   required="required" value="<?php echo $productsData['productName'][0]; ?>" class="form-control" disabled>
                                        ...
                                        <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="name_<?= $val['lan_id'] ?>" name="productName[<?= $val['lan_id'] ?>]"
                                                          value="<?php echo $productsData['productName'][$val['lan_id']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="category" name="firstCategoryId"  class="form-control error-box-class" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="subCategory" name="secondCategoryId"  class="form-control error-box-class" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="subSubCategory" name="thirdCategoryId"  class="form-control error-box-class" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="barcode" name="barcode"
                                                   required="required" value="<?php echo $productsData['barcode']; ?>" class="form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="shortDescription" name="shortDescription[0]" value="<?php echo $productsData['shortDesc'][0]; ?>" 
                                                   required="required" class="error-box-class  form-control" disabled>
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="shortDescription" name="shortDescription[<?= $val['lan_id']; ?>]"
                                                           value="<?php echo $productsData['shortDesc'][$val['lan_id']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <textarea id="detailedDescription" name="detailedDescription[0]" value="<?php echo $productsData['detailedDesc'][0]; ?>" 
                                                      required="required" class="error-box-class  form-control" style=" max-width: 100%;" disabled><?php echo $productsData['detailedDesc'][0]; ?></textarea>
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <textarea id="detailedDescription" name="detailedDescription[<?= $val['lan_id']; ?>]"
                                                              value="<?php echo $productsData['detailedDesc'][$val['lan_id']]; ?>"  required="required" class="error-box-class  form-control" style=" max-width: 100%;" disabled><?php echo $productsData['detailedDesc'][$val['lan_id']]; ?></textarea>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="manufacturer" name="manufacturer"  class="form-control error-box-class" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="brand" name="brand" class="form-control error-box-class" disabled>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="multiselect sizeMultiSelect">
                                                <div class="selectBox" style="width: 102%;">
                                                    <select class="multiple form-control" id="sizeGroup" name="size[]" multiple="multiple" disabled>
                                                        <?php
                                                        $sizeIds = [];
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="multiselect">
                                                <div class="selectBox"  style="width: 102%;">
                                                    <select class="multiple form-control" name="color[]" multiple="multiple" disabled>
                                                        <?php
                                                        $colorIds = [];
...
//                                                console.log(select);
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="POSName" name="POSName[<?= $val['lan_id']; ?>]"
                                                           value="<?php echo $productsData['pos'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="barcodeFormat" name="barcodeFormat"
                                                   required="required" class="form-control" value="<?php echo $productsData['barcodeFormat']; ?>" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="THC" name="THC" onkeypress="return isNumberKey(event)" value="<?php echo $productsData['THC']; ?>" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="CBD" name="CBD" onkeypress="return isNumberKey(event)" value="<?php echo $productsData['CBD']; ?>" disabled>
                                        </div>
                            ...
                            <section class="" id="tab3">
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="relaxed" value="<?php echo $productsData['strainEffects']['relaxed']; ?>" name="strainEffects[relaxed]" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="happy" name="strainEffects[happy]" value="<?php echo $productsData['strainEffects']['happy']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="euphoric" name="strainEffects[euphoric]" value="<?php echo $productsData['strainEffects']['euphoric']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="uplifted" name="strainEffects[uplifted]" value="<?php echo $productsData['strainEffects']['uplifted']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="creative" name="strainEffects[creative]" value="<?php echo $productsData['strainEffects']['creative']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="stress" name="medicalAttributes[stress]" value="<?php echo $productsData['medicalAttributes']['stress']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="depression" name="medicalAttributes[depression]" value="<?php echo $productsData['medicalAttributes']['depression']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="pain" name="medicalAttributes[pain]" value="<?php echo $productsData['medicalAttributes']['pain']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="headaches" name="medicalAttributes[headaches]" value="<?php echo $productsData['medicalAttributes']['headaches']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="fatigue" name="medicalAttributes[fatigue]" value="<?php echo $productsData['medicalAttributes']['fatigue']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="dryMouth" name="negativeAttributes[dryMouth]" value="<?php echo $productsData['negativeAttributes']['dryMouth']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="CBD" name="negativeAttributes[dryEyes]" value="<?php echo $productsData['negativeAttributes']['dryEyes']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="anxious" name="negativeAttributes[anxious]" value="<?php echo $productsData['negativeAttributes']['anxious']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="paranoid" name="negativeAttributes[paranoid]" value="<?php echo $productsData['negativeAttributes']['paranoid']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <span  class="abs_text"><b>%</b></span>
                                            <input type="text" class="form-control" id="dizzy" name="negativeAttributes[dizzy]" value="<?php echo $productsData['negativeAttributes']['dizzy']; ?>" onkeypress="return isNumberKey(event)" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" class="form-control" id="flavour1" name="flavours[flavour1]" value="<?php echo $productsData['flavours']['flavour1']; ?>" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" class="form-control" id="flavour2" name="flavours[flavour2]" value="<?php echo $productsData['flavours']['flavour2']; ?>" disabled>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" class="form-control" id="flavour3" name="flavours[flavour3]" value="<?php echo $productsData['flavours']['flavour3']; ?>" disabled>
                                        </div>
                                ...
                                <div class="row row-same-height">
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="ingredients_<?php echo $val['langCode']; ?>" name="ingredients[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['ingredients'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="upc_<?php echo $val['langCode']; ?>" name="upcName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['upcName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="mpn_<?php echo $val['langCode']; ?>" name="mpnName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['mpnName'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="model_<?php echo $val['langCode']; ?>" name="modelName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['modelName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomShelfLife_<?php echo $val['langCode']; ?>" name="uomShelfLife[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['uomShelfLife'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="UOMstorageTemperature_<?php echo $val['langCode']; ?>" name="UOMstorageTemperature[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['UOMstorageTemperature'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="warningName_<?php echo $val['langCode']; ?>" name="warningName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['warningName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="allergyInfo_<?php echo $val['langCode']; ?>" name="allergyInfo[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['allergyInfo'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerCalories" name="nutritionFactsInfo[servingPerCalories][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerCalories']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerCalories_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerCalories][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerCalories'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomCholesterol" name="nutritionFactsInfo[uomCholesterol][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomCholesterol']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomCholesterol_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomCholesterol][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomCholesterol'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerCholesterol" name="nutritionFactsInfo[servingPerCholesterol][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerCholesterol']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerCholesterol_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerCholesterol][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerCholesterol'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerFatCalories" name="nutritionFactsInfo[servingPerFatCalories][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerFatCalories']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerCholesterol_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerFatCalories][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerFatCalories'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomFibre" name="nutritionFactsInfo[uomFibre][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomFibre']['en']; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomFibre_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomFibre][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomFibre'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerFibre" name="nutritionFactsInfo[servingPerFibre][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerFibre']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerFibre_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerFibre][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerFibre'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomSodium" name="nutritionFactsInfo[uomSodium][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomSodium']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomSodium_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomSodium][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomSodium'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="sodiumPerServing" name="nutritionFactsInfo[sodiumPerServing][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['sodiumPerServing']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="sodiumPerServing_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[sodiumPerServing][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['sodiumPerServing'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomProtein" name="nutritionFactsInfo[uomProtein][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomProtein']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomProtein_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomProtein][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomProtein'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerProtein" name="nutritionFactsInfo[servingPerProtein][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerProtein']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerProtein_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerProtein][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerProtein'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomTotalFat" name="nutritionFactsInfo[uomTotalFat][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomTotalFat']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomTotalFat_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomTotalFat][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomTotalFat'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerTotalFat" name="nutritionFactsInfo[servingPerTotalFat][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerTotalFat']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerTotalFat_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerTotalFat][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerTotalFat'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="uomTransFat" name="nutritionFactsInfo[uomTransFat][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['uomTransFat']['en']; ?>" required="required" class="error-box-class  form-control" disabled> 
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="uomTransFat_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[uomTransFat][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['uomTransFat'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="servingPerTransFat" name="nutritionFactsInfo[servingPerTransFat][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['servingPerTransFat']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="servingPerTransFat_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[servingPerTransFat][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['servingPerTransFat'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="cholesterolDVP" name="nutritionFactsInfo[cholesterolDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['cholesterolDVP']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="cholesterolDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[cholesterolDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['cholesterolDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="calciumDVP" name="nutritionFactsInfo[calciumDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['calciumDVP']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="calciumDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[calciumDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['calciumDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="ironDVP" name="nutritionFactsInfo[ironDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['ironDVP']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="ironDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[ironDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['ironDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="sodiumDVP" name="nutritionFactsInfo[sodiumDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['sodiumDVP']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="sodiumDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[sodiumDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['sodiumDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="saturatedFatDVP" name="nutritionFactsInfo[saturatedFatDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['saturatedFatDVP']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="saturatedFatDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[saturatedFatDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['saturatedFatDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="totalFatDVP" name="nutritionFactsInfo[totalFatDVP][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['totalFatDVP']['en']; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="totalFatDVP_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[totalFatDVP][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['totalFatDVP'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="vitaminADvp" name="nutritionFactsInfo[vitaminADvp][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['vitaminADvp']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="vitaminADvp_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[vitaminADvp][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['vitaminADvp'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="vitaminCDvp" name="nutritionFactsInfo[vitaminCDvp][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['vitaminCDvp']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="vitaminCDvp_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[vitaminCDvp][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['vitaminCDvp'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="vitaminDDvp" name="nutritionFactsInfo[vitaminDDvp][en]"
                                                   value="<?php echo $productsData['nutritionFactsInfo']['vitaminDDvp']['en']; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="vitaminDDvp_<?php echo $val['langCode']; ?>" name="nutritionFactsInfo[vitaminDDvp][<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['nutritionFactsInfo']['vitaminDDvp'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="containerName" name="containerName[en]"
                                                   value="<?php echo $productsData['containerName']['en']; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="containerName_<?php echo $val['langCode']; ?>" name="containerName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['containerName'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            ...
                                            <input type="text" id="containerPerServings" name="containerPerServings[en]"
                                                   value="<?php echo $productsData['containerPerServings']['en']; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="containerPerServings_<?php echo $val['langCode']; ?>" name="containerPerServings[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['containerPerServings'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="genreName_<?php echo $val['langCode']; ?>" name="genreName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['genreName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="labelName_<?php echo $val['langCode']; ?>" name="labelName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['labelName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="artistName_<?php echo $val['langCode']; ?>" name="artistName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['artistName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="actorName_<?php echo $val['langCode']; ?>" name="actorName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['actorName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="directorName_<?php echo $val['langCode']; ?>" name="directorName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['directorName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="featureName_<?php echo $val['langCode']; ?>" name="featureName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['featureName'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="publisherName_<?php echo $val['langCode']; ?>" name="publisherName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['publisherName'][$val['langCode']]; ?>"  required="required" class="error-box-class  form-control" disabled>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    ...
                                                    <input type="text" id="authorName_<?php echo $val['langCode']; ?>" name="authorName[<?= $val['langCode']; ?>]"
                                                           value="<?php echo $productsData['authorName'][$val['langCode']]; ?>" required="required" class="error-box-class  form-control" disabled>
