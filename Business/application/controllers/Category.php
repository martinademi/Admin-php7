    ...
    public function index() {
        if ($this->issessionset()) {
           ...
           // $this->table->set_heading('SL NO', 'IMAGE', 'CATEGORY NAME', 'STATUS', 'DESCRIPTION', 'SUBCATEGORY COUNT', 'SORT','ACTION','Select' );
            // removed $this->lang->line('col_select')
            $this->table->set_heading($this->lang->line('col_slno'),$this->lang->line('col_image'),$this->lang->line('col_catname'),
            $this->lang->line('col_description'),$this->lang->line('col_subcount'),$this->lang->line('col_sort'),
            $this->lang->line('col_action'));
    ...
    public function operationCategory($param = '', $status = '') {
        ...
        switch ($param) {
            ...
            case 'order': $this->Categorymodal->changeCatOrder($status);
                break;
            case 'active': $this->Categorymodal->activeCategory($status);
                break;
        }
    }
