...
//         $data['appConfig'] = $this->Superadminmodal->getAppConfig();
    ...
    public function getWalletForDriver() {
        ...
        $data['result'] = $this->Superadminmodal->getWalletForDriver();
    }
...
//        $this->table->set_heading('DRIVER TYPE', 'APP VERSION', 'DRIVER NAME', 'CITY','EMAIL','MOBILE NUMBER', 'VEHICLE TYPE', 'STORE/OPERATOR NAME', 'VEHICLES', 'VEHICLE PLATE NUMBER', 'PLAN NAME', 'REFERRAL CODE', 'RENEWAL DATE', 'AVERAGE RATING', 'CREDIT LINE', 'WALLET (SET LIMIT)', 'REJECTED ON', 'REGISTERED ON', 'CURRENT STATUS','LAST UPDATED LOCATION', 'SHIFT LOGS','REASON', 'BANNED ON','SELECT');
...
//        $data['cityForZones'] = $this->Superadminmodal->cityForZones();
    ...
    public function exportAccData($stdate = '', $enddate = '') {
        ...
        $data = $this->Superadminmodal->exportAccData($stdate, $enddate);
