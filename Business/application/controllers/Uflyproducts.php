...
//            exit;
    ...
    public function savealltext() {
        $data = $this->Uflyproductsmodal->savealltext();
...
//        echo json_encode($data); 
    ...
    public function uflyStoreProducts(){
        ...
        $this->table->set_template($tmpl);
        $this->table->set_heading('SL NO','Product Name','Category','SUB-Category','SUB-SUB Category','UNITS','Sort','select');
