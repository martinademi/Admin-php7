...
//Database Name
$config['default']['mongo_database'] = 'Instacart';               //'Menuse';

//DB Username - by default, it is empty
$config['default']['mongo_username'] = 'Instacartdblocal';               //'Menuzedbserver';

//DB Password - by default, it is empty
$config['default']['mongo_password'] = '3LsGUmRrWaneXL';
...
//$config['mongo_db'] = "db_Ryland_Insurence";
//
