...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo ServiceLink ; ?>theme/icon/delivxlogoflexy.png" />
      ...
      window.onload = function ()
               ...
               function VerifyNsendLink()
            {
                ...
                } else
                {
                    ...
                    $.ajax({
                        url: "<?php echo APILink ?>storeadmin/forgotPassword",
                        type: 'POST',
                        data: {"emailOrMobile": resetemail, 'verifyType': 2},
                        datatype: "JSON",
                        beforeSend: function(xhr){xhr.setRequestHeader('language', 'en');},
    ...
    <body>
        ...
        <div class="login-wrapper">
            ...
            <div class="bg-pic">
                ...
                <img src="<?php echo ServiceLink ?>theme/icon/delivx.png" data-src="<?php echo ServiceLink ?>theme/icon/delivx.png" data-src-retina="<?php echo ServiceLink ?>theme/icon/delivx.png" alt="">
            ...
            <div class="login-container">
                ...
                <img src="<?php echo ServiceLink ?>theme/icon/delivxlogin.png" style="width:50%;height:auto !important; margin-left:25%;padding-bottom: 25px"/>
                    <div class="loginDetails loginForm col-xs-12">
                        <form id="submitForLogin" method="post" action="<?php echo base_url() ?>index.php?/Business/AuthenticateUser" onsubmit= "return submitLogin();">
