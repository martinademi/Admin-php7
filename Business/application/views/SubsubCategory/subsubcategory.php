...
//                            $('#EditcatDescription').val(row.description);
        ...
        $(document).on('click', '#btndelete', function () {
            ...
            val=delCatid;
            $.ajax({
                        url: "<?php echo base_url('index.php?/SubsubCategory') ?>/operationSubSubCategory/delete",
                        type: "POST",
                        data: {val: val},
                        dataType: 'json',
                        success: function (response)
        ...
        $('#confirmActive').click(function(){
            val=delCatid;
            $.ajax({
                    url: "<?php echo base_url('index.php?/SubsubCategory') ?>/operationSubSubCategory/active",
                    type: "POST",
                    data: {val: val},
                    dataType: 'json',
                    success: function (response)
    ...
    <div class="content">
        ...
        <ul class="nav nav-tabs  bg-white whenclicked">
            ...
            <li id= "2" class="tabs_active" style="cursor:pointer">
                <a   class="changeMode" data="index.php?/SubsubCategory/datatable_subsubcategory/<?php echo $bid; ?>/2" data-id="2"><span><?php echo 'Deleted'; ?></span></a>
            </li>
