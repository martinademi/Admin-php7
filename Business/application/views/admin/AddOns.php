...
//        $('.icon-thumbnail').attr('<?php echo base_url(); ?>assets/dash_board_on.png"');
    ...
    function Delservice(thisval) {
        ...
        $("#deletelink").attr('href', "<?php echo base_url() ?>index.php/Admin/DeleteAddOnCat/" + entityidid);
    }
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            ...
            <div class="add_new">
                <a href="<?php echo base_url(); ?>index.php/Admin/AddNewAddOns"><button type="button" class="btn btn-primary" style="margin:0px;"> Add</button></a>               
            </div>
                                            ...
                                            foreach ($entitylist as $result) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td  class="v-align-middle">
                                                        <div class="btn-group">
                                                            <a href="<?php echo base_url() . 'index.php/Admin/EditAddon/' . $result['_id']; ?>"><button id="<?php echo $result['_id'] ?>" type="button" style="color: #ffffff !important;background-color: #5bc0de;border: 1px solid #5bc0de;" class="btn btn-success"><i class="fa fa-pencil"></i>
                                                                </button></a>
