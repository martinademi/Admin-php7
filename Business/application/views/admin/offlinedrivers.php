...
//        alert(status);
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php // echo base_url() ?>index.php/superadmin/datatable_users',
            "bJQueryUI": true,
...
//            }
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/Business') ?>/validateEmail_driver",
            type: "POST",
...
//            var accepts_1 = $("#accepts_1").val();
//            var accepts_2 = $("#accepts_2").val();
//            var accepts_3 = $("#accepts_3").val();
...
//                 alert(val);
                ...
                if (size == "mini")
                {
                    $('#modalStickUpSmall').modal('show')
                      ...
                      $.ajax({
                               url: "<?php echo base_url('index.php/Business') ?>/get_driverdata",
                               type: "POST",
                                data: {val: val},
                                dataType: 'json',
...
//                                      alert(row.Email);
                                                ...
                                                $('#Username').val(response.DriverName);
...
//            $("#display-data").text("");
            ...
            //                        else if (confirm("Are you sure to Delete this company")) {
                                      ...
                                      $.ajax({
                                           url: "<?php echo base_url('index.php/Business') ?>/delete_Driver",
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content" style="  padding-top: 30px;">
        ...
        <div class="brand inline breadcrumb" style="">
            <strong>OFFLINE DRIVERS</strong><!-- id="define_page"-->
        </div>
        <!-- Nav tabs -->
         <!--<ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked" style="margin-bottom:20px;">
...
//                            
                              ?>
                                    <tr>
                                        ...
                                        <td><?php echo (string)$result['Drseq'];?></td>
...
<div class="modal fade stick-up" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">                  
                    ...
                    <form id="addentity" method="post" class="" role="form" action="<?php echo base_url('index.php/Business') ?>/insertoffdrivr"  method="post" enctype="multipart/form-data">
                    
                     
                     <div class="form-group" class="formex">

                        <div class="frmSearch">
                            <label for="fname" class="col-sm-4 control-label">DRIVER NAME<span style="color:red;font-size: 18px">*</span></label>
                            <div class="col-sm-8">
...
<div class="modal fade stick-up" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editentity" method="post" class="" role="form" action="<?php echo base_url('index.php/Business') ?>/editofflinedriver"  method="post" enctype="multipart/form-data">
...
<div class="modal fade stick-up" id="ChangeModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
            <form id="changepassword" method="post" class="" role="form" action="<?php echo base_url('index.php/Business') ?>/change_password"  method="post" enctype="multipart/form-data">
