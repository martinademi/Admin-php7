...
<div class="page-content-wrapper"style="padding-top: 20px">
    ...
    <div class="content" >
        ...
        <!-- id="define_page"-->
        <div class="brand inline" style="  width: auto;">
            <?php echo $this->lang->line('heading_StoreCustomers'); ?>
        </div>
        ...
        <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
            ...
            <li id="4" class="tabs_active <?php echo ($status == 0 ? "active" : ""); ?>" style="cursor:pointer">
                <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/StoreCustomer/dt_passenger/0"><span><?php echo $this->lang->line('heading_addedByStores'); ?> </span> <span class="badge addedbystore" style="background-color:#3CB371;"></span></a>
            </li>
                        ...
                        <div class="col-xs-12 container-fixed-lg bg-white">
                            ...
                            <div class="row panel panel-transparent">
                                <div class="panel-heading">
                                    ...
                                    <div class="searchbtn clearfix pull-right" >

                                        <div class="col-xs-12 pull-right"><input type="text" id="search-table" class="form-control pull-right"  placeholder="Search"> </div>
                                    </div>
