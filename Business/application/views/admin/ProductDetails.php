...
//        alert('Loading');
        ...
        if (SubCategoryId != '') {
            ...
            $('#SubCategory').load('<?php echo base_url() ?>index.php/Admin/GetSubCatfromCat', {catId: catid, SubCat: SubCategoryId});
        }
        $('#CategoryId').change(function () {
             ...
             var catId = $(this).val();
//            alert(catId);
            $('#SubCategory').load('<?php echo base_url() ?>index.php/Admin/GetSubCatfromCat', {catId: catId});
        });
...
//                alert("Mandatory Fields Missing")
    ...
    function movetonext()
    {
        console.log($("#firstlitab").attr('class'));
        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            <div class="inner">
                ...
                <ul class="breadcrumb" style="">
                    ...
                    <li><a class="active" href="<?php echo base_url() ?>index.php/Admin/Products">PRODUCTS</a>
                    </li>
                                                    ...
                                                    <div class="portfolio-group">
                                                     <a onclick="openFileUpload(this)" id='1' style="cursor: pointer;">
                                                        ...
                                                        if ($ProductDetails['Masterimageurl']['Url'] == '') {
                                                            echo '  <img src="http://54.174.164.30/Tebse/Business/addnew.png" onerror="if (this.src != \'error.jpg\') this.src = \'http://54.174.164.30/Tebse/Business/addnew.png\';" id="MainImageUrl" style="width:14% ;height: 25%;">';
                                                        } else {
                                        ...
                                        <div class="col-sm-4">
                                            <select class="error-border1 form-control" id="CategoryId" name="FData[CategoryId]" required>
                                                ...
                                                foreach ($AllCats as $Cats) {
                                                    ...
                                                    echo '<option value = "' .  $Cats['_id']['$oid'] . '">' . implode($Cats['Category'],',') . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
