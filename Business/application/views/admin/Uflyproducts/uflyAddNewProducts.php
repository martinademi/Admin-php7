                            ...
                            <section class="" id="tab1">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label error-box-class ">Name (English)<span style="" class="MandatoryMarker"> *</span></label>
                                    ...
                                    <div class="customField row">
                                        ...
                                        <div class="form-group pos_relative2">
                                            ...
                                            <div class="col-sm-3 pos_relative2">
                                                ...
                                                <input type="text" name="units[0][title]" class="error-box-class  form-control productTitle" id="title0"  placeholder="Text Element ">
                                            </div>
                                            <div class="col-sm-3 pos_relative2">
                                                <span  class="abs_text"><b><?php echo $currencySymbol; ?></b></span>
                                                <input type="text" name="units[0][value]" class="error-box-class  form-control productValue" id="value0" placeholder="Value of text element "  onkeypress="return isNumberKey(event)">
                                            </div>
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="imagesField row">
                                        <div class="form-group pos_relative2">
                                            ...
                                            <div class="col-sm-6 pos_relative2">
                                                <input type="file" name="imageupload" class="error-box-class form-control imagesProduct" id="tb1" attrId="0" value="Text Element 1">
                                            </div>
