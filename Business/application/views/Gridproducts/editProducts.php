                                ...
                                <div class="row row-same-height">
                                 ...
                                 <?php if($storeType == "6" || $storeType == 6){?>
                                     ...
                                     <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo "Rx Mandatory"; ?></label>
                                    ...
                                    <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo "Sold Online"; ?></label>
                                        <div class="col-sm-2 pos_relative2">
                                       ...
                                       <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo "Prescription Required"; ?></label>
                                        <div class="col-sm-2 pos_relative2">
											<label for="soldOnline" class="col-sm-1 control-label"><?php echo "Yes"; ?></label>
                                    ...
                                    <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo "Product Type"; ?></label>
                                        <div class="col-sm-2 pos_relative2">
                                        ...
                                        <div class="col-sm-6 pos_relative2">
                                            <select id="category" name="firstCategoryId"  class="form-control error-box-class">
                                               ...
                                               foreach ($category as $result) {
                                                ...
                                                //             echo "<option selected value=" . $result['categoryId'] . "  data-name='" . $result['name'][0] . "'>" . $result['name'][0] . "</option>";
												// 			}else{
												// 				echo "<option  value=" . $result['categoryId'] . "  data-name='" . $result['name'][0] . "'>" . $result['name'][0] . "</option>";
												// 			}
                                                //         }
                                                //     }
                                                //     else{
                                                ...
                                                //            }
                                                //             if($productsData['firstCategoryId'] ==  $result['categoryId'] ){
                                                //         echo "<option selected value=" . $result['categoryId'] . "  data-name='" .  $catData . "'>" . $catData . "</option>";
												// 			}else{
...
//                                                console.log(select);
    ...
    <?php } else { ?>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label id="addOn-error" class="error" style="display:none">This field is required.</label>
                                </div>
                                <div class="col-sm-3 error-box" id="colorsErr"></div>
                        ...
                        <?php if($storeType == "6" || $storeType == 6){?>
                                   <!--Pharmacy  -->
                                   <div class="form-group required" >
                                <label class="col-sm-2 control-label">Symtoms</label>
                                <div class="col-sm-6">
                                    <div class="multiselect">
                                        <div class="selectBox"  style="width: 102%;">
                             ...
                             <div class="form-group required" >
                                <label class="col-sm-2 control-label">Selective Generic</label>
                                <div class="col-sm-6">
                                    <div class="multiselect">
                                        <div class="selectBox"  style="width: 102%;">
                         ...
                         <div class="form-group required" >
                                <label class="col-sm-2 control-label">Selective Branded</label>
                                <div class="col-sm-6">
                                    <div class="multiselect">
                                        <div class="selectBox"  style="width: 102%;">
