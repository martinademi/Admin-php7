...
//            }
            ...
            d.setMonth(d.getMonth()+mon);
                    ...
                    console.log(dformat);
                        ...
                        $(document).ready(function () {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryschduled/datatable_getProviderDetails/'+status+'/'+offset,
                                "bJQueryUI": true,
    ...
    // without second
            ...
            //    return;
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryschduled/addSchduled",
                    type: "POST",
                    data: {
                        //BusinessId:fid,
                        stTime:stTime,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryschduled/datatable_getProviderDetails/1/'+offset,
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            ...
            <strong style="font-size: 12px;margin-left: 15px;">DELIVERY SLOTS</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                        <li id= "1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?>" style="cursor:pointer">
                            <a class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/1" data-id="1"><span>ACTIVE</span><span class="badge createdSchedule" style="background-color: #5bc0de;"></span></a>
                        </li>
                        <li id= "2" class="tabs_active <?php echo ($status == 2 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/2" data-id="2"><span>EXPIRED</span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                        </li>
                        <li id= "3" class="tabs_active <?php echo ($status == 3 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/3" data-id="3"><span>DELETED</span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                        </li>
