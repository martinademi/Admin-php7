    ...
    function dateTimeReturn(month,stTime){
        ...
        var d = new Date,
                    ...
                    ' ' +stTime;
                        ...
                        $(document).ready(function () {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Schduled/datatable_getProviderDetails/'+status,
                                "bJQueryUI": true,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Schduled/datatable_getProviderDetails/1',
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
//                  $('#big_table_processing').hide();
        ...
        $('.changeMode').click(function () {
            ...
            {
               targetUrl = "<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/1" ;
            } else if($(this).attr('data-id') == 2) {
                targetUrl = "<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/2" ;
            }
            else{
                targetUrl = "<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/3" ;
            }
...
<div class="modal fade stick-up" id="confirmModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal fade stick-up" id="slotData" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
