...
//            }
    ...
    function dateTimeReturn(month,stTime){
        ...
        $('#addSlot').click(function(){
            ...
            var sTime = $('#startTimeSlot').val();
            var eTime = $('#endTimeSlot').val();
        ...
        $("#insert_cat_group").click(function () {
            ...
            //     var returnval = len > 0 ? new Array(len).join(chr || '0') + this : this;
           ...
           // console.log("offset",offset);
            ...
            //    console.log("start date=",startDate,"end date=",endDate,"startTime=",startTime,"endTime=",endTime,"deviceTime=",deviceTime,"days=",day,"duration=",duration, "notes=",notes)
            //    return;
                $.ajax({
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <!-- <div class="brand inline" style="  width: auto; margin-top: 60px;">
            <strong style="font-size: 12px;margin-left: 15px;">WORKING HOURS</strong>
        </div> --><!-- id="define_page"-->

        <div class="brand inline" style="  width: auto;">
            <?php echo $this->lang->line('working_hour'); ?>
        </div>
            ...
            <div class="hide_show">
                ...
                <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                        <li id= "1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?>" style="cursor:pointer">
                            <a class="changeMode" data="<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/1" data-id="1"><span> <?php echo $this->lang->line('ACTIVE'); ?></span><span class="badge createdSchedule" style="background-color: #5bc0de;"></span></a>
                        </li>
                        <li id= "2" class="tabs_active <?php echo ($status == 2 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/2" data-id="2"><span> <?php echo $this->lang->line('EXPIRED'); ?></span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                        </li>
                        <li id= "3" class="tabs_active <?php echo ($status == 3 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Schduled/datatable_getProviderDetails/3" data-id="3"><span> <?php echo $this->lang->line('DELETED'); ?></span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                        </li>

                          <div class="">
                            <button class="btn btn-info" type="button" id="AddSchedule" style="float:right;margin-top: 7px;"> <?php echo $this->lang->line('Add'); ?></button>
                        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 bg-white">
                ...
                <div class="panel panel-transparent ">
                    ...
                    <div class="tab-content">
                         ...
                         <div class="pull-right hide_show" ><input type="text" id="search-table1" class="form-control pull-right" placeholder="Search" style="display: block;margin-right: 15px;margin-top: 10px;width: 140px;border-radius:0px"> </div> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="col-sm-8" > 
                    <div class="pull-right m-t-10"> <button type="button" data-dismiss="modal" class="btn btn-default btn-cons" id="cancel"> <?php echo $this->lang->line('Close'); ?></button></div>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
...
<div class="modal fade stick-up" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <span class="modal-title" > <?php echo $this->lang->line('ADD_SCHEDULE'); ?></span>
            </div>
            <div class="modal-body">
                <form action="" method="post"  data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group" class="formex">
                        <label for="fname" class="col-sm-4 control-label"> <?php echo $this->lang->line('Repeat_Schedule'); ?><span style="color:red;font-size: 12px"> *</span></label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <select onchange="checkDays(this)" id="repeatDay" name="repeatDay"  class="form-control error-box-class">
                                <option value=0><?php echo $this->lang->line('Select_Schedule '); ?></option>
                                <option value=1> <?php echo $this->lang->line('Every_Day'); ?></option>
                                <option value=2> <?php echo $this->lang->line('Week_Day'); ?></option>
                                <option value=3> <?php echo $this->lang->line('Week_End'); ?></option>
                                <option value=4> <?php echo $this->lang->line('Select_Days'); ?></option>
                            </select>
                        </div>
                    ...
                    <div class="form-group" class="formex" id='bTypeBlock' style="display: none">
                        ...
                        <div class="col-md-6 col-sm-5 col-xs-12">
                            <label><input type="checkbox" class="messageCheckbox" id="Mon"  value="Mon" name="schedule[]">  <?php echo $this->lang->line('Mon'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Tue"  value="Tue" name="schedule[]">  <?php echo $this->lang->line('Tue'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Wed"  value="Wed" name="schedule[]">  <?php echo $this->lang->line('Wed'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Thu"  value="Thu" name="schedule[]">  <?php echo $this->lang->line('Thu'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Fri"  value="Fri" name="schedule[]">  <?php echo $this->lang->line('Fri'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Sat"  value="Sat" name="schedule[]">  <?php echo $this->lang->line('Sat'); ?></label>  &nbsp;
                            <label><input type="checkbox" class="messageCheckbox" id="Sun"  value="Sun" name="schedule[]">  <?php echo $this->lang->line('Sun'); ?></label>  &nbsp;
                        </div>
                    ...
                    <div class="form-group" class="formex">
                        <label for="fname" class="col-sm-4 control-label"> <?php echo $this->lang->line('Duration'); ?><span style="color:red;font-size: 12px"> *</span></label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <select onchange="checkDuration(this)" id="duration" name="duration"  class="form-control error-box-class">
                                <option value=0> <?php echo $this->lang->line('Select_Duration'); ?></option>
                                <option value=1> <?php echo $this->lang->line('This_Month'); ?></option>
                                <option value=2> <?php echo $this->lang->line('2_Months'); ?></option>
                                <option value=3> <?php echo $this->lang->line('3_Months'); ?></option>
                                <option value=4> <?php echo $this->lang->line('4_Months'); ?></option>
                                <option value=5> <?php echo $this->lang->line('Custom'); ?></option>
                            </select>
                        </div>
...
<!--</select><span  class='abs_text' id='sym1'>Hour<span>-->
            ...
            <div class="modal-footer">
                ...
                <div class="col-sm-4 error-box errors responseErr"></div>
                <div class="col-sm-8" >
                    <div class="pull-right m-t-10"> <button type="button" class="btn btn-primary pull-right" id="insert_cat_group" > <?php echo $this->lang->line('Add'); ?></button></div>
...
<div class="modal fade stick-up" id="addParticularSlot" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <span class="modal-title" > <?php echo $this->lang->line('ADD_PARTICULAR_TIME_SLOT'); ?></span>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                    ...
                    <button type="button"  class="btn btn-primary btn-cons" id="addSlot" style><?php echo $this->lang->line('Add'); ?></button>
                    <button type="button" data-dismiss="modal" class="btn btn-default btn-cons " id="cancel"><?php echo $this->lang->line('Close'); ?></button></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                    ...
                    <button type="button"  class="btn btn-primary btn-cons" id="yes" style> <?php echo $this->lang->line('Delete'); ?></button>
                    <button type="button" data-dismiss="modal" class="btn btn-default btn-cons " id="cancel"> <?php echo $this->lang->line('Close'); ?></button></div>
...
<div class="modal fade stick-up" id="showSlot" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <span class="modal-title" > <?php echo $this->lang->line('Show_Slot'); ?></span>
            </div>
            <div class="modal-body">
                <input type="hidden" id="slotId" value=''>
                <div class="form-group" class="formex" id=''>
                        <label for="date" class="col-sm-4 control-label"><?php echo $this->lang->line('Choose_Date '); ?><span style="color:red;font-size: 12px"> *</span></label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
            ...
            <div class="modal-footer">
                    <button type="button"  class="pull-left" id="doSearchAll" style="background: transparent;color: #2828da;border: none;"> <?php echo $this->lang->line('Show_All_Slots'); ?></button>
                    <button type="button"  class="btn btn-primary btn-cons" id="doSearch" style><?php echo $this->lang->line('Search'); ?></button>
                    <button type="button" data-dismiss="modal" class="btn btn-default btn-cons " id="cancel"><?php echo $this->lang->line('Close'); ?></button></div>
...
<div class="modal fade stick-up" id="slotData" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <span class="modal-title" > <?php echo $this->lang->line('Particular_Slots_Details'); ?></span>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                    ...
                    <button type="button"  class="btn btn-primary btn-cons" id="yesSlot" style> <?php echo $this->lang->line('Delete'); ?></button>
                    <button type="button" data-dismiss="modal" class="btn btn-default btn-cons " id="cancel"> <?php echo $this->lang->line('Close'); ?></button></div>
