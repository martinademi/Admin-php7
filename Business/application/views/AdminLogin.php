        ...
        <div class="login-wrapper ">
            ...
            <div class="login-container bg-white">
                <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                    <img src="http://54.174.164.30/Tebse/sadmin//theme/icon/website_yum_to_go_logo.png" alt="logo"  style="width: 100px; margin-left: 100px;">
                    <p class="p-t-35">Sign into your store  account </p>

                    <form id="form-login" class="p-t-15" role="form" action ="<?php echo base_url() ?>index.php?/Business/AuthenticateUser" onsubmit= "return validateForm();" method="post">
