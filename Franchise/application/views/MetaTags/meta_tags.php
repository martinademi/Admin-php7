...
//                $("#display-data").text(<?php // echo json_encode(POPUP_DELETE_DELETE_FRANCHISE);                                                       ?>);
                ...
                $.ajax({
                    ...
                    success: function (response)
                    {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/Metatags/datatable_Metatags/' + '<?php echo $mid; ?>'+'/'+'<?php echo $bid; ?>',
                            "bJQueryUI": true,
        ...
        $('#editbusiness').click(function () {
            ...
            form_data.append('value', $("#Editmetaname").val());
            form_data.append('type', $("#EditmetaId").val());

            form_data.append('editId', $("#editedId").val());
            if ($("#Editmetaname").val() == "" || $("#Editmetaname").val() == null) {
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-left: 8px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 16px;">Meta Tags</strong>
        </div>
        <!-- START BREADCRUMB -->
...
<?php if($bid !=''){?>
            <li>
                <a href="<?php echo base_url() ?>index.php?/SubCategory/SubCategory/<?php echo $mid;?>" class="active">
                    <?php
                    foreach ($businessTwo as $cat) {
                        if ((string) $cat['id'] == $bid) {
                            $catname = $cat['name'][0];
                        }
                    }
                    print_r($catname);
...
<?php } ?>
            ...
            <li style="width: 70%"><a href="<?php echo base_url() ?>index.php?/Metatags/meta_tags/<?php echo $mid; ?>/<?php echo $bid; ?>" class="active">
                    Metatag
                </a>
            </li>
            ...
            <div class="pull-right m-t-10"> <button class="btn btn-primary btn-cons pull-right" style="margin-top:0px;" id="btnStickUpSizeToggler">Add</button></div>                 
        </ul>
        <!-- END BREADCRUMB -->
