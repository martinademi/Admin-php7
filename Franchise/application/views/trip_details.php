                                    ...
                                    <div id="summernote">
                                           ...
                                           <div class="row">
                                                <div class="col-sm-12" style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">CUSTOMER DETAILS</a>
                                                    </p>
											...
											<div class="row">
                                                ...
                                                <div class="col-sm-6" >
                                                    ...
                                                    <p class="small"><?php echo ($data['res']['driverDetails']['fName'] == "" || $data['res']['driverDetails']['lName'] == "")?"N/A":$data['res']['driverDetails']['fName']." ".$data['res']['driverDetails']['lName']; ?></p> 
                                         ...
                                         <div class="row">
                                                <div class="col-sm-12" style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">ORDER DETAILS</a>
                                                    </p>
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <p class="small"><?php if($data['res']['serviceType'] == 1){ echo $data['res']['drop']['flatNumber'].' , '.$data['res']['drop']['addressLine1'].'<br/>'.$data['res']['drop']['addressLine2'].'<br> '.$data['res']['drop']['area'].' </br>'.$data['res']['drop']['city'].'<br> '.$data['res']['drop']['state'].'<br>'.$data['res']['drop']['country'].'<br>'.$data['res']['drop']['postalCode']; }else{ echo "N/A"; }?></p>
                                                    <span class="errors" id="receiverPhoneErr"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                <div class="col-sm-6" style="padding-left: 22px;">
                                                    ...
                                                    <p class="small"><?php echo $data['res']['bookingDate']; ?></p>
                                                    <span class="errors" id="slaveEmailErr"></span>
                                                </div>
                                                <div class="col-sm-6">
                                                    <!-- <p class="no-margin">
                                            ...
                                            foreach ($data['res']['activities'] as $resArray) {
                                                ...
                                                <?php } else { ?>
                                                    <div  class="activity_body">
                                                        ...
                                                        ?><span  class="activity_status_text col-lg-5"><?php echo date('M-d, Y, h:i:a ', $resArray['time']); ?></span></span>
                                                        <span  class="bullet_line"></span>
                                                    </div>
                                                    <?php
                                                }
									...
									<div class="row">
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                ...
                                                <div class="col-sm-6" style="padding-left: 22px;">
                                                    ...
                                                    <p class="small">
                                                     <?php echo $data['res']['timeStamp']['reached']['distance'].$data['res']['mileageMetric'];?>
											...
											<div class="row" style="margin-top: 3%;">
                                                ...
                                                <div class="col-sm-6" style="padding-left: 22px;">
                                                    ...
                                                    <p class="small">
                                                    <?php echo $data['res']['timeStamp']['arrived']['distance'].$data['res']['mileageMetric'];?>
											...
											<div class="row">
                                                ...
                                                <div class="col-sm-6" style="padding-left: 22px;" >
													...
													<?php if($data['res']['receivers']['signatureUrl'] == null || $data['res']['receivers']['signatureUrl'] == ""){ echo "N/A"; } else{?>
                                                        <img src="<?php echo $data['res']['receivers']['signatureUrl']; ?>" style="width: 45px;height:45px;" class="style_prevu_kit">
													<?php }?>
                                                    </p>
