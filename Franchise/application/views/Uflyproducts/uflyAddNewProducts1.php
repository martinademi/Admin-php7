        ...
        if(countPname>3){
            $.ajax({
                    ...
                    success: function (response)
                    {
                        ...
                        console.log('rel---',response.data.length)
    ...
    $("#productNameList").on('click', '.pData' , function () {
        ...
        $('#productNameList').hide();
             ...
             $.ajax({
                    ...
                    var dList=dataList.data;
                        ...
                        console.log('val---',dataList.data);
                       console.log('val---',dList.images[0].image);
                                ...
                                //  $('.imagesProduct').attr('src', dList.images[0].image);
                                //  $('.imagesProduct').show();
       ...
       $(document).on('change', '.productNameList', function () {
         ...
         $.ajax({
                   ...
                   url:   '<?php echo base_url(); ?>index.php?/AddNewProducts/getProductDataDetail/' + ProductId,
                   type: "GET",
                   data: '',                  
                   success: function (json,textStatus, xhr) {
                    var dataList=JSON.parse(json);
                    var dList=dataList.data;
                       ...
                       console.log('val---',dataList.data);
                                ...
                                $("#name_0").val(dList.productName[0]);
                                $("#shortDescription").val(dList.shortDesc[0]);
                                $("#detailedDescription").val(dList.detailedDesc[0]);


                                // loadCategory(response.categoryId);
                                // loadSubCategory(response.categoryId,response.subCategoryId);
                                // loadSubSubCategory(response.categoryId,response.subCategoryId,response.subSubCategoryId);
                                // loadManufacture(response.manufactureId);
                                // loadBrand(response.brandId);
...
<div class="page-content-wrapper">
    ...
    <ul class="breadcrumb" style="margin-left: 0px; margin-top: 5%;">
        <li><a href="<?php echo base_url(); ?>index.php?/AddNewProducts/FranchiseProducts" class=""><?php echo $this->lang->line('LIST_PRODUCTS'); ?></a></li>
                                ...
                                <?php } ?>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2  cls110"> 
                                                 <button class="btn btn-success pull-right m-t-10" id="btnStickUpSizeToggler" style="font-size: 10px;"><?php echo $this->lang->line('Add_Category'); ?></button>
                                             </div>           
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2  cls110"> 
                                                 <button class="btn btn-success pull-right m-t-10" id="subbtnStickUpSizeToggler" style="font-size: 10px;display:none"><?php echo $this->lang->line('Add_Sub_Category'); ?></button>
                                             </div>       
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2  cls110"> 
                                                 <button class="btn btn-success pull-right m-t-10" id="subsubbtnStickUpSizeToggler" style="font-size: 10px;display:none"><?php echo $this->lang->line('Add_Sub_sub_Category'); ?></button>
                                             </div>   
                                    ...
                                    <div class="customField  row">
                                        <div class="customPriceField row" id="customePriceMain">
                                            ...
                                            <div class="form-group pos_relative2 customPriceField1">
                                                ...
                                                <div class="col-sm-3 pos_relative2">
                                                    <span  class="abs_text"><b><?php echo $currencySymbol; ?></b></span>
                                                    <input type="text" name="units[0][price][en]" class="error-box-class  form-control productValue" id="value0" placeholder="Enter the Price "  onkeypress="return isNumberKey(event)">
                                                </div>
				...
				<?php } ?> 
                                    ...
                                    <div class="divdynamicViewImage row">
                                        <div class="form-group pos_relative2">
                                            ...
                                            <div class="col-sm-1">
                                                  <button class="btn btn-success finishbutton pull-right" type="button" onclick="submitform()"><span>Finish</span></button>
                                            </div>
                                            <div class="col-sm-3 error-box" id="text_images1"></div>
...
//            $('.customField').append(html);
            ...
            var divElement1 = '<div class="customPriceField row"><div class="form-group pos_relative2 customPriceField' + z + '">'
                    ...
                    + ' <div class="col-sm-3 pos_relative2">'
                    + ' <span  class="abs_text"><b><?php echo $currencySymbol; ?></b></span>'
                    + ' <input type="text" name="units[' + len + '][price][en]" class="form-control productValue" id="value' + z + '" placeholder="Enter Unit Price" onkeypress="return isNumberKey(event)">'
                    + ' </div>'
                    + '<div class=""></div>'
                        ...
                        <div class="form-group" class="formex">
                            ...
                            <div class="col-sm-6">
                                <input type="file" class="form-control error-box-class subsubcatImage"  name="cat_photos" id="subsubcat_photos" placeholder=""></div>
                                 ...
                                 <input type="hidden" id="subsubimagesProductImg" value="">

                            <img src="" style="width: 35px; height: 35px; display: none;" class="subsubimagesProductImg style_prevu_kit">
