...
//        $("#timeForacceptBookingErr").text("");
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.btndeviceLogs', function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/FranchiseManager') ?>/getDeviceLogs/manager",
                type: "POST",
                data: {mas_id: val},
                dataType: 'json',
...
//            $('#password').val("");
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/FranchiseManager') ?>/getManagers",
                type: "POST",
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    //console.log(result.data.franchiseId)
//                    $('#editfranchise').val(result.data.franchise);
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            // $.each(r, function (index, row) {
                            //    // console.log(row);
                            //     if (row._id.$oid == result.data.franchiseId) {
...
//                        $('#editstores option:selected').val(result.data.storeId);
                  ...
                  //  $('#editpassword').val(result.data.password);
                   ...
                   // $('.editaccepts').val(result.data.accepts);
                    ...
                    // if (result.data.accepts == '1') {
                    //     $("#editaccepts1").attr('checked', 'checked');
                    // } else if (result.data.accepts == '2') {
                    //     $("#editaccepts2").attr('checked', 'checked');
                    // } else if (result.data.accepts == '3') {
        ...
        $('#editemail,#editfrm_mobile').focusout(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/FranchiseManager') ?>/checkManagerExists",
                type: "POST",
        ...
        $("#yesEdit").click(function () {
           ...
           // var accepts = $('input[name=editaccepts]:checked').val();
            ...
            var email = $('#editemail').val();
            var editfranchise = '<?php echo $this->session->userdata('fadmin')['MasterBizId']; ?>';   //$('#editfranchise').val();
...
//          console.log($('.editaccepts').val());  console.log(accepts); return;
           /* if (stores == "" && stores == null)
            ...
            else if (editfranchise == "" || editfranchise == null)
            {
                $("#text_edit_FranchiseList").html("Please choose Franchise");
            }else if(!$("#editaddManagerForm").valid()){
               
            } 
            else {
                $.ajax({
                    url: "<?php echo base_url('index.php?/FranchiseManager') ?>/editManager",
                    type: "POST",
                    data: {managerId: editval, name: name,  email: email, mobile: mobile, accepts: accepts, countryCode: countryCode,   profilePic: profilePic,editfranchise : editfranchise},
                    success: function (result) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/1',
                            "bJQueryUI": true,
        ...
        // console.log($('.country-list li.active').attr('data-dial-code'));
        // $("#countryCode").val($('.country-list li.active').attr('data-dial-code')); 
        ...
        //    var cityName = $('#city option:selected').attr('cityName');
           ...
           // var stores = $('#stores').val();
            var franchise = '<?php echo $this->session->userdata('fadmin')['MasterBizId'] ?>';           //$('#franchise').val();
           
            // var franchiseName = $('#franchise option:selected').text();
            // var franchiseNameList = franchiseName.split(",");
            ...
            } else if (accepts == "" || accepts == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/FranchiseManager') ?>/addManager",
                    type: "POST",
                    dataType: 'json',
                    data: {name: name, profilePic: $('#ImageUpload').val(), email: email, mobile: mobile, password: $('#password').val(), accepts: accepts, countryCode: countryCode, franchiseId:franchise},
                    success: function (result) {
                        ...
                        if (result.flag == 1) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url() ?>index.php?/FranchiseManager/getManagersCount",
                                type: "POST",
                                dataType: 'json',
                                async: true,
                                success: function (response)
...
//            if(confirm("Are you sure to Delete " +val.length + " Drivers")){
                    $.ajax({
                        url: "<?php echo base_url('index.php?/FranchiseManager') ?>/activateManagers",
                        type: "POST",
                        data: {masterid: val},
                        success: function (result) {
                            ...
                            var settings = {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/4',
                                "bJQueryUI": true,
                                "sPaginationType": "full_numbers",
                                "iDisplayStart ": 20,
                                "oLanguage": {
...
//            if(confirm("Are you sure to Delete " +val.length + " Drivers")){
                    $.ajax({
                        url: "<?php echo base_url('index.php?/FranchiseManager') ?>/logoutManagers",
                        type: "POST",
                        data: {masterid: val},
                        success: function (result) {
                            ...
                            var settings = {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/2',
                                "bJQueryUI": true,
                                "sPaginationType": "full_numbers",
                                "iDisplayStart ": 20,
                                "oLanguage": {
...
//            if(confirm("Are you sure to Delete " +val.length + " Drivers")){
                    $.ajax({
                        url: "<?php echo base_url('index.php?/FranchiseManager') ?>/deleteManagers",
                        type: "POST",
        ...
        $("#editdriver").click(function () {
            ...
            {
                window.location = "<?php echo base_url() ?>index.php?/FranchiseManager/editdriver/" + val;
            }
        });
        ...
        $(document).on('click', '.getManagerDetails', function ()
        {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/FranchiseManager') ?>/getManagerDetails",
                type: "POST",
                ...
                success: function (result) {
                    ...
                    if (result.managerData.name != null)
                    {
                        ...
                        var franchiseName='';
                        $.each(result.managerData.franchiseName, function (index,fName){
                            if(fName && index==0){
                                franchiseName+=fName;
                            }
                            else if(fName){
                        ...
                        $('.dfranchisename').text(franchiseName);
                        var storeName="";
                        $.each(result.managerData.store, function (i, item) {
                        if(item && i==0){
                            storeName+=item;
                        }
                        else if(item){
                      ...
                      console.log(result.managerData.store)  
    ...
    $(document).ready(function () {
        ...
        $('#resetPasswordConfirm').click(function () {
            ...
            newpass = newpass.trim()
             ...
             if(newpass == '')
            {
                $('#pwderror').text('Please enter new password');
                ...
                $('#cnfpwderror').text('Password not match');
                ...
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/FranchiseManager/resetPassword",
                    type: "POST",
...
//            alert('asdf');
        ...
        $(document).on("countrychange", function (e, countryData) {
            ...
            console.log('count---------',countryData.dialCode);
        ...
        setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/' + status,
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
				"columns": [
...
//        });
        ...
        $("#ok_to_logout").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/FranchiseManager/driver_logout",
                type: "POST",
                data: {val: val},
                dataType: 'json',
                success: function (response)
            ...
            } else
            {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        // console.log(result.msg,typeof(result.msg))
                        switch (type)
                        {
                            case 1:
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs  bg-white whenclicked">
                        <li id= "my1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode New_" data="<?php echo base_url(); ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/1" data-id="1"><span><?php echo $this->lang->line('APPROVED'); ?></span><span class="badge newManagersCount" style="background-color: #337ab7;"></span></a>
                        </li>

                        <li id= "my2" class="tabs_active <?php echo $loggedin ?>" style="cursor:pointer">
                            <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/2" data-id="2"><span><?php echo $this->lang->line('LOGGED_IN'); ?></span> <span class="badge bg-green loggedInManagersCount" style="background-color: #5bc0de;"></span></a>
                        </li>
                        <li id= "my3" class="tabs_active <?php echo $loggedout ?>" style="cursor:pointer">
                            <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/3" data-id="3"><span><?php echo $this->lang->line('LOGGED_OUT'); ?></span> <span class="badge loggedOutManagersCount" style="background-color:#f0ad4e;"></span></a>
                        </li>
                        <li id= "my4" class="tabs_active <?php echo $deleted ?>" style="cursor:pointer">
                            <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/FranchiseManager/datatable_FranchiseManager/my/4" data-id="4"><span><?php echo $this->lang->line('DELETED'); ?></span> <span class="badge bg-red deletedManagersCount"></span></a>
                        </li>

                        <!--<div class="cls111"><button class="btn btn-primary pull-right m-t-10 " id="resetPassword"  >Reset Password</button></div>-->
                        <div style="margin-right:10px;margin-top:10px;">
                        <div class="cls111"><button class="btn btn-primary pull-right m-t-10 " id="managerLogout"  ><?php echo $this->lang->line('Logout'); ?></button></div>
                        <div class="cls111"> <button class="btn btn-success pull-right m-t-10" id="active" ><?php echo $this->lang->line('Activate'); ?></button></a></div>
                        <div class="cls111"> <button class="btn btn-danger pull-right m-t-10" id="chekdel" ><?php echo $this->lang->line('Deactivate'); ?></button></a></div>
                        <!--<div class="cls100"><button class="btn btn-info pull-right m-t-10 " id="deviceLogs" >Device Logs</button></div>-->     


                        <!--<div class="cls111"><button class="btn btn-info pull-right m-t-10 " id="editManager" >Edit</button></div>-->
                        <div class="cls110"><button class="btn btn-success pull-right m-t-10" id="add" ><?php echo $this->lang->line('Add'); ?></button></a></div>
                        </div>
                        ...
                        <div class="panel panel-transparent">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="pull-right col-xs-2"><input type="text" id="search-table" class="form-control pull-right" placeholder="<?php echo SEARCH; ?>"> </div>
                                </div>
            ...
            <div class="modal-header">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <input type="tel" required="" class="form-control error-box-class" name="frm_mobile"  id="frm_mobile" onkeypress="return isNumberKey(event)" style="    width: 109%;" > 
                    ...
                    <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label"><?php echo $this->lang->line('Profile_Image'); ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-sm-6">
                ...
                <form id="editaddManagerForm" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                   ...
                   <!-- <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label"> <?php echo $this->lang->line('Mobile'); ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-sm-6">
                            <input type="tel"  required="" value="" class="form-control error-box-class" name="editfrm_mobile"  id="editfrm_mobile" onkeypress="return isNumberKey(event)" style="    width: 100%;" > 
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="radio" class="error-box-class col-sm-2 editaccepts" name="editaccepts"  id="editaccepts3"  value="3">  -->
                             ...
                             <label class="radio-inline acceptedit"><input type="radio" name="acceptedit_res" id="acceptedit1"  value="1" > <?php echo $this->lang->line('Pickup'); ?></label>
                ...
                <!-- <form action="" method="post"  data-parsley-validate="" class="form-horizontal form-label-left"> -->
                    ...
                    <div class="modal-body">
                        <div class="form-group" class="formex">
                            <label for="fname" class="col-sm-3 control-label">Password<span style="" class="MandatoryMarker"> *</span></label>
                            <div class="col-sm-6">
                                <input type="text"  id="newpass1" name=""  class="newpass form-control" placeholder="New Password">
                            </div>
                            <span id="pwderror" style="text-align:right;color:red;font-size:9px;"></span>
                        </div>

                        <div class="form-group" class="formex">
                            <label for="fname" class="col-sm-3 control-label">Confirm Password<span style="" class="MandatoryMarker"> *</span></label>
                            <div class="col-sm-6">
                                <input type="text"  id="confirmpassword"  class="confirmpass form-control" placeholder="Confirm Password">
                            </div>
                            <span id="cnfpwderror" style="text-align:right;color:red;font-size:9px;"></span>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="pull-right m-t-10"> <button type="button" class="btn btn-success pull-right" id="resetPasswordConfirm" >SUBMIT</button></div>
                        </div>
                    </div>
                <!-- </form> -->
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group row" style="  margin-left: 7%;">
                            <label class="control-label col-md-5 col-sm-5 col-xs-5" for="Franchise_name">Franchise Name</label>
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <span style="" class="dfranchisename"></span>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3"></div>
                        </div>

                        <div class="form-group row" style="  margin-left: 7%;">
                            <label class="control-label col-md-5 col-sm-5 col-xs-5" for="Store_name">Store Name</label>
                            <div class="col-md-6 col-sm-6 col-xs-6">
                            <span style="" class="dstorename"></span>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3"></div>
                        </div>
                                ...
                                $("#frm_mobile").intlTelInput({
                                    ...
                                    geoIpLookup: function (callback) {
                                        $.get("https://ipinfo.io", function () {}, "jsonp").always(function (resp) {
                                            ...
                                            console.log('countrycode',countryCode.dialCode)
