...
//here this function validates all the field of form while adding new subadmin you can find all related functions in RylandInsurence.js file
    ...
    function submitform()
    {
      ...
      //  var cityId = $('#cityId').val();
        var cityId='<?php echo $cityzoneId['cityId'];?>';
                    ...
                    data:datainsert,
                        ...
                        if(json.flag==1){
                           ...
                           // on click modal button reload the page
                            ...
                            var msg = '<?php echo $this->lang->line('alert_offerNotCreated'); ?>'
                            $("#productOfferMsg").append(msg);
                            $('#productOfferModel').modal('show');
                         }
                         else{
  ...
  function isNumber(evt) {
    ...
    $(document).ready(function () {
        ...
        $('#uproductIds').on('change',function(){
             ...
             $.ajax({
                ...
                if (json.data.length > 0) {
                    ...
                    $(".modalPopUpText").text("No Units found.");
            ...
            if (val == 0) { // flat Discount
                ...
                $.ajax({
                    ...
                    if (json.data.length > 0) {
                        ...
                        $("#applicableOn").prop('selectedIndex',0);
                        $(".modalPopUpText").text("No Product found.");
                        $("#errorModal").modal('show');
                    }
        ...
        $(document).on('change', '#applicableOn', function () {
           ...
           // var storeId = $('#store').val();
           //var storeId='<?php $this->session->userdata('badmin')['BizId'];?>';
...
function citiesList(){
        $.ajax({    
                    ...
                    //console.log(json);
                  //  console.log('data---',json[0]["cityId"]["$oid"]);
                  document.getElementById("demo").innerHTML = "Currency";
...
<div class="page-content-wrapper">
    ...
    <div class="brand inline" style="  width: auto;">
            <?php echo $this->lang->line('heading_addPage'); ?>
        </div>
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="row">
                                        <div class="imagesField">
                                            <div class="form-group pos_relative2">
                                                ...
                                                &nbsp;
                                                <!--                                            <button type="button" id="btAddSeo0" data-id="0" class="btAddSeo btn btn-default btn-primary" style="width: 5%; border-radius: 9px;">
                                    ...
                                    <div class="row">
                                        <div class="form-group pos_relative2" style="display:none">
                                            ...
                                            <div class="col-sm-6 pos_relative2" style="display:none">
                                            ...
                                            <input type="hidden" name="cityId" value="<?php echo $cityzoneId['cityId'];?>"/>
      ...
      <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                ...
                <strong style="color:#0090d9;text-transform: capitalize;"><span id="cityDetails"><?php echo $this->lang->line('error_rejected'); ?></span></strong>
            </div>
            ...
            <table class="table table-bordered schedulepopup">
                <thead>
                  <tr>
                    ...
                    <th style="text-align: center; color: darkturquoise;"><?php echo $this->lang->line('error_productName'); ?></th>
...
<div class="modal fade" id="productOfferModel" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="error-box-class" id="productOfferMsg"></div> 
            </div>
            <div class="modal-footer">  
               <a href="<?php echo base_url(); ?>index.php?/ProductOffers" class="btn btn-default">Close</a>
               </button>
