        ...
        <script type="text/javascript">
            ...
            function VerifyNsendLink()
            {
                ...
                } else
                {
                    ...
                    $.ajax({
                        url: "<?php echo APILink ?>franchise/forgotPassword",
                        type: 'POST',
                        data: {"emailOrMobile": resetemail, 'verifyType': 2},
                        datatype: "JSON",
                        beforeSend: function(xhr){xhr.setRequestHeader('language', 0);},
                        success: function (data) {
                            ...
                            {
                                $("#msgtxt").text("Invalid email id,Please enter valid email id");
                                $("#msgModal").modal('show');   
    ...
    <body>
        ...
        <div class="login-wrapper">
            ...
            <div class="bg-pic">
                ...
                <img src="<?php echo ServiceLink; ?>theme/icon/admin_bg.png" data-src="<?php echo ServiceLink; ?>theme/icon/admin_bg.png" data-src-retina="<?php echo ServiceLink; ?>theme/icon/admin_bg.png" alt="">
            ...
            <div class="login-container">
                <div class="m-l-20 p-r-50 m-r-20 p-t-50  sm-p-l-15 sm-p-r-15 sm-p-t-40" style="margin-top:50%">
                    <!-- <img src="<?php base_url() ?>theme/icon/grocerloginlogo.png" style="width:50%;height:50%; margin-left:25%;"/> -->
                    <div class="loginDetails loginForm col-xs-12">
                   
                        <form id="submitForLogin" method="post" action="<?php echo base_url() ?>index.php?/Franchise/AuthenticateUser" onsubmit= "return submitLogin();">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                            <input type="hidden" name="timeOffset" value="" id="timeOffset"/>
...
if ($loginerrormsg != '')
    ...
    ?>
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" style = "text-align:left;">Alert</h5>
            </div>
            <hr>
            <div class="modal-body">
            <p id ="msgtxt" style="color: #0090d9; text-align:center;"></p>
            </div>
