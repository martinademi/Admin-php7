...
<script>
   $(document).ready(function() {
    ...
    function bonafidetab(litabtoremove,divtabtoremove)
    {
        ...
        {             
            if(isBlank($("#entitydocname").val()) || isBlank($("#entityexpirydate").val()))            
            {
                bstatus=false;
            }
    ...
    function signatorytab(litabtoremove,divtabtoremove)
    {
        ...
        {             
            if(isBlank($("#entitypersonname").val()) || isBlank($("#entitysignatorymobileno").val()) || $("#entitydegination").val()==="null")
            {
                bstatus=false;
            }
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            ...
            <!-- Tab panes -->
            <form id="addentity" class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/superadmin/EditEntity/Broker/<?php echo $entitydata['_id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane padding-20 slide-left active" id="tab1">
                    <div class="row row-same-height">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="entityname" placeholder="Name" name="entityname"  aria-required="true" value="<?php echo $entitydata['Name'];?>">
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="entityemail" placeholder="Email" name="entityemail"  aria-required="true" value="<?php echo $entitydata['Email'];?>">
                                </div>
                                <div class="col-sm-1">
                                <span style="color: red; font-size: 20px">*</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="active" type="radio" value="active" name="entitystatus" id="entitystatus">&nbsp;&nbsp;&nbsp;Active&nbsp;&nbsp;&nbsp;                                        
                                <input id="deactive" type="radio" value="deactive" name="entitystatus" id="entitystatus">&nbsp;&nbsp;&nbsp;Deactive&nbsp;&nbsp;&nbsp;
                                    
                                    
                                <?php 
                                    if($entitydata['Status'] == "active")
                                    {?>
                                        <script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="entityregno" placeholder="Registration no" name="entityregno"  aria-required="true" value="<?php echo $entitydata['Registration_No']?>">
                                </div>
                                 <div class="col-sm-1">
                                <span style="color: red; font-size: 20px">*</span>
                                </div>
                ...
                <div class="tab-pane slide-left padding-20" id="tab2">
                    <div class="row row-same-height">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="entityaddress" id="entityaddress" rows="3"><?php echo $entitydata['Address']?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">                             
                                    <input type="text" name="entitytown" id="entitytown" class="form-control" value="<?php echo $entitydata['Town']?>">                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="entitystate" id="entitystate" value="<?php echo $entitydata['State']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <script>
                                          ...
                                          if ($(this).text() == "<?php echo $entitydata['Country']?>")
                                          {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="entitypobox" placeholder="Po-Box" name="entitypobox"  aria-required="true" value="<?php echo $entitydata['PObox']?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" onkeypress="return OnlyInt(event,'ziperror')" class="form-control" id="entityzipcode" placeholder="Zipcode" name="entityzipcode"  aria-required="true" value="<?php echo $entitydata['Zipcode']?>">
                ...
                <div class="tab-pane slide-left padding-20" id="tab3">
                    <div class="row row-same-height">
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="entitydocname" id="entitydocname" value="<?php echo $entitydata['Documentname']?>">                                    
                                    <input type="hidden" value="<?php echo $entitydata['DocumentId']?>" name="documentid" id="documentid">
                                </div>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="entitydescription" id="entitydescription" rows="3"><?php echo $entitydata['Documentname']?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">                     
                                    ...
                                    <input type="hidden" value="<?php echo $entitydata['Documentpath']?>" name="olddocpath" id="olddocpath">
                                </div>
                                ...
                                <div class="col-sm-2">    
                                    <?php
                                    $pos = strrpos($entitydata['Documentpath'],"/");
                                    $filename = substr($entitydata['Documentpath'],$pos);
                                    ?>
                                    <a href="<?php echo base_url()."Documents".$filename?>" target="blank">Last Uploaded file</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" class="form-control" style="height: 37px;" name="entityissuedate" id="entityissuedate" value="<?php echo $entitydata['Issuedate'];?>">                                           
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" class="form-control" style="height: 37px;" name="entityexpirydate" id="entityexpirydate" value="<?php echo $entitydata['Expirydate'];?>">                                           
                                </div>
                ...
                <div class="tab-pane slide-left padding-20" id="tab4">
                       ...
                       <div class="row row-same-height">
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="entitypersonname" id="entitypersonname" value="<?php echo $entitydata['Signatorypname'];?>">                                    
                                    <input type="hidden" value="<?php echo $entitydata['SignatoryId']?>" name="signatoryid" id="signatoryid">
                                </div>
                           ...
                           <div class="form-group">
                                <label for="address" class="col-sm-3 control-label">Description</label>
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="entitysignatorydescription" id="entitysignatorydescription"><?php echo $entitydata['Signatorydescription'];?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">                     
                                    ...
                                    <input type="hidden" value="<?php echo $entitydata['Signatorypath']?>" name="oldsignatorypath" id="oldsignatorypath">
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <?php
                                    $ipos = strrpos($entitydata['Signatorypath'],"/");
                                    $ifilename = substr($entitydata['Signatorypath'],$ipos);
                                    ?>
                                    <a href="<?php echo base_url()."Signatory".$ifilename?>" target="blank"><img src="<?php echo base_url()."Signatory".$ifilename?>" height="50px" width="50px"></a>                                                                  
                                </div>
                            ...
                            <div class="form-group">
                                <label for="fname" class="col-sm-3 control-label">Mobile No</label>
                                 <div class="col-sm-1">
                                     <input type="text" class="form-control" style="height: 37px;" name="mobileprefix" id="mobileprefix" disabled value="<?php echo $entitydata['Countrycode'];?>">                                           
                                     <input type="hidden" class="form-control" style="height: 37px;" name="countrycode" id="countrycode">
                                </div>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" style="height: 37px;" name="entitysignatorymobileno" id="entitysignatorymobileno" onkeypress="return OnlyInt(event,'phoneerror')" value="<?php echo $entitydata['Signatorypmobileno'];?>">                                           
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" style="height: 37px;" name="entitydegination" id="entitydegination">
                                           <option value="null" selected="">select..</option>
                                    ...
                                    <script>
                                          $("#entitydegination > option").each(function () { 
                                              
                                          if ($(this).text() == "<?php echo $entitydata['Spdesignation']?>")
                                          {
                                                $(this).attr("selected", "selected");
                                          }
                                        });
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" style="height: 37px;" name="entitysignatoryemail" id="entitysignatoryemail" value="<?php echo $entitydata['Spemail'];?>">                                           
                                </div>
