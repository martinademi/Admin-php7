...
//                      $('.edit_accepts').val(row.Accepts);
    ...
    function Delservice(thisval) {
        ...
        $("#deletelink").attr('href', "<?php echo base_url() ?>index.php/superadmin/DeleteSubCat/" + entityidid);
    }
...
<div class="modal fade in" id="NewCat" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="">
    <div class="modal-dialog modal-md" style="padding: 0% 5%;">
        ...
        <form  id="addnewsubcat" role='form' action = "<?php echo base_url(); ?>index.php/superadmin/AddNewSubCategory" method="post" enctype="multipart/form-data"">
