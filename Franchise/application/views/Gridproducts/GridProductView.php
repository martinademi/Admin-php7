...
<html>
	...
	<div class="brand inline" style="  width: auto;
                        ...
                        <strong style="color:#0090d9;">PRODUCTS </strong><!-- id="define_page"-->
                   </div>
		<div class="container">
        <!-- header -->
        ...
        <ul class="nav nav-tabs bg-white whenclicked">
						 ...
						 <li id= "rejected" class="tabs_active <?php //echo $reject ?>" style="cursor:pointer">
							...
							<li id= "delete" class="tabs_active <?php //echo $reject ?>" style="cursor:pointer">
		 					 ...
		 					 <div class="pull-right m-t-10"><a href="<?php echo base_url() ?>index.php?/AddNewProducts/addNewProduct"> <button class="btn btn-success pull-right m-t-10" id="add" style="font-size:10px !important;">Add </button></a></div>
				...
				<div class="col-sm-3 col-lg-3">
					<div class="panel panel-info outer">
						<div class="panel-body">
							...
							<div class="pull-right pricetag"><?php echo $products['currencySymbol']['currencySymbol']." ".$product['units'][0]['price']['en'];?></div>
