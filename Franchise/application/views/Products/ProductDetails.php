        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            <div class="inner">
                ...
                <ul class="breadcrumb" style="">
                    ...
                    <li><a class="active" href="<?php echo base_url() ?>index.php/Products">PRODUCTS</a>
                    </li>
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <!-- Tab panes -->
                    <form id="addentity" class="form-horizontal" role="form" action="<?php echo base_url() ?>index.php/Products/AddnewProduct" method="post" enctype="multipart/form-data">
