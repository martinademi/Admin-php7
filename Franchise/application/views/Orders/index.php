...
function getOrdersCount()
   ...
   $('#big_table_processing').show();
		...
		$(document).on('click', '.orderDetails', function ()
		 {
            ...
            var status = urlChunks[urlChunks.length - 1];
			 ...
			 window.open("<?php echo base_url();?>index.php?/Orders/orderDetails/"+orderId+"/"+status)
		 });
        ...
        $('#big_table').on('init.dt', function () {
            ...
            if (status == 0) {
                $('#big_table').dataTable().fnSetColumnVis([2,4,5,13,14,15,16], false);
				getOrdersCount();
                }
            if (status == 1) {
                $('#big_table').dataTable().fnSetColumnVis([2,4,5,13,14,16,17,15], false);
				getOrdersCount();
                
            }
            if (status == 2) {
                $('#big_table').dataTable().fnSetColumnVis([2,4,15,17], false);
                getOrdersCount();
            }
            if (status == 3) {
                $('#big_table').dataTable().fnSetColumnVis([2,4,5,8,9,13,14,15,17], false);
                getOrdersCount();
            }
            // if (status == 4) {
...
<div class="page-content-wrapper"style="padding-top: 20px">
    ...
    <div class="content" >
        ...
        <!-- <div class="brand inline" style="  width: auto;            
            ...
            <strong style="color:#0090d9;font-size:14px;">ORDERS</strong>
        </div> -->
       ...
       <?php echo $this->lang->line('page_name'); ?>
        ...
        <div id="test"></div>
        <!-- Nav tabs -->
        <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm bg-white whenclicked">
