...
class Deliverydriverslotsmodal extends CI_Model {
    ...
    public function datatable_getProviderDetails($zoneId,$status,$timeOffset,$zoneDeliveryId) {
        ...
        //$respo = $this->datatables->datatable_mongodb('driver',array('serviceZones'=>$zoneId,'status'=> 9));
        $respo = $this->datatables->datatable_mongodb('zonesDeliverySlots',array("_id" => new MongoDB\BSON\ObjectID($zoneDeliveryId),'status'=> 1));
        ...
        //     $arr[] = 'Order Assigned';          
        //   //  $arr[] = "<button class='btn driverAssignSlot btn-primary cls111' style='width:35px; border-radius: 25px;' data-id='" . $value['_id']['$oid'] . "'><i class='fa fa-user-plus' style='font-size:12px;'></i> </button>";         
        //     $datatosend[] = $arr;
        // }
