...
$acc_pageArr = array(
    ...
    'marketing/addNewPromoCampaign' => 'offers',
...
<html>
    ...
    <head>
        ...
        <title><?php echo "loopzDelivery"; ?></title>
        ...
        <link href="<?php echo base_url(); ?>build/css/styles_admin.css" rel="stylesheet">
        <script>
    ...
    <body class="nav-md">
                        ...
                        <div id="sidebar-menu" class="main_menu_side main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu leftSideMenu">
                                    ...
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >SETTINGS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li class="zones"><a href="<?php echo base_url(); ?>index.php?/superadmin/zones"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >ZONES</a></li>
                                            <li class="taxes"><a  href="<?php echo base_url(); ?>index.php?/taxController"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" >TAXES</a></li> 
                                            ...
                                            <li class="appConfig"><a  href="<?php echo base_url(); ?>index.php?/superadmin/app_config"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" >APP CONFIGURATION</a></li> 
                                            ...
                                            <li class="tripRating"><a  href="<?php echo base_url(); ?>index.php?/superadmin/driverRating"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Driver reviews.png' ?>" > ORDER RATING</a></li>    
                                    ...
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >PRODUCTS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="products"><a  href="<?php echo base_url(); ?>index.php?/AddNewProducts"><img class="menuIconClass" src="<?php echo base_url() ?>theme/icon/product.png" >MANAGE</a></li>    
                                            ...
                                            <li class="colors"><a  href="<?php echo base_url(); ?>index.php?/colorsController"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" > COLORS</a></li> 
                                            <li class="manufacturer"><a  href="<?php echo base_url(); ?>index.php?/Manufacturer_Controller"><img class="menuIconClass" src="<?php echo base_url() ?>theme/icon/store.png" >MANUFACTURER</a></li>    
                                            <li class="sizegroup"><a  href="<?php echo base_url(); ?>index.php?/sizeController"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" > SIZE-GROUPS</a></li> 
                                            <li class="brands"><a  href="<?php echo base_url(); ?>index.php?/brandsController"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" > BRANDS</a></li> 
                                        </ul>
                                    </li>
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >STORE<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="storeCategory"><a  href=""><img class="menuIconClass" src="<?php echo base_url() ?>theme/icon/store.png" >CATEGORIES</a></li>
                                            <li class="franchise"><a  href=""><img class="menuIconClass" src="<?php echo base_url() ?>theme/icon/store.png" >FRANCHISE</a></li>
                                    ...
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >CUSTOMERS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li ><a  href="<?php echo base_url(); ?>index.php?/welcome/customerVerification"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Shape passangerrating_off.png' ?>" >VERIFICATION</a></li> 
                                        </ul>
                                    </li>

                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >DRIVERS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li  class="driver"><a  href="<?php echo base_url(); ?>index.php?/superadmin/Drivers/my/1"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Drivers.png' ?>" >MANAGE</a></li>  
                                            <li ><a  href="<?php echo base_url(); ?>index.php?/superadmin/driverVerification"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Customer-Verification.png' ?>" >VERIFICATION</a>
                                            <li class="driverPlan"><a  href="<?php echo base_url(); ?>index.php?/superadmin/driverPlans"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Driver-Plans.png' ?>" >PLANS</a></li>
                                            <li class="driverReview"><a  href="<?php echo base_url(); ?>index.php?/superadmin/driver_review/1"><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Driver reviews.png' ?>" >RATING</a></li>    
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >STATISTICS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
        ...
        <!--                                            <li class="cancellationReasons"><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/Cancellation-Reasons.png' ?>" >CANCELLATION REASONS<span class="fa fa-chevron-down"></span></a>
                                    ...
                                    <li class="wallet"><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >ACCOUNT STATEMENT<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class=""><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >WALLET<span class="fa fa-chevron-down"></span></a>
                                                <ul class="nav child_menu">
                                    ...
                                    <li><a><img class="menuIconClass" src="<?php echo ServiceLink . 'pics/icon_Zones.png'; ?>" >AUTHORISED USERS<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="manageAccess"><a  href="<?php echo base_url(); ?>index.php?/superadmin/manageRole"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/disputes_off.png' ?>" >LOOPZ ADMIN</a></li> 
                                            <li><a  href="<?php echo base_url(); ?>index.php?/managers"><img class="menuIconClass"  src="<?php echo ServiceLink . 'pics/dispatcher_off.png' ?>" class="">REGIONAL MANAGERS</a></li>       
