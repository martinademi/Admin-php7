...
class Ordercapacityslotsmodal extends CI_Model {
    ...
    public function datatable_getProviderDetails($zoneId,$status,$timeOffset) {
        ...
        switch((int)$status){
            case 1:
            $respo = $this->datatables->datatable_mongodb('zonesDeliveryWorkings',array('zoneId'=>$zoneId,'status'=> 1));
            break;
            case 2:
            $respo = $this->datatables->datatable_mongodb('zonesDeliveryWorkings', array('zoneId'=>$zoneId,'status' => 2));
            break;
            case 3:
            $respo = $this->datatables->datatable_mongodb('zonesDeliveryWorkings', array('zoneId'=>$zoneId,'status' => 3));
            break;
