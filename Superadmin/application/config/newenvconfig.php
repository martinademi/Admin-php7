...
define('AMAZON_AWS_ACCESS_KEY', getenv('amazonkey'));
define('AMAZON_AWS_AUTH_SECRET', getenv('amazonsecretkey'));

define('bucketName', getenv('bucketname'));
define('region', 'us-east-1');
define('AMAZON_URL', '');

define('ServiceLink', getenv('servicelink'));
define('franchiseLink', getenv('franchiselink'));

define('APILink', getenv('apiurl'));
...
$config['es_server'] = getenv('elasticsearchip');
$config['index'] = getenv('elasticsearchindex');
