...
define('JobStatus', serialize(array('1'=>'New Order','2'=>'Cancelled by manager','3'=>'Rejected by manager','4'=>'Accepted by manager',
             '5'=>'Order ready','6'=>'Order picked','7'=>'Order completed',
             '8'=>'Accepted by driver','9'=>'Rejected by driver','10'=>'Driver on the way','11'=>'Driver arrived at pickup','12'=>'Driver journey Started',
             '13'=>'Driver reached at delivery location','14'=>'Order delivered','15'=>'Order completed','16'=>'Customer cancelled order','17'=>'Driver cancelled order')));
...
define('WeightMetric',serialize(array('0'=>'Kilogram (kg)','1'=>'Pounds (lb)')));//Weight metric setting
define('DistanceMetric',serialize(array('0'=>'Kilometer (km)','1'=>'Miles (mi)')));//Distance metric setting


/*product offer*/
//define('ProductOffers','https://offers.flexyapp.com/');
//define('Pushnotification','https://api.flexyapp.com/');
//Wallet
//define('wallet_api','https://offers.flexyapp.com/admin/wallet/');
...
define('uploadImageapiLink', 'https://uploadimage.flexyapp.com/s3');
$config['UPLOAD_TYPE'] = 'AMAZONE';
//$config['base_url'] = 'http://superadmin.instacart-clone.com/';
...
$config['csrf_token_name'] = 'grocer';
$config['csrf_cookie_name'] = 'grocer';
