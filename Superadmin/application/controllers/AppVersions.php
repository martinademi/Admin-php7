...
class AppVersions extends CI_Controller {
    ...
    public function appVersions($param = '') {
        ...
        $this->table->set_heading($this->lang->line('VERSION'),$this->lang->line('UPDATE_DATE'),$this->lang->line('MANDATORY'));
    ...
    public function showAllUsersAppVersion($appversion = '',$tab = '') {
        ...
        $this->table->set_heading($this->lang->line('Name'),$this->lang->line('EMAIL'),$this->lang->line('MOBILE'),$this->lang->line('DEVICE_INFO'));
