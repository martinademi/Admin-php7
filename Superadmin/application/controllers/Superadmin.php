...
//        $driversArrAndroid = $array;
    ...
    public function accounting() {
        ...
        $this->table->set_template($tmpl);
        $this->table->set_heading('ORDER ID','ORDER TYPE & BUSINESS TYPE', 'ORDER DATE & TIME', 'CITY','DRIVER NAME', 'CUSTOMER NAME','STORE NAME', 'STORE EARNINGS', 'PAYMENT GATEWAY EARNINGS', 'DRIVER EARNINGS', 'STORE EARNINGS','DISCOUNT','TOTAL AMOUNT', 'PAYMENT METHOD', 'ORDER STATUS', 'INVOICE');
        $this->load->view("company", $data);
    }
