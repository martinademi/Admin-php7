...
class Category extends CI_Controller {
    ...
    public function index() {
        ...
        $this->table->set_heading($this->lang->line('SL_NO'),$this->lang->line('IMAGE'),$this->lang->line('CATEGORY_NAME'),$this->lang->line('DESCRIPTION'),$this->lang->line('SUBCATEGORY_COUNT'),
            // $this->lang->line('META_TAGS'),
            $this->lang->line('SORT'),$this->lang->line('ACTIONS'), $checkbox);
