...
$this->Logoutmodal->logout();
    ...
    public function index($status = '') {
        ...
        $this->table->set_heading($this->lang->line('col_sino'),$this->lang->line('col_Name'),$this->lang->line('col_desc'),$this->lang->line('col_addOns'),$this->lang->line('col_action'), $checkbox);
