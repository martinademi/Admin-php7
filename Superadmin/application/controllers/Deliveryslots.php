...
class Deliveryslots extends CI_Controller {
...
$this->Logoutmodal->logout();
        $this->load->model("Deliveryslotsmodal");
    ...
    public function index() {
        ...
        //$data['citiesData'] = $this->Deliveryslotsmodal->getCityList();
        ...
        $data['pagename'] = "Deliveryslots/Deliveryschduled";
    ...
    public function slots($zoneId='',$cityId='') {
        ...
        $this->table->set_heading('SL NO.','DATE','START TIME','END TIME','ORDER CAPACITY','DRIVERS','STATUS','BUTTON' );
        $data['pagename'] = "Deliveryslots/Deliveryschduled";
        $this->load->view("company", $data);
    }
    public function slotDetails($id=''){
        ...
        $data['pagename'] = "Deliveryslots/Deliveryslot";
    ...
    public function bookingSlotdetails($id=''){
        ...
        $data['pagename'] = "Deliveryslots/bookedDetails";
        $data['deliveryworkingHourId'] = $id;
        $this->load->view("company", $data);
    ...
    public function datatable_getProviderDetails($zoneId ='',$status = '',$timeOffset= '') {
        ...
        $this->Deliveryslotsmodal->datatable_getProviderDetails($zoneId,$status,$timeOffset);
    }

    public function getProviderDetailsCount($cityid = '', $catid = '', $userType = '', $sdate = '') {

        $this->Deliveryslotsmodal->getProviderDetailsCount($cityid, $catid, $userType, $sdate);
    }

    public function addSchduled($zoneId='',$cityId = '') {

        $this->Deliveryslotsmodal->addSchduled($zoneId,$cityId);

    }
    
    public function deleteSchduled() {

        $this->Deliveryslotsmodal->deleteSchduled();

    }
    public function deleteParticularSlot() {

        $this->Deliveryslotsmodal->deleteParticularSlot();

    }
    public function addSlotSchduled(){
        $this->Deliveryslotsmodal->addSlotSchduled();
    }
  
    public function datatable_getSlotSchduled($id='',$Offset=''){
        $this->Deliveryslotsmodal->datatable_getSlotSchduled($id,$Offset);
    }

    public function datatable_getBookingDetails($id='',$Offset=''){
        $this->Deliveryslotsmodal->datatable_getBookingDetails($id,$Offset);
    }
