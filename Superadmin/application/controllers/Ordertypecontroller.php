...
class Ordertypecontroller extends CI_Controller {
...
$this->Logoutmodal->logout();
        $this->load->model('Ordertypemodal');
       ...
       public function index($status = '') {
        ...
        $data['language'] = $this->Ordertypemodal->getlanguageText();
        ...
        $data['pagename'] = "Ordertype/ordertype";
        $this->load->view("company", $data);
    }
    
     public function data_details($status = '') {
        $this->Ordertypemodal->data_details($status);
    }
    
     public function addBrand() {
        $this->Ordertypemodal->addBrand();
    }
     public function getBrand($id = '') {
        $data1 = $this->Ordertypemodal->getBrand($id);
        echo json_encode(array('data' => $data1));
    }
     public function editBrand() {
        $this->Ordertypemodal->editBrand();
    }
     public function activateBrand() {
        $this->Ordertypemodal->activateBrand();
    }
     public function deactivateBrand() {
        $this->Ordertypemodal->deactivateBrand();
    }

    public function deleteSymtom() {
        $this->Ordertypemodal->deleteSymtom();
    }
