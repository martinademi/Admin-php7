...
$this->lang->load('header_lang',$language); 
    ...
    public function slots($zoneId='',$cityId='') {
        ...
        $this->table->set_heading('SL NO.', 'START DATE','START TIME', 'END DATE',  'END TIME','WORKING DAYS','ACTION');
        $data['pagename'] = "Deliveryschduled/Deliveryschduled";
        $this->load->view("company", $data);
    }
    ...
    public function bookingSlotdetails($id=''){
        ...
        $data['pagename'] = "Deliveryschduled/bookedDetails";
        $data['deliveryworkingHourId'] = $id;
        $this->load->view("company", $data);
    ...
    public function datatable_getProviderDetails($zoneId ='',$status = '',$timeOffset= '') {
        ...
        $this->Deliveryschduledmodal->datatable_getProviderDetails($zoneId,$status,$timeOffset);
    }
    ...
    public function addSchduled($zoneId='',$cityId = '') {
        ...
        $this->Deliveryschduledmodal->addSchduled($zoneId,$cityId);
    ...
    public function datatable_getBookingDetails($id='',$Offset=''){
        $this->Deliveryschduledmodal->datatable_getBookingDetails($id,$Offset);
    }
