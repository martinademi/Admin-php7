...
class PaymentGateway extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->lang->load('paymentGateway_lang',$language);
...
//        require 'datatableVariable.php';
        ...
        $this->table->set_heading($this->lang->line('col_slno'),$this->lang->line('col_gatewayName'),$this->lang->line('col_Commission'),$this->lang->line('col_fixedCommission'),$this->lang->line('col_Action'),
        $this->lang->line('col_select'),$this->lang->line('col_Action'));
