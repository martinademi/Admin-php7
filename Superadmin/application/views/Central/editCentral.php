            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="navbar-collapsible"  class="navbar-collapse collapse m-t-50">
                    ...
                    <form id="addentity" class="form-horizontal" role="form"
                          action="<?php echo base_url(); ?>index.php?/CentralController/editCentralData/<?php echo $dataId; ?>"
                        ...
                        <div class="tab-content">
                                    ...
                                    <div id="customePriceMain">
                                        ...
                                        <div class="form-group pos_relative2 customPriceField1">
                                            ...
                                            <div class="col-sm-1" id="text_productTitleText">
                                                <input type="button" id="custom" value="Add" class="btn btn-default pull-right marginSet btn-primary" style="margin-right: -10px;border-radius: 25px;">
                            ...
                            <script>
                                ...
                                $.ajax({
                                    url: "<?php echo base_url(); ?>index.php?/CentralController/getAddOnsEdit/<?php echo $dataId; ?>",
                                            type: "POST",
                                               ...
                                               console.log(response);
                                                $.each(response.result, function (index, row) {
                                                    ...
                                                    var divElement1 = '<div class="customPriceField"><div class="form-group pos_relative2 customPriceField' + len + '">'
                                                            + '<label id="titleLabel' + len + '" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_AddOns'); ?> ' + len + ' </label>'
                                                            + '<div class="col-sm-3 pos_relative2">'
                                                            + '<span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>'
                                                            + '<input type="text" name="addOns[' + len + '][name][en]" value="' + row.name.en + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title">'
                                                            + '<input type="text" name="addOns[' + len + '][id]" value="' + row.id.$oid + '" class="form-control productTitle" id="title' + z + '"  style="display:none">'
                                                            + '</div>'
                                                            + '<div class=""></div>'
                                ...
                                foreach ($language as $val) {
                                    if ($val["Active"] == 1) {
                                        ?>'
                                                                    ...
                                                                    + '<label id="titleLabel' + len + '" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_AddOns'); ?> ' + len + ' (<?php echo $val['lan_name']; ?>)</label>'
                                                                    + '<div class="col-sm-3 pos_relative2">'
                                                                    + '<span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>'
                                                                    + '<input type="text" name="addOns[' + len + '][name][<?php echo $val['langCode']; ?>]" value="' + row.name.<?php echo $val['langCode']; ?> + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title">'
                                                                  //  + '<input type="text" name="addOns[' + len + '][id][<?php echo $val['langCode']; ?>]" value="' + row.id.$oid + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title">'
                                                                    + '</div>'
                                                                    + '<div class=""></div>'
                                                                    + '</div>'
                                                                    + '<?php } else { ?>'
                                                                    + '<div class="form-group pos_relative2 customPriceField' + z + '" style="display:none">'
                                                                    + '<label id="titleLabel' + z + '" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_AddOns'); ?> ' + z + ' (<?php echo $val['lan_name']; ?>)</label>'
                                                                    + '<div class="col-sm-3 pos_relative2">'
                                                                    + '<span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>'
                                                                    + '<input type="text" name="addOns[' + len + '][name][<?php echo $val['langCode']; ?>]" value="' + row.name.<?php echo $val['langCode']; ?> + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title">'
                                                                   // + '<input type="text" name="addOns[' + len + '][name][<?php echo $val['langCode']; ?>]" value="' + row.id.$oid + '" class="form-control productTitle" id="title' + z + '"  placeholder="Enter title">'
                                                                    + '</div>'
                                                                    + '<div class=""></div>'
                                                                    + '</div>'
                                                                    + '<?php
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#custom', function () {
            ...
            var divElement1 = '<div class="customPriceField"><div class="form-group pos_relative2 customPriceField' + z + '">'
                    + '<label id="titleLabel' + z + '" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_AddOns'); ?> ' + z + ' </label>'
                    + '<div class="col-sm-3 pos_relative2">'
                    + '<span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>'
