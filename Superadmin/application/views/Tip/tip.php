...
<script>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/TipController/tax_details/1',
            "bJQueryUI": true,
        ...
        $("#yesAdd").click(function () {
            ...
            if (taxValue == '' || taxValue == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/TipController') ?>/addTax",
                    type: "POST",
                    dataType: 'json',
...
//            if (val.length == 1) {
                $.ajax({
                    url: "<?php echo base_url('index.php?/TipController') ?>/getTax",
                    type: "POST",
                    dataType: 'json',
                    data: {Id: editval},
                    success: function (result) {
...
//            }
        ...
        $("#yesEdit").click(function () {
            ...
            } else if (edittaxValue == '' || edittaxValue == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/TipController') ?>/editTax",
                    type: "POST",
        ...
        $("#activate").click(function () {
            ...
            if (val.length >= 1) {
                ...
                $("#errorboxactivateTax").text('<?php echo $this->lang->line('alert_activate_tip'); ?>');
        ...
        $("#yesActivate").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/TipController') ?>/activateTax",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    ...
                    if (res.flag == 0) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/TipController/tax_details/2',
                            "bJQueryUI": true,
                            "sPaginationType": "full_numbers",
                            "iDisplayStart ": 20,
                            "oLanguage": {
        ...
        $("#deactivate").click(function () {
            ...
            if (val.length >= 1) {
                ...
                $("#errorboxdeactivate").text('<?php echo $this->lang->line('alert_deactivate_tip'); ?>');
        ...
        $('#yesdeactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/TipController') ?>/deactivateTax",
                type: "POST",
                data: {Id: val},
                success: function (result) {
...
<div class="page-content-wrapper" style="padding-top: 20px">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-left: 30px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 14px;"><?php echo "TIP"; ?></strong>
        </div>
        <!-- Nav tabs -->
        <div class="panel panel-transparent ">
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                <li id= "my1" class="tabs_active active" style="cursor:pointer">
                    <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/TipController/tax_details/1" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                </li>

                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/TipController/tax_details/2" data-id="2"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>
            </ul>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                 ...
                 <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label"><?php echo "Tip Value"; ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-sm-5">
                            <span class="abs_text1 currencySymbol"><b>$</b></span>
                            <input type="text" class="form-control error-box-class" id="taxValue" name="taxValue" onkeypress="isNumber();"  minlength="3" placeholder="Enter tip vaue" required="">  
