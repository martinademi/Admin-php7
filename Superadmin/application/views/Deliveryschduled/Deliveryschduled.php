...
//            }
    ...
    function dateTimeReturn(month,stTime){
            ...
            d.setMonth(d.getMonth()+mon);
                    ...
                    console.log(dformat);
                        ...
                        function callDataTable(zoneId, status){
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryschduled/datatable_getProviderDetails/'+zoneId+'/'+status+'/'+offset,
                                "bJQueryUI": true,
        ...
        //     // var valid = $(this).attr('data-id');
        //     // $.ajax({
        //     //         url: "<?php echo base_url() ?>index.php?/Deliveryschduled/getSlotSchduled",
        //     //         type: "POST",
        //     //         data: {
        //     //             whId:valid
        //     //         },
        ...
        $('#addSlot').click(function(){
            ...
            if($("#pDate").val() == '' )
            {
                ...
                var zoneId = '<?php echo $zoneId; ?>'
            $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryschduled/addSlotSchduled",
                    type: "POST",
                    data: {
                        objId:objId,
                        slotDate:slotDate,
        ...
        $("#insert_cat_group").click(function () {
           ...
           // console.log("offset",offset);
            ...
            //    return;
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryschduled/addSchduled/<?php echo $zoneId;?>/<?php echo $cityId;?>",
                    type: "POST",
                    data: {
                        //BusinessId:fid,
                        stTime:stTime,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/'+offset,
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
//                  $('#big_table_processing').hide();
        ...
        $('.changeMode').click(function () {
            ...
            {
               targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/"+offset ;
            } else if($(this).attr('data-id') == 2) {
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/2/"+offset ;
            }
            else{
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/3/"+offset ;
            }
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            ...
            <strong style="font-size: 12px;margin-left: 15px;">DELIVERY SCHEDULE</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="form-group">
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                        <li id= "1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?>" style="cursor:pointer">
                            <a class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/1" data-id="1"><span>ACTIVE</span><span class="badge createdSchedule" style="background-color: #5bc0de;"></span></a>
                        </li>
                        <li id= "2" class="tabs_active <?php echo ($status == 2 ? "active" : ""); ?>" style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryschduled/datatable_getProviderDetails/<?php echo $zoneId; ?>/2" data-id="2"><span>EXPIRED</span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                        </li>   
                ...
                <div class="pull-left col-sm-6" >
                        ...
                        <div class="">
                            <ul class="breadcrumb" style="background:white;margin-top: 0%;">
                                ...
                                <li><a class="active" href="#" class="">Delivery Schedule</a> </li>
                            </ul>
                        </div>
