...
<script>
    ...
    //   base_url().'index.php?/superadmin/access_denied';
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/Ordertypecontroller/data_details/1',
            "bJQueryUI": true,
        ...
        $("#yesAdd").click(function () {
          ...
          //  var type = $("input:radio[name=itemType]:checked").val();
            ...
            if (bname == '' || bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/addBrand",
                    type: "POST",
                    dataType: 'json',
                    data: {orderName: Name, brandDescription: Description, bannerImage: bimg},
                    success: function (result) {
                        console.log('--------',result)
                        if (result.flag == 1) {
                            $('#addModal').modal('hide');
...
//        $('#edit').click(function () {
        $(document).on('click', '#btnEdit', function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/getBrand",
                type: "POST",
                dataType: 'json',
                data: {Id: editval},
                success: function (result) {
...
<?php } ?>
        ...
        $("#yesEdit").click(function () {
           ...
           // var type = $("input:radio[name=edititemType]:checked").val();
            ...
            if (Bname == '' || Bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/editBrand",
                    type: "POST",
                    data: {Id: editval, orderName: Name, brandDescription: Desc,bannerImage: editbimg,logoImage: editlogoimg},
                    success: function (result) {
                        console.log(result);
                        if (result == "true") {
        ...
        $("#yesActivate").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/activateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    ...
                    if (res.flag == 0) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/Ordertypecontroller/data_details/0',
                            "bJQueryUI": true,
                            "sPaginationType": "full_numbers",
                            "iDisplayStart ": 20,
                            "oLanguage": {
        ...
        $('#yesdeactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/deactivateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
           ...
           $('#yesDelete').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/Ordertypecontroller') ?>/deleteSymtom",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    console.log(JSON.parse(result));
...
<div class="page-content-wrapper" style="padding-top: 20px">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-left: 30px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 14px;"><?php echo 'ORDER TYPE'; ?></strong>
        </div>
        <!-- Nav tabs -->
        <div class="panel panel-transparent ">
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                <li id= "my1" class="tabs_active active" style="cursor:pointer">
                    <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/Ordertypecontroller/data_details/1" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                </li>

                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/Ordertypecontroller/data_details/0" data-id="0"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>

                  <li id= "my3" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode deleted_" data="<?php echo base_url(); ?>index.php?/Ordertypecontroller/data_details/2" data-id="0"><span><?php echo $this->lang->line('heading_delete'); ?></span> <span class="badge bg-red"></span></a>
                </li>
