...
//            "sPaginationType": "bootstrap",
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url(); ?>index.php?/DriverAcceptanceRate_controller/datatable_acceptedBookings/<?php echo $driverID;?>',
                "bJQueryUI": true,
...
<div class="page-content-wrapper" style="padding-top: 20px">
    ...
    <div class="content">
        ...
        <ul class="breadcrumb" style="margin-top: 5%;">
            <li>
                <a href="<?php echo base_url() ?>index.php?/superadmin/DriverAcceptanceRate" class="active">ACCEPTED BOOKINGS</a>
            </li>
            <li>
