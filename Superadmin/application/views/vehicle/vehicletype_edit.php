...
//            }
        ...
        $(":file").on("change", function (e) {
            ...
            } else
            {
                ...
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/vehicle/upload_images_on_amazon",
                    type: "POST",
                    data: form_data,
                    dataType: "JSON",
                    async: false,
                    ...
                    success: function (result) {
                        ...
                        {
                            case 1:
                                $('#onImageAWS').val('https://s3.amazonaws.com/' + result.fileName);
                                 $('.onImageAWS').attr('src','https://s3.amazonaws.com/'+result.fileName);
                                break;
                            case 2:
                                $('#offImageAWS').val('https://s3.amazonaws.com/' + result.fileName);
                                 $('.offImageAWS').attr('src','https://s3.amazonaws.com/'+result.fileName);
                                break;
                            case 3:
                                $('#mapImageAWS').val('https://s3.amazonaws.com/' + result.fileName);
                                 $('.mapImageAWS').attr('src','https://s3.amazonaws.com/'+result.fileName);
                                break;
                            default :
                                '';
        ...
        <div class="bg-white" data-pages="parallax">
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <form id="updateVehicleTypeForm" method="post" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php?/vehicle/update_vehicletype/<?php echo $param; ?>"  enctype="multipart/form-data">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane padding-20 slide-left active" id="tab1">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 pos_relative">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <span class="abs_textT"><?php echo $weightMetric; ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="address" class="col-sm-2 control-label">Choose Good Types</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <img style="width:35px;" src="<?php echo $vehicle_img; ?>" alt="" class="onImageAWS style_prevu_kit"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <img style="width:35px;" src="<?php echo $vehicle_img_off; ?>" alt="" class="offImageAWS style_prevu_kit"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <img style="width:35px;" src="<?php echo $MapIcon; ?>" alt="" class="mapImageAWS style_prevu_kit"></div>
                                                            ...
                                                            <div class="row row-same-height">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div <div class="col-sm-3 pos_relative2">
                                                                            ...
                                                                            <input type="text" id="mileage_after_x_km_mile" name="mileage_after_x_km_mile" class="form-control number" value="<?php echo $mileage_after_x_km_mile; ?>">                                                     <span  class="abs_text Mileagemetric"><?php echo $mileageMetric; ?></span>
                                                                        </div>
                            ...
                            <!--                                <div class="tab-pane padding-20 slide-left" id="tab3">
                                                                <div class="row row-same-height">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-3 input-group pos_relative">
                                                                            <input type="text" id="ride_baseFare" name="ride_baseFare" class="form-control" value="<?php echo $baseFare; ?>">
                                                                            <div class="input-group-addon">
                                                                                <span style="color: #73879C;"> <?php echo $currency; ?></span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div <div class="col-sm-3 pos_relative2">
                                                                                <span class="abs_textLeft">After</span>
                                                                                <input type="text" id="ride_mileage_after_x_km_mile" name="ride_mileage_after_x_km_mile" class="form-control number" value="<?php echo $mileage_after_x_km_mile; ?>">                                                     <span  class="abs_text Mileagemetric"><?php echo $mileageMetric; ?></span>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-3 pos_relative2"> 
                                                                                ...
                                                                                <span  class="abs_textLeft">After</span>
                                                                                <input type="text" id="ride_x_minutesTripDuration" name="ride_x_minutesTripDuration" class="form-control"  onkeypress="return isNumber(event)" placeholder="Enter Minutes" value="<?php echo $xminuts ?>">
                                                                                <span  class="abs_text">Minutes</span>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-3 pos_relative2"> 
                                                                                ...
                                                                                <span  class="abs_textLeft">After</span>
                                                                                <input type="text" id="ride_x_minutesWaiting" name="ride_x_minutesWaiting" class="form-control"  onkeypress="return isNumber(event)" placeholder="Enter Minutes" value="<?php echo $waiting_minutes ?>">
                                                                                <span  class="abs_text">Minutes</span>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-3 pos_relative2"> 
                                                                                <span  class="abs_textLeft">After</span>
                                                                                <input type="text" id="ride_x_minutesCancel" name="ride_x_minutesCancel" class="form-control"  onkeypress="return isNumber(event)" placeholder="Enter Minutes" value="<?php echo $cancellation_minutes ?>">
                                                                                <span  class="abs_text">Minutes</span>
                                                                            </div>
                                                                            <div class="col-sm-3 error-box" id="price_after_x_minCancelErr"></div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-3 pos_relative2"> 
                                                                                <input type="text" id="ride_x_minutesCancelScheduledBookings" name="ride_x_minutesCancelScheduledBookings" class="form-control"  onkeypress="return isNumber(event)" placeholder="Enter Minutes" value="<?php echo $scheduledBookingCancellationMin; ?>">
