    ...
    $.ajax({
               ...
               if (json.message == "success") {
                ...
                //    web images
                  ...
                  //get store list
                   $('#store').load("<?php echo base_url('index.php?/productOffers') ?>/getStoreData", {val: productoffer.zones});
                    //get frnchise
                   ...
                   $("#endtime").val(resend[1].substr(0,5));
                    ...
                    //csk editor
                    var data=productoffer["termscond"];
                   CKEDITOR.instances.termscond.setData(data);
                    //csk editor
                    var data=productoffer["howItWorks"];
                    CKEDITOR.instances.howItWorks.setData(data);
...
function citiesList(productoffer){
     ...
     var currencySymbol=productoffer.currencySymbol;
        ...
        $.ajax({    
                    ...
                    $("#cityId").html('<option value="" disabled selected>Select City</option>');
                        ...
                        for (var i = 0; i< json.length; i++) {
                            var citiesList = "<option currencySymbol="+json[i].currencySymbol+" abbrevation="+json[i].abbrevation+" value="+ json[i].cityId.$oid + ">"+  json[i].cityName +"</option>";
                            $("#cityId").append(citiesList);  
                           
                        }
                      
                        // <span class="abs_text"><b></b></span>
                        $('.abs_text').text(currencySymbol);
                        $("#cityId").val(cityId);
...
<div class="page-content-wrapper">
    ...
    <div class="brand inline" style="  width: auto;
            ...
            <strong style="color:#0090d9;">EDIT PRODUCT OFFERS</strong>
    </div>
                ...
                <div id="navbar-collapsible"  class="navbar-collapse collapse m-t-50">
                    ...
                    <form id="addentity" class="form-horizontal" role="form"
                                    ...
                                    <div class="row">
                                        <div class="imagesField">
                                            <div class="form-group pos_relative2">
                                                ...
                                                <div class="col-sm-6 pos_relative2">
                                                    <input type="file" name="imageupload" class="error-box-class form-control webimagesBanner" id="image1" attrId="1" value="Text Element 1">
                                        ...
                                        <div class="panel-body">
                                            <div class="summernote-wrapper">
                                                <div id="summernote">
                                                    ...
                                                    <label>Terms & Conditions<a target="_new" href="">Preview</a></label>
                        ...
                        <div class="panel-collapse collapse" id="collapseFour" style="height: 0px;">
                            ...
                            <div class="padding-30 bg-white col-sm-9" style="margin-left: 275px;">
