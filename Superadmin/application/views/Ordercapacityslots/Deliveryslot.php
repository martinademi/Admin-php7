    ...
    function dateTimeReturn(month,stTime){
        ...
        function callDataTable(status){
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryschduled/datatable_getSlotSchduled/<?php echo $deliveryworkingHourId ?>/'+offset,
                "bJQueryUI": true,
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
           ...
           <a href="<?php echo base_url() ?>index.php?/Deliveryschduled"> <strong style="font-size: 11px;margin-left: 15px;">DELIVERY SLOTS</strong></a> ><strong> Slot Details</strong><!-- id="define_page"-->
        </div>
