...
//            }
    ...
    function dateTimeReturn(month,stTime){
            ...
            d.setMonth(d.getMonth()+mon);
                    ...
                    console.log(dformat);
                        ...
                        function callDataTable(zoneId, status){
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Ordercapacityslots/datatable_getProviderDetails/'+zoneId+'/'+status+'/'+offset,
                                "bJQueryUI": true,
        ...
        //     // var valid = $(this).attr('data-id');
        //     // $.ajax({
        //     //         url: "<?php echo base_url() ?>index.php?/Ordercapacityslots/getSlotSchduled",
        //     //         type: "POST",
        //     //         data: {
        //     //             whId:valid
        //     //         },
        ...
        $('#yes').click(function(){
            ...
            if(val!=0 || val !='' || val!=null){
             ...
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Ordercapacityslots/deleteSchduled",
                    type: "POST",
                    data: {
                        whId:val
                    },
        ...
        $('#yesSlot').click(function(){
            ...
            if(val!=0 || val !='' || val!=null || date!="" || sTime!="" || eTime!=""){
             //  console.log("val",val);
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Ordercapacityslots/deleteParticularSlot",
                    type: "POST",
                    data: {
                        whId:val,
                        date: date,
        ...
        $('#addSlot').click(function(){
            ...
            if($("#pDate").val() == '' )
            {
                ...
                var zoneId = '<?php echo $zoneId; ?>'
            $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Ordercapacityslots/addSlotSchduled",
                    type: "POST",
                    data: {
                        objId:objId,
                        slotDate:slotDate,
        ...
        $("#insert_cat_group").click(function () {
           ...
           // console.log("offset",offset);
            ...
            //    return;
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Ordercapacityslots/addSchduled/<?php echo $zoneId;?>/<?php echo $cityId;?>",
                    type: "POST",
                    data: {
                        //BusinessId:fid,
                        stTime:stTime,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Ordercapacityslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/'+offset,
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
//                  $('#big_table_processing').hide();
        ...
        $('.changeMode').click(function () {
            ...
            {
               targetUrl = "<?php echo base_url(); ?>index.php?/Ordercapacityslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/"+offset ;
            } else if($(this).attr('data-id') == 2) {
                targetUrl = "<?php echo base_url(); ?>index.php?/Ordercapacityslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/2/"+offset ;
            }
            else{
                targetUrl = "<?php echo base_url(); ?>index.php?/Ordercapacityslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/3/"+offset ;
            }
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            ...
            <strong style="font-size: 12px;margin-left: 15px;">ORDER CAPACITY DETAILS</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="panel panel-transparent ">
                     ...
                     <div class="pull-left col-sm-6" >
                        <div class="">
                            <ul class="breadcrumb" style="background:white;margin-top: 0%;">
                                ...
                                <li><a class="active" href="<?php echo base_url() ?>index.php?/Deliveryslots/slots/<?php echo $zoneId;?>/<?php echo $slotId;?>" class="">Delivery Slots</a> </li>
                                <li><a class="active" href="#" class="">Order Capacity</a> </li>
                            </ul>
                        </div>
                     </div>
                    ...
                    <div class="tab-content">
                        <div class="container-fluid container-fixed-lg bg-white col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row clearfix pull-left" style="margin-left:35px;">
                                    <div class="pull-left">
                                            <select class="form-control pull-left" id="orderFilter">
                             ...
                             <div class="pull-right hide_show" ><input type="text" id="search-table1" class="form-control pull-right" placeholder="Search" style="display: block;margin-right: 15px;margin-top: 2px;width: 140px;border-radius: 13px"> </div>                         
