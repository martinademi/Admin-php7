...
input#x_minutesCancel,#x_minutesWaiting,#x_minutesTripDuration,#mileage_after_x_km_mile,#x_km_mile_price {
    padding-left: 74px;
}   
 ...
 function RemoveMore(Id)
    ...
    $(document).ready(function () {
         ...
         $(".clear").click(function () {
             $('.onImageAWS').attr('src','');
             $('.onImageAWS').hide();
             $('.offImageAWS').attr('src','');
             $('.offImageAWS').hide();
             $('.mapImageAWS').attr('src','');
             $('.mapImageAWS').hide();
        ...
        $('.checkbox1').click(function ()
        {
            if($(this).is(":checked"))
            {
                 $('.selectedGoodType').append('<span class="selectedGood" id="RemoveControl'+$(this).attr('id')+'"><input readonly type="text" class="inputDesc"  value="'+$(this).attr('goodType')+'"><input type="button"   value="&#10008" data-id="'+$(this).attr('id')+'" class="RemoveMore">')
        ...
        <div class="bg-white" data-pages="parallax">
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                     ...
                     <form id="addVehicleTypeForm" method="post" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php?/superadmin/insert_vehicletype"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-3 input-group pos_relative">
                                         ...
                                         <div class="col-sm-3 pos_relative2"> 
                                              <input type="text" id="x_minutesCancelScheduledBookings" name="x_minutesCancelScheduledBookings" class="form-control"  onkeypress="return isNumber(event)" value="<?php echo $scheduledBookingCancellationMin;?>">
