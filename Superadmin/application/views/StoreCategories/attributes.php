...
<script> 
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/StoreCategoryController/operationCategory/tableAttributes/1/<?php echo $name;?>/<?php echo $id;?>',
            "bJQueryUI": true,
...
?>'
        ...
        $('#big_table').on("click", '.addOnsList', function () {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>/StoreCategoryController/operationCategory/tableAttributes/' + status +'/<?php echo $name;?>/<?php echo $id;?>',
                type: "POST",
                data: {id: id},
                dataType: "JSON",
...
//        $('#editTax').click(function () {
        $(document).on('click', '.editAttributes', function () {
            ...
            editval = $(this).val();
            window.location.href="<?php echo base_url() ?>index.php?/StoreCategoryController/editAttributes/"+editval+"/<?php echo $name?>/<?php echo $id?>";
        ...
        $("#yesEdit").click(function () {
            ...
            } else if (edittaxValue == '' || edittaxValue == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/StoreCategoryController') ?>/editTax",
                    type: "POST",
        ...
        $("#yesActivate").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/StoreCategoryController') ?>/operationCategory/activateAttribute",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    ...
                    if (res.flag == 0) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/StoreCategoryController/operationCategory/tableAttributes/2/<?php echo $name;?>/<?php echo $id;?>',
                            "bJQueryUI": true,
                            "sPaginationType": "full_numbers",
                            "iDisplayStart ": 20,
                            "oLanguage": {
        ...
        $('#yesdeactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/StoreCategoryController') ?>/operationCategory/deactivateAttribute",
                type: "POST",
                data: {Id: val},
                success: function (result) {
        ...
        $('#yesdelete').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/StoreCategoryController') ?>/operationCategory/deleteAttribute",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    console.log(JSON.parse(result));
                    ...
                    if (res.flag == 0) {
                        ...
                        $('#errorModal').modal('show')
                        $(".modalPopUpText"). text('<?php echo $this->lang->line('select_deleted'); ?>');
                    }
...
<ul class="breadcrumb" style="margin-left: 0px; margin-top: 5%;">
        <li><a href="<?php echo base_url(); ?>index.php?/StoreCategoryController" class=""><?php echo $name; ?></a></li>
    ...
    <div class="content">
        ...
        <!--<div class="brand inline" style="  width: auto; margin-left: 30px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 14px;"><?php echo $this->lang->line('heading_page_attributes'); ?></strong>
        </div>-->
        <!-- Nav tabs -->
        <div class="panel panel-transparent ">           
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                <li id= "my1" class="tabs_active active" style="cursor:pointer">
                    <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/StoreCategoryController/operationCategory/tableAttributes/1/<?php echo $name;?>/<?php echo $id;?>" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                </li>

                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/StoreCategoryController/operationCategory/tableAttributes/2/<?php echo $name;?>/<?php echo $id;?>" data-id="2"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>
                <li id= "my3" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode deleted_" data="<?php echo base_url(); ?>index.php?/StoreCategoryController/operationCategory/tableAttributes/3/<?php echo $name;?>/<?php echo $id;?> " data-id="3"><span><?php echo $this->lang->line('heading_deleted'); ?></span> <span class="badge bg-red"></span></a>
                </li>
            </ul>
            <ul class="nav nav-tabs nav-tabs-simple whenclicked bg-white new_button" style="" role="tablist" data-init-reponsive-tabs="collapse">
                ...
                <div class="pull-right m-t-10"><a href="<?php echo base_url() ?>index.php?/StoreCategoryController/addAttributes/<?php echo $name?>/<?php echo $id?>"> <button class="btn btn-success pull-right m-t-10" id="addAttributes"><?php echo $this->lang->line('button_add'); ?> </button></a></div>
