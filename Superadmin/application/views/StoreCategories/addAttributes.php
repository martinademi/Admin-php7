...
<script>
    ...
    function redirectToDest() {
        window.location.href = "<?php echo base_url(); ?>index.php?/StoreCategoryController/attributes/<?php echo $name?>/<?php echo $id?>";
    }
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="navbar-collapsible"  class="navbar-collapse collapse m-t-50">
                    ...
                    <form id="addentity" class="form-horizontal" role="form"
                          action="<?php echo base_url(); ?>index.php?/StoreCategoryController/operationCategory/AddNewAttributes/<?php echo $name?>/<?php echo $id?>"
                        ...
                        <div class="tab-content">
                            ...
                            <div class="row row-same-height">
                                ...
                                <div class="form-group pos_relative2">
                                    <label for="fname" class="col-sm-3 control-label error-box-class "><?php echo $this->lang->line('label_GroupName'); ?> <span style="" class="MandatoryMarker"> *</span></label>
                                ...
                                foreach ($language as $val) {
                                    if ($val['Active'] == 1) {
                                        ?>
                                        <div class="form-group pos_relative2">
                                            <label for="fname" class="col-sm-3 control-label "><?php echo $this->lang->line('label_GroupName'); ?> (<?php echo $val['lan_name']; ?>)<span style="" class="MandatoryMarker"> *</span></label>
                                            <div class="col-sm-5 pos_relative2">
                                ...
                                <div class="form-group pos_relative2">
                                    <label for="fname" class="col-sm-3 control-label"><?php echo $this->lang->line('label_Desc'); ?> </label>
                                    <div class="col-sm-5 pos_relative2">
                                ...
                                <div class="customField ">
                                    <div class="customPriceField" id="customePriceMain">
                                        ...
                                        <div class="form-group pos_relative2 customPriceField1">
                                            <label id="titleLabel" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_Attributes'); ?> 1<span style="" class="MandatoryMarker"> *</span></label>
                                            <div class="col-sm-3 pos_relative2">
                                                <span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>
                                                <input type="text" name="attributes[0][name][en]" class="error-box-class  form-control productTitle" id="title0"  placeholder="Enter here">
                                            </div>
                                        ...
                                        foreach ($language as $val) {
                                            if ($val['Active'] == 1) {
                                                ?>
                                                <div class="form-group pos_relative2  customPriceField1">
                                                    <label id="titleLabel" for="fname" class="col-sm-2 control-label"><?php echo $this->lang->line('label_Attributes'); ?> 1(<?php echo $val['lan_name']; ?>)</label>
                                                    <div class="col-sm-3 pos_relative2">
                                                        <span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>
                                                        <input type="text" name="attributes[0][name][<?= $val['langCode']; ?>]" class="error-box-class  form-control productTitle" id="title0"  placeholder="Enter Title">
                                                    </div>
                                            ...
                                            <?php } else { ?>
                                                <div class="form-group pos_relative2  customPriceField1" style="display:none">
                                                    ...
                                                    <div class="col-sm-3 pos_relative2">
                                                        <span  class="abs_text"><b><?php echo $this->lang->line('label_Title'); ?></b></span>
                                                        <input type="text" name="attributes[0][name][<?= $val['langCode']; ?>]" class="error-box-class  form-control productTitle" id="title0"  placeholder="Text Element ">
                                                    </div>
