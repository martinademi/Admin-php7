...
<script>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/Promotions/datatable_Promotions/1',
            "bJQueryUI": true,
   ...
   $('.changeMode').click(function () {
        ...
        $('#view').click(function(){
             var val = $('.checkbox:checked').attr('data-id');
              if (val.length == 0) {
                ...
                window.location.href ='<?php echo base_url()?>index.php?/Promotions/viewPromotion/1/'+val;
            }
         ...
         $('#Edit').click(function(){
             var val = $('.checkbox:checked').attr('data-id');
              if (val.length == 0) {
                ...
                window.location.href ='<?php echo base_url()?>index.php?/Promotions/editrpromotion/1/'+val;
            }
        ...
        $('.deactivate').click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/Promotions/inactivePromotion",
                type: "POST",
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/Promotions/datatable_Promotions/2',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
...
//                      $( "#refid" ).load(window.location.href + " #refid" );
        ...
        $('.hitTosure').click(function () {
         var mongoid = $('#hittosure').attr('data-id');
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/Promotions/activePromotion",
                type: "POST",
                data: {'mongoid': mongoid},
                dataType: "JSON",
                success: function (result) {
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-transparent">
                <ul class="nav nav-tabs nav-tabs-simple bg-white m-t-20" role="tablist" data-init-reponsive-tabs="collapse">
                    <li class="active">
                        <a><strong style="font-size: 14px;color:#0090d9;">PROMOTION</strong></a>
                    </li>
                </ul>
                    ...
                    <li id="1" class="tabs_active active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/Promotions/datatable_Promotions/1" data-id="1"><span><?php echo LIST_ACCEPTED; ?> </span></a>
                    </li>
                    <li id="2" class="tabs_active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/Promotions/datatable_Promotions/2" data-id="2"><span><?php echo LIST_REJECTED; ?></span></a>
                    </li>
                
                        <div class="pull-right"> <button class="btn btn-primary" id="view" >VIEW</button></div>
                        <div class="pull-right"> <button class="btn btn-warning" id="activate" >ACTIVATE</button></div>
                                                <div class="pull-right"> <button class="btn btn-info" id="Edit" >EDIT</button></div>
                        <div class="pull-right"> <button class="btn btn-warning" id="deactivate" >DEACTIVATE</button></div>
                        <div id="add" class="pull-right"><a href="<?php echo base_url() ?>index.php?/Promotions/Createpromotion/1"><button id="show-modal" class="btn btn-primary" ><i class="fa fa-plus"></i> CREATE </button></a></div>
                </ul>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
               ...
               <span class="modal-title"></span>
                ...
                <div class="modal-footer">
                <button type="button" id="btndeactivate" class="btn btn-primary btn-cons deactivate" data-id="" data-dismiss="modal">Continue</button>
              </div>
            </div>
        </div>
        <!-- /.modal-content -->
...
<div class="modal fade slide-up disable-scroll in" id="alertmodal" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog">
        <div class="modal-content-wrapper">
            <div class="modal-content">
                 <div class="modal-header">
               ...
               <span class="modal-title"></span>
                ...
                <div class="modal-body">
                    <h4 class="no-margin p-b-10">Promo code has been expired, you cannot activate it..</h4>
