...
//        $('#selectedcityNew option[value=' + campaningData.cityName + ']').prop("selected", true);
...
//        $('#endtime').wickedpicker({twentyFour: true, now:formattedTime});
...
//        $("input[name=rewardtype][value=" + PromoData.rewardType + "]").prop('checked',true);
...
$('.submitDataOnserver').prop("disabled", true);
...
//                var rewardTypeExpiryDate = getDateINtimpstamp(ExpiryDate[2] + '-' + ExpiryDate[0] + '-' + ExpiryDate[1] + ' ' + $('#ExpiryTime').val().trim());//'2013-09-17 10:08'
                var DataTOSend = {
//                    code: PromoData.code,
//                    'discount': amount,
//                    promotionType: 1,
