        ...
        <script type="text/javascript">
               ...
               function VerifyNsendLink()
            {
                ...
                } else
                {
                    ...
                    $.ajax({
                        url: "<?php echo APILink ?>superadmin/forgotPassword",
                        type: 'POST',
...
<?php//                        echo Appname; ?> 
            ...
            <div class="login-container">
                <div class="m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
				 <img src="<?php base_url() ?>theme/icon/delivxlogin.png" style="width:50%;height:auto !important; margin-left:25%;padding-bottom: 25px"/>
