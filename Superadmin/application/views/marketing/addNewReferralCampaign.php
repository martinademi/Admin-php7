...
//        CKEDITOR.replace('editor1');
        ...
        $("input[name=referralDiscountValue]").click(function (event) {
            event.stopPropagation();
        });

        

        $("input[name=rewardTriggerType]").click(function (event) {
            event.stopPropagation();
        });
...
// Change the field for new user percentage value-------- changes
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                <div class="inner" style="">
                    ...
                    <ul class="breadcrumb" style="">
                        ...
                        <li class="breadClass"><a href="<?php echo base_url(); ?>index.php?/referralController/index/1" class="active">Referal Campaign</a>&nbsp>&nbsp<a href="#" style="color: #0090d9 !important; font-size: 11px !important">Create New Referral Campaign</a>
                        </li>
                                                    ...
                                                    <div class="form-group col-xs-12 ">
                                                        ...
                                                        <div class="col-sm-6 removePadding">
                                                            <div class="radio radio-success">
                                                                ...
                                                                <label onclick="calltrigger('newUserTripCountTrigger')">ORDER COUNT</label>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio radio-success">
                                                    ...
                                                    <label onclick="calltrigger('referrerWalletCredit')">Wallet Credit</label>
                                                     <input type="radio" class ="marginLeft"  value="2" name="referrerRewardType" id="referrerCouponDelivery">
                                                    <label onclick="calltrigger('referrerCouponDelivery')">Coupon Delivery</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio radio-success">
                                                    ...
                                                    <label onclick="calltrigger('newUserWalletCredit')">Wallet Credit</label>
                                                     <input type="radio" class ="marginLeft"  value="2" name="newUserRewardType" id="newUserCouponDelivery">
                                                    <label onclick="calltrigger('newUserCouponDelivery')">Coupon Delivery</label>
                                                </div>
                                            </div>
                                        </div>
                                       <div class="error-box" id="paymentMethodError"></div>
