...
<script>
     function getAcceptedDataTables(){
           /* $('#campaigns-datatable').DataTable({
                 ...
                 "bSort" : true,
                 "ajax": {
                    url : "<?php //echo base_url('index.php?/campaigns/getUnlockedDetailsById/'. $campaignId .'/0/10');?>",  //1 MEANS NEW
                    type : 'POST'
                },
            });*/
            ...
            var settings = {
                ...
                "serverSide": true,
                "ajax": {
                    url : "<?php echo base_url('index.php?/campaigns/getUnlockedDetailsById/'. $campaignId .'/');?>",
                    type : 'POST',
                    "data": function (d) {
                                        ...
                                        <div class="row clearfix" >
                                            <div class="col-sm-12">
                                                <ul class="breadcrumb">
                                                  ...
                                                  <li><a href="<?php echo base_url('index.php?/Campaigns/qualifyingTripData'. $campaignId .'/0/10');?>" style="color: dodgerblue !important;">Campaign unlocked bookings</a></li>
