     ...
     function getAcceptedDataTables(){
         ...
         var table = $('#campaigns-datatable');
            var settings = {
                ...
                "serverSide": true,
                "ajax": {
                    url : "<?php echo base_url('index.php?/campaigns/getClaimDetailsByClaimId/'. $campaignId .'/');?>",
                    type : 'POST',
                        ...
                        <div class="tab-content">
                            <div class="container-fluid container-fixed-lg bg-white">
                                ...
                                <div class="panel-heading">
                                                <ul class="breadcrumb">
                                                  <li><a href="<?php echo base_url('index.php?/campaigns/index/1');?>" style="color: dodgerblue !important;">Promo campaigns</a></li>
