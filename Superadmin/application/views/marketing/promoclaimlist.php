  ...
  <script type="text/javascript"> 
    $(document).ready(function() {
        ...
        $(".cityDetails").live('click', function(){
            ...
            $.ajax({
            url: "https://api.deliv-x.com/admin/cityDetailsByCityIds/" + cityIds,
            type: 'GET',
            dataType: 'json',
            headers: {
                  language: 0
...
<script>
     function getAcceptedDataTables(){
          /*  $('#campaigns-datatable').DataTable({
                 ...
                 "bSort" : true,
                 "ajax": {
                    url : "<?php //echo base_url('index.php?/campaigns/getClaimDetailsByClaimId/'. $campaignId .'/0/10');?>",  //1 MEANS NEW
                    type : 'POST'
                 },
         ...
         var table = $('#campaigns-datatable');
            var settings = {
                ...
                "serverSide": true,
                "ajax": {
                    url : "<?php echo base_url('index.php?/couponCode/getClaimDetailsByClaimId/'. $campaignId .'/');?>",
                    type : 'POST',
                        ...
                        <div class="tab-content">
                            <div class="container-fluid container-fixed-lg bg-white">
                                ...
                                <div class="panel-heading">
                                                <ul class="breadcrumb">
                                                  <li><a href="<?php echo base_url('index.php?/CouponCode/index/1');?>" style="color: dodgerblue !important;">Promo code claim list</a></li>
                                                  <li><a href="<?php //echo base_url('index.php?/Campaigns/qualifyingTripData'. $campaignId .'/0/10');?>" style="color: dodgerblue !important;">Qualified Bookings</a></li>
                                                  <div class="pull-right"><input type="text" id="search_table" class="form-control pull-right" placeholder="<?php echo SEARCH; ?>"> </div>
                                                </ul>
                                    <div class="row">
