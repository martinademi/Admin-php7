...
function calltrigger(element) {
        ...
        if (element == 'referrerFixedValue') {
           ...
           // $(".newUserForPercentage").addClass('hide');
            ...
            console.log("refer percentage value");
        ...
        $('.postAOffer').click(function () {
            ...
            var dataToInsert = JSON.stringify({
                               ...
                               // "paymentMethod": 0,
                                ...
                                "rewardTriggerType": $("#newUserTripCountTrigger").val(),
              ...
              var promodata=json["data"][0];
               ...
               if (xhr.status == 200) {
                ...
                //    changes end *****
                    ...
                    //new user disount reward type 
                    console.log("prom");
                    console.log(promodata["newUserDiscount"]["rewardType"]);
                    if(promodata["newUserDiscount"]["rewardType"]==1){
                      ...
                      //new user discount type
                      console.log("user discount type");
                      console.log(promodata["newUserDiscount"]["discountType"]);
                    ...
                    //referer discount
                    console.log("refer discount");
                    console.log(promodata["referrerDiscount"]["rewardType"]);
                    ...
                    //refer discount type
                    console.log("refer discount type");
                    console.log(promodata["referrerDiscount"]["discountType"]);
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                <div class="inner" style="">
                    ...
                    <ul class="breadcrumb" style="">
                        ...
                        <li class="breadClass"><a href="<?php echo base_url(); ?>index.php?/referralController/index/1" class="active">Referal Campaign</a>&nbsp>&nbsp<a href="#" style="color: #0090d9 !important; font-size: 11px !important">Edit Referral Campaign</a>
                        </li>
                                        ...
                                        <div class="form-group  col-xs-12 ">
                                            <label for="fname" class="col-sm-2 control-label aligntext" style="margin-left: -1%; margin-right: 1%;">TOTAL BILLING AMOUNT REQUIRED</label>
                                                <div class="col-sm-3 removePadding">
                                                    <input type="text" class="addmemclass1 form-control" id="newUserBillingAmountTrigger"  placeholder=""   required="" aria-required="true" onkeypress="return isNumberKey(event, 'amount')">                                                                                            
