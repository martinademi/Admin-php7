...
#add,#deactivate,#del_all,#adactive{
...
<!------------------------------------------ for assign route to the student---------------------------------------------->
        ...
        $.ajax({
                ...
                $("#citiesList").html('<option value="" disabled selected>Select City</option>');
...
<div class="page-content-wrapper" style="padding-top: 20px">
    <!-- START PAGE CONTENT -->
        ...
        <div class="brand inline" style="  width: auto;
            ...
            <strong style="color:#0090d9;">REFERAL CAMPAIGNS</strong><!-- id="define_page"-->
        </div>
            <!-- Nav tabs -->
            <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                ...
                <div class="pull-right m-t-10 new_button" id="deleteTab">
                 ...
                 <div class="pull-right m-t-10 new_button" id="deactivateTab">
                    <a href="#">
                ...
                <div class="pull-right m-t-10 new_button" id="activeTab">
                    <a href="#"> 
