...
if ($data['res']['payment_type'] == 1) {
    $payment = unserialize(paymentMethod)[$data['res']['payment_type']];
...
$arrColor = array(6 => "background:#933EC5!important", 7 => "background:#FFDA44!important", 8 => "background:#006DF0!important", 9 => "background:#402B4D!important", 16 => "background:#91DC5A!important", 10 => "background:#044857!important");
$arrStatusCode = array(6 => "A", 7 => "B", 8 => "C", 9 => "D", 16 => "E", 10 => "F");
?>    
...
<div class="page-content-wrapper">
    <div class="content">
        ...
        <ul class="breadcrumb" style="margin-top: 5%;">
            <li>
                <a href="#" class="active">TRIP DETAILS - <?php echo $order_id; ?></a>
            </li>
            <?php
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-simple hidden-xs" role="tablist" data-init-reponsive-tabs="collapse">
                                    ...
                                    <li class="active tabs_active">
                                        <a href="#customer_details" data-toggle="tab" role="tab" aria-expanded="true">SUMMARY</a>
                                    </li>
                                ...
                                <div  class="tab-content hidden-xs">
                                    <div class="tab-pane active" id="customer_details">
                                        <?php if ($data['res']['status'] == 3 || $data['res']['status'] == 4) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6" style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Vehicle Type</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo $data['res']['vehicleType'][0]['type_name']; ?>
                                                    </p>
                                                </div>
                                                <div class="col-sm-6">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Pricing Model & Trip Type</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo ($data['res']['zoneType'] == 1) ? $data['res']['pricingModel'] . ' & Long Haul' : $data['res']['pricingModel'] . ' & Short Haul'; ?>
                                                    </p>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row" style="margin-top: 4%;">
                                                <div class="row">
                                                    <div class="col-sm-6" style="padding-left: 22px;">
                                                        <p class="no-margin"> <img src="<?php echo base_url(); ?>../../pics/pickup_small_icon.png" class="img-rounded" alt="" width="20px" height="20px">
                                                            <a href="#" class="headinClass">Pickup At</a>
                                                        </p>

                                                        <p class="small hint-text pickupAddr">
                                                            <?php echo $data['res']['address_line1']; ?>       
                                                        </p>

                                                    </div>
                                                    <div class="col-sm-6" >
                                                        <p class="no-margin"><img src="<?php echo base_url(); ?>../../pics/dropdown_small_icon.png" class="img-rounded" alt="" width="20px" height="20px">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                <div class="col-sm-6" style="padding-left: 22px;">
                                                    ...
                                                    <p class="small">
                                                    <p class="small"> <?php echo $data['res']['slaveCountryCode'] . $data['res']['slavemobile']; ?></p> 
                                                    </p>
                                                    <span class="errors" id="slavePhoneErr"></span>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Receiver's Signature</a>
                                                    </p>
                                                    <p class="small">
                                                        <img alt="<?php echo $data['res']['receivers']['0']['signatureUrl']; ?>" style="height:70px;width:70px;"
                                                             data-src-retina="<?php echo $data['res']['receivers']['0']['signatureUrl']; ?>" 
                                                             data-src="<?php echo $data['res']['receivers']['0']['signatureUrl']; ?>"
                                                             src="<?php echo $data['res']['receivers']['0']['signatureUrl']; ?>"
                                                             onerror="this.src = '<?php echo base_url('/../../pics/error.png') ?>'">
                                                    </p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6"  style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Trip Duration</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo $data['res']['invoice']['time'] . ' Minutes'; ?>
                                                    </p>
                                                </div>
                                                <div class="col-sm-6" >
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Total Fare</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo $data['appConfig']['currencySymbol'] . ' ' . $data['res']['invoice']['total']; ?>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6"  style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Trip Distance</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php
                                                        if ($data['res']['status'] == 10) {
                                                            echo number_format($data['res']['receivers'][0]['DriverTripDistance'], 2) . ' ';
                                                            echo ($data['appConfig']['mileage_metric'] == 1) ? 'Mile' : 'Km';
                                                        } else {
                                                            echo number_format($data['res']['invoice']['distance'], 2) . ' ';
                                                            echo ($data['appConfig']['mileage_metric'] == 1) ? 'Mile' : 'Km';
                                                        }
                                                        ?>
                                                    </p>
                                                ...
                                                <div class="col-sm-6" >
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Deadhead</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php
                                                        echo number_format($data['res']['receivers'][0]['DriverPickupDistance'], 2);
                                                        echo ($data['appConfig']['mileage_metric'] == 1) ? ' Mile' : ' Km';
                                                        ?>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6"  style="padding-left: 22px;">
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Waiting Time</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo $data['res']['invoice']['watingtime'] . ' Minutes'; ?>
                                                    </p>
                                                </div>
                                                <div class="col-sm-6" >
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Waiting Fee</a>
                                                    </p>
                                                    <p class="small">
                                                        <?php echo $data['appConfig']['currencySymbol'] . ' ' . $data['res']['invoice']['watingFee']; ?>
                                                    </p>
                                                </div>
                                            </div>
                                            <hr>
    ...
    <!--                                                    <p class="no-margin">
                                                    ...
                                                    <p class="small"> <i class="fa fa-credit-card" aria-hidden="true"></i>
                                                    <?php // echo $card;   ?>
                                                    </p>-->
                                                    <p class="no-margin">
                                                        <a href="#" class="headinClass">Payment Type</a>
...
foreach ($data['res']['activities'] as $resArray) {
    if ($resArray['bid'] == $data['res']['order_id']) {
        ?>
        ...
        <?php echo $arrStatusCode[$resArray['status']]; ?><span  class="bullet_points" style="<?php echo $arrColor[$resArray['status']]; ?>"></span>
                                    ...
                                    <div class="tab-pane" id="consignment_details">
                                        <div class="row" style="margin-top:4%">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="no-margin">
                                                    <a href="#" class="headinClass">Good Type</a>
                                                </p>
                                                <p class="small">
                                                    <?php
                                                    if ($data['res']['receivers']['0']['goodType'])
                                                        echo $data['res']['receivers']['0']['goodType'];
                                                    else
                                                        echo "-";
                                                    ?>
                                                </p>
                                            ...
                                            <div class="row"style="margin-top:2%" >
                                                ...
                                                <div>
                                                    <p class="no-margin" class="headinClass">
                                                        <a class="headinClass" style="width: 100px;height: 100px;">Customer</a>
                                                    </p>
                                                </div>
        ...
        <!--                                                        <a target="_blank" href="<?php echo $images; ?>">
                                        ...
                                        <?php if ($data['res']['receivers'][0]['pickupImages']) { ?>
                                            <div class="row" >
                                                ...
                                                <div >
                                                    <p class="no-margin" class="headinClass">
                                                        <a class="headinClass" style="width: 100px;height: 100px;">Driver( At Pickup )</a>
                                                    </p>
                                                </div>
