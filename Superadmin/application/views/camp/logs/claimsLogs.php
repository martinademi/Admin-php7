...
<script>
    ...
    function moveUp(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>index.php?/logs/getAllQualifiedTripLogs",
            type: "POST",
    ...
    $(document).ready(function () {
      ...
      var table = $('#big_table');
        ...
        var settings = {
            ...
            "iDisplayLength": 10,
            "bProcessing": true,
           "sAjaxSource": '<?php echo base_url() ?>index.php?/promoCodeModel/getAllClaimsLogs/' + "<?php echo $campaignId ?>" ,
            "bJQueryUI": true,
      ...
      var table = $('#big_table');
        ...
        var settings = {
            ...
            "sAjaxSource": '<?php echo base_url() ?>index.php?/logs/getAllQualifiedTripLogs',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 0,
            "columns": [
