                                        ...
                                        <div class="col-md-12 b-b  b-l b-r b-grey p-b-10 p-t-10 citiesData">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <div class="col-sm-5 row pull-right">
                                                    <div class="pull-right"><input type="text" id="search-tables" class="form-control pull-right" placeholder="<?php echo $this->lang->line('search'); ?>" style="border-radius: 13px;height: 32px;"> </div>
                                                </div>
                                            </div>
