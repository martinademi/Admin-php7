...
<script>
     function getAcceptedDataTables(){
            $('#campaigns-datatable').DataTable({
                 ...
                 "bSort" : true,
                 "ajax": {
                    url : "<?php echo base_url('index.php?/ReferralController/getAllCamRefCodesByUser/5a9c39f90d42ad649634413f/5a9ccad828808b4881e20373/0/10');?>",  //1 MEANS NEW
                    type : 'POST'
                },
            });
        }
                            ...
                            <div class="container-fluid container-fixed-lg bg-white">
                                ...
                                <div class="panel panel-transparent">
                                    ...
                                    <div class="panel-body">
                                        <table id="campaigns-datatable" border = "1" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>S. NO.</th>
                                                    <th>NAME</th>
