     ...
     function getAcceptedDataTables(){
         console.log("apha 346");
          /*  $('#campaigns-datatable').DataTable({
                 ...
                 "bSort" : true,
                 "ajax": {
                    url : "<?php //echo base_url('index.php?/campaigns/getQualifiedTripDatas/'. $campaignId .'/0/10');?>",  //1 MEANS NEW
                    type : 'POST'
                },
            });*/
            ...
            var settings = {
                ...
                "serverSide": true,
                "ajax": {
                    url : "<?php echo base_url('index.php?/campaigns/getQualifiedTripDatas/'. $campaignId .'/');?>",
                    type : 'POST',
                    "data": function (d) {
