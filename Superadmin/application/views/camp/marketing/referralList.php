<?php
/*
This page is generated for referral codes generated while campaign active
 */
...
<script>
     function getAcceptedDataTables(){
         console.log("alpha 56");
        /*var requestURL = "<?php //echo base_url('index.php?/ReferralController/referralCodesByCampaignId/'. $campaignId . '/0/10') ?>";*/
          /*  $('#campaigns-datatable').DataTable({
                 "pageLength" : 10,
                 "sPaginationType" : "full_numbers",
                 "aaSorting": [],
                 ...
                 "ajax": 
                 {
                    url : "<?php //echo base_url('index.php?/ReferralController/referralCodesByCampaignId/'. $campaignId . '/0/10') ?>",
                    type : 'GET',
                    "cache": true,
                },
            });*/
            ...
            var settings = {
                ...
                "serverSide": true,
                "ajax": {
                    url : "<?php echo base_url('index.php?/ReferralController/referralCodesByCampaignId/'. $campaignId . '/') ?>",
                    type : 'POST',
                    "data": function (d) {
                                ...
                                <div class="panel panel-transparent">
                                    <div class="panel-heading">     
                                        ...
                                        <div class="row clearfix" >
                                            <div class="col-sm-12">
                                                <ul class="breadcrumb">
                                                  <li><a href="<?php echo base_url('index.php?/referralController/index/1');?>" style="color: dodgerblue !important;">Referral</a></li>
                                                  <li>
                                                    <a href="<?php echo base_url('index.php?/Campaigns/qualifyingTripData'. $campaignId .'/0/10');?>" style="color: dodgerblue !important;">Referral codes</a>
                                                </li>
                                                </ul>
                                                <!-- <div class="searchbtn" >
