                        ...
                        <div class="tab-content">
                            <div class="container-fluid container-fixed-lg bg-white">
                                ...
                                <div class="panel-heading">
                                                <ul class="breadcrumb">
                                                  <li><a href="<?php echo base_url('index.php?/campaigns/index/1');?>" style="color: dodgerblue !important;">Loyalty Program</a></li>
                                                  <li><a href="<?php echo base_url('index.php?/Campaigns/qualifyingTripData'. $campaignId .'/0/10');?>" style="color: dodgerblue !important;">Claims</a></li>
