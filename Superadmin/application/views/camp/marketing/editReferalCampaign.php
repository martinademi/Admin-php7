    ...
    function calltrigger(element) {
        ...
        if (element == 'referrerFixedValue') {
            ...
            if ($('#offerAvailImmediateNewUser').is(':checked')) {
                calltrigger('newUserPercentageValue');
            } else {
            ...
            if (parseInt($('#newUserBillingAmountTrigger').val()) == 0) {
                $('#offerAvailImmediateRefUser').attr('checked', true);
                $('#offerAvailImmediateRefUser').attr('disabled', true);
                $('#offerAvailImmediateNewUser').attr('checked', true);
                $('#offerAvailImmediateNewUser').attr('disabled', true);
...
function citiesList(){
    ...
    function getAllCategoryByCityId(cityIds, Refcategory, Newcategory) {
        $.ajax({
            ...
            if (json.data.length == 0) {
                ...
                if (Newcategory != "undefined" && Newcategory != undefined)
                {
                    $.each(Newcategory, function (index, val) {
                ...
                if (Refcategory != "undefined" && Refcategory != undefined) {
                    $.each(Refcategory, function (index, val) {
                        var catdata = val.catId;
                        $('#catList2').multiselect('select', val.catId);
                    });
                }
    ...
    // Ajax to fill the form 
        ...
        $('#tripCount').keyup(function () {
            if (parseInt($(this).val()) == 0) {
                ...
                //
                $('#referrerFixedValue').trigger('click');
                $('#referrerPercentageValue').attr('disabled', true);
...
//                $('#newUserPercentageValue').attr('disabled', false);
        ...
        $.ajax({
            url: "<?php echo APILink ?>" + 'referralCampaignDetailsById/' + "<?php echo $campaignId ?>",
            type: "GET",
            dataType: "JSON",
            headers: {
                      language: 0
            ...
            console.log(json);
            //console.log(promodata["title"]);
            //console.log(promodata["paymentMethod"]);
            if (json.message == "Success") {
                ...
                if (promodata.newUserDiscount.offerAvailImmediate && promodata.newUserDiscount.offerAvailImmediate == true)
                {
                    $('#offerAvailImmediateNewUser').attr('checked', true);
                } else
                    $('#offerAvailImmediateNewUser').attr('checked', false);

                if (promodata.referrerDiscount.offerAvailImmediate && promodata.referrerDiscount.offerAvailImmediate == true)
                    $('#offerAvailImmediateRefUser').attr('checked', true);
                else
                    $('#offerAvailImmediateRefUser').attr('checked', false);

                if (parseInt(promodata.tripCount) == 0) {
                    $('#offerAvailImmediateNewUser').attr('disabled', true);
                    $('#offerAvailImmediateRefUser').attr('disabled', true);
                }
                if (parseInt(promodata.rewardTriggerType) == 1) {
                    $('.requiredBillingAmount').addClass('hide');
                    $('.tripCountTrigger').removeClass('hide');
                    $('#newUserTripCountTrigger').attr('checked', true);
                    $('#tripCount').val(promodata.tripCount);
                } else {
                    $('.requiredBillingAmount').removeClass('hide');
                    $('.tripCountTrigger').addClass('hide');
                    $('#newUserBillingAmountTrigger').val(promodata.newUserBillingAmtTrigger);
                    $('#newUserTotalBusinessTrigger').attr('checked', true);
                }
                ...
                //new user disount reward type d
                console.log("prom", promodata);

                if (promodata["newUserDiscount"]["rewardType"] == 1) {

                    $("input[name=newUserRewardType][value='1']").prop("checked", true);
                } else if (promodata["newUserDiscount"]["rewardType"] == 2) {
                    $(".catData1").removeClass('hide');
                    $("input[name=newUserRewardType][value='2']").prop("checked", true);
                }
                ...
                //refer discount type
                if (promodata["referrerDiscount"]["discountType"] == 1) {
                    $("input[name=referralDiscountValue][value='1']").prop("checked", true);
                } else if (promodata["referrerDiscount"]["discountType"] == 2) {

                    $("input[name=referralDiscountValue][value='2']").prop("checked", true);
                    $('.referrerMaxDiscount').show();
                    $('#referrerMaxDiscount').val(promodata["referrerDiscount"]["maximumDiscountValue"]);
                }
...
//        $("#datepicker1").datepicker({ minDate: 0});
        ...
        $('input[name="referralDiscountValue"]').click(function () {
            $('.referrerMaxDiscount').hide();
        });
            ...
            if (checkAllFields() == true) {
                ...
                if ($("#firstForm").valid())
                {
                    ...
                    var dataToInsert = JSON.stringify({
                        ...
                        "perUserLimit": 0,
                        "rewardTriggerType": $('input[name=rewardTriggerType]:checked').val(),
...
//                return false;
                    $.ajax({
                        url: "<?php echo APILink ?>" + 'referralCampaign',
                        type: "PATCH",
                        dataType: "JSON",
                        contentType: "application/json; charset=utf-8",
                        data: dataToInsert,
...
<div class="page-content-wrapper">
    <form id="firstForm" class="form-horizontal" role="form"  method="post" enctype="multipart/form-data" novalidate="novalidate">
        <!-- START PAGE CONTENT -->
        <div class="content">
            <!-- START JUMBOTRON -->
                ...
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                    <div class="inner" style="">
                        ...
                        <ul class="breadcrumb" style="">
                            ...
                            <li class="breadClass"><a href="index.php?/referralController/index/1" class="active">REFERRAL CAMPAIGN</a>&nbsp>&nbsp<a href="#" style="color: #0090d9 !important; font-size: 11px !important">EDIT</a>
                            </li>
                                            ...
                                            <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                                <div class="col-sm-12 removePadding">
                                                    <div class="form-group  col-xs-12 ">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="addmemclass1 form-control autonumeric" id="referralAmount"  placeholder=""   required="" aria-required="true" >                                                                                            
                                            ...
                                            <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                                <div class="col-sm-12" style="padding-bottom: 15px">
                                                    <div class="form-group referrerMaxDiscount" style="display:none">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="addmemclass1 form-control autonumeric" id="referrerMaxDiscount" placeholder="Amount" value="0"   required="" aria-required="true" onkeypress="return isNumberKey(event, 'amountFirstBlock')" style="margin-left:-2%">                                                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                                <div class="col-sm-12 removePadding">
                                                    <div class="form-group  col-xs-12 ">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="addmemclass1 form-control autonumeric" id="newUserDiscountAmount"  placeholder=""   required="" aria-required="true" >                                                                                            
                                            ...
                                            <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                                <div class="col-sm-12" style="padding-bottom: 15px">
                                                    <div class="form-group newUserMaxDiscount" style="display:none">
                                                        <label for="fname" class="col-sm-3 control-label aligntext removePadding">MAX DISCOUNT<span class="mandatoryField"> &nbsp *</span></label>
                                                        <div class="col-sm-7">
                                                            <input type="text" class="addmemclass1 form-control autonumeric" id="newUserMaxDiscount" placeholder="Amount" value="0"   required="" aria-required="true" >                                                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3 error-box" id="maxDiscountError"></div>
