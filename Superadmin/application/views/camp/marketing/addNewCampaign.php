...
//        getAllZones(cityId);
        ...
        $("#citiesList2").change(function () {
            ...
            $(".percentageSpan").text($('#citiesList2 option:selected').attr('currencysymbol'));
             $(".catData").addClass('hide');
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                <div class="inner" style="">
                    ...
                    <ul class="breadcrumb" style="">
                        ...
                        <li class="breadClass"><a href="index.php?/campaigns/index/1" class="active">LOYALTY PROGRAM</a>&nbsp>&nbsp<a href="#" style="color: #0090d9 !important; font-size: 11px !important">ADD</a>
                        </li>
                                    ...
                                    <div class="col-sm-6 removePadding">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span class="percentageSpan" style="font-size: 15px; margin-left: 10px; "> % </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-xs-12 ">
                                            ...
                                            <div class="col-sm-6 removePadding">
                                                <div class="radio radio-success">
                                                    ...
                                                    <label for="newUserTripCountTrigger">BOOKING COUNT</label>
                                                    <input class= "marginLeft" type="radio"  value= 2 name="rewardTriggerType" id="newUserTotalBusinessTrigger">

                                                    <label for="newUserTotalBusinessTrigger">TOTAL BUSINESS</label>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <div class="radio usageType">
                                                                                    <input class = "marginLeft" type="radio"  value="1" name="usageType" id="cardselected">
                                                                                    <label>CART</label>
                                                                                    <input type="radio" class ="marginLeft"  value="2" name="usageType" id="cashselected">
                                                                                    <label>DELIVERY FEE</label>
                                                                                    <input type="radio" class ="marginLeft"  checked="checked" value="3" name="usageType" id="cashselected">
                                                                                    <label>BOTH</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
