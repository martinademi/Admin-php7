            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                <div class="inner" style="">
                    ...
                    <ul class="breadcrumb" style="">
                        ...
                        <li class="breadClass"><a href="<?php echo base_url() ?>index.php?/CouponCode/index/1" class="active">PROMO CODE</a>&nbsp>&nbsp<a href="<?php echo base_url() ?>index.php?/couponCode/addNewCode" style="color: #0090d9 !important; font-size: 11px !important">ADD</a>
                        </li>
                                    ...
                                    <div class="col-sm-6 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="storeList" name="company_select" class="form-control" style="width: 55% !important" multiple="multiple">
                                                         <option style="margin: 5px;margin-left: 39px;" > Please Select City</option>
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-12 b-b  b-l b-r b-grey p-b-10 p-t-10" style="padding-bottom: 15px">
                                    <div class="col-sm-6 removePadding">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id='minimumPurchaseValue' class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="0" style="width: 90%; float: left;" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 error-box" id="perUserLimitError"></div>
