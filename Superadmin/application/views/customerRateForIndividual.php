        ...
        $('#searchData').click(function () {
            if ($("#start").val() && $("#end").val())
            {
                ...
                var settings = {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": '<?php echo base_url() ?>index.php?/superadmin/datatable_customerRateForIndividual/' + ID + '/' + startDate + '/' + endDate,
                    "bJQueryUI": true,
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/superadmin/datatable_customerRateForIndividual/' + ID,
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content">
        ...
        <ul class="breadcrumb" style="margin-top: 5%;">
            <li>
                <a href="<?php echo base_url() ?>index.php?/superadmin/customers/3" class="active">CUSTOMER (<?php echo $customerData['name'].' '.$driverData['lastName'];?>)</a>
            </li>
            <li>
