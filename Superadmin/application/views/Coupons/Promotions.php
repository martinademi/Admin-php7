...
<script>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/coupons/datatable_Promotions/1',
            "bJQueryUI": true,
   ...
   $('.changeMode').click(function () {
        ...
        $('#view').click(function(){
             var val = $('.checkbox:checked').attr('data-id');
              if (val.length == 0) {
                ...
                window.location.href ='<?php echo base_url()?>index.php?/coupons/viewPromotion/1/'+val;
            }
         ...
         $('#Edit').click(function(){
             var val = $('.checkbox:checked').attr('data-id');
              if (val.length == 0) {
                ...
                window.location.href ='<?php echo base_url()?>index.php?/coupons/editrpromotion/1/'+val;
            }
        ...
        $('.deactivate').click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/coupons/inactivePromotion",
                type: "POST",
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/coupons/datatable_Promotions/2',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
...
//                      $( "#refid" ).load(window.location.href + " #refid" );
        ...
        $('.hitTosure').click(function () {
         var mongoid = $('#hittosure').attr('data-id');
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/coupons/activePromotion",
                type: "POST",
                data: {'mongoid': mongoid},
                dataType: "JSON",
                success: function (result) {
            ...
            <div class="panel panel-transparent">
                <ul class="nav nav-tabs nav-tabs-simple bg-white m-t-20" role="tablist" data-init-reponsive-tabs="collapse">
                    ...
                    <li id="1" class="tabs_active active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/coupons/datatable_Promotions/1" data-id="1"><span><?php echo LIST_ACCEPTED; ?> </span></a>
                    </li>
                    <li id="2" class="tabs_active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/coupons/datatable_Promotions/2" data-id="2"><span><?php echo LIST_REJECTED; ?></span></a>
                    </li>
                        ...
                        <div id="add" class="pull-right"><a href="<?php echo base_url() ?>index.php?/coupons/Createpromotion/1"><button id="show-modal" class="btn btn-primary" ><i class="fa fa-plus"></i> CREATE </button></a></div>
                </ul>
