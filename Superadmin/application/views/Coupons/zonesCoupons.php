...
//-----------------------View Zones----------------------  
    ...
    /*ajax request to get all the details of polygon*/
        ...
        if (navigator.geolocation) {
         ...
         $.ajax({
                    dataType: "json",
                    url: "<?= base_url() ?>index.php?/coupons/zonemapsapi",
                    async: false, 
...
////                                $('#zonesurge_price').val(),
//                                s,
//                               "<a href='<?php echo  base_url()."index.php?/coupons/zone_pricing/";?>"+data.city_ID+'/'+data.id.$id+"' class='btn btn-info btn-cons btn-animated from-top fa fa-dollar'  style='padding: 0px 10px;font-family: sans-serif;font-size: 10px;color: #fff;text-decoration: none;width: 108px;text-align:center;'><span>Set Zonal Price</span></a>",
                ...
                {    
                    ...
                    $('#editZoneModal1').trigger('click');
                                ...
                                $.ajax({
                                    dataType: "json",
                                    type:'POST',
                                    url: "<?= base_url() ?>index.php?/coupons/getCityZones",
        ...
        $("#chekdel").click(function () {
            ...
            if (val.length > 0) {
                ...
                $("#yesdelete").click(function () {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('index.php?/coupons') ?>/deleteCouponZone",
                        type: "POST",
                        data: {zone_id: val},
                        success: function (result) {
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-transparent ">
                    <!-- Nav tabs -->
                      ...
                      <div class="pull-right m-t-10"><button data-toggle="modal" class="btn btn-primary btn-cons" data-target="#addZoneModal" onclick="addNewZone(12.972442010578353, 77.5909423828125)"> 
                                Add</button></div>
                                     ...
                                     margin-bottom: 10px;margin-left: -0.7%" >
                                        <select class="form-control" id="city_select" style="background-color:gainsboro;height:30px;font-size:11px;display: none;" >
                                            ...
                                            foreach ($cities as $city) {
                                                ?>
                                            <option value="<?php echo $city['_id']['$oid'];?>" city="<?php echo $city['city']; ?>" data-id="" lat="" lng=""><?php echo $city['city']; ?></option>    
                                                <?php
                                            }
                                            ?>
                                        </select>
