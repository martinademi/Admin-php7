    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/coupons/datatable_Refferral/1',
                "bJQueryUI": true,
        ...
        $('#view').click(function () {
            ...
            if (val.length == 0) {
                ...
                window.location.href = '<?php echo base_url() ?>index.php?/coupons/viewrefferal/' + val;
            }
        ...
        $('.deactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/coupons/inactiveReferral",
                type: "POST",
...
//                      $( "#refid" ).load(window.location.href + " #refid" );
        ...
        $('.hitTosure').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/coupons/activeReferral",
                type: "POST",
                data: {'mongoid': mongoid},
                dataType: "JSON",
                success: function (result) {
                    if (result.msg == 0) {
                        ...
                        setTimeout(function () {
                            var settings = {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/coupons/datatable_Refferral/2',
                                "bJQueryUI": true,
                                "sPaginationType": "full_numbers",
                                "iDisplayStart ": 20,
                                "oLanguage": {
            ...
            <div class="panel panel-transparent">
                ...
                <ul class="nav nav-tabs nav-tabs-simple whenclicked bg-white new_button" style="" role="tablist" data-init-reponsive-tabs="collapse">
                    ...
                    <li id="1" class="tabs_active active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/coupons/datatable_Refferral/1" data-id="1"><span><?php echo LIST_ACCEPTED; ?> </span></a>
                    </li>
                    <li id="2" class="tabs_active" style="cursor:pointer;text-transform:uppercase;">
                        <a  class="changeMode"   data="<?php echo base_url(); ?>index.php/coupons/datatable_Refferral/2" data-id="2"><span><?php echo LIST_REJECTED; ?></span></a>
                    </li>

           <!--<div id="add" class="pull-right m-t-10"><a href="<?php echo base_url() ?>index.php?/coupons/createReferal"><button id="show-modal" class="btn btn-primary btn-cons m-t-10" ><i class="fa fa-plus"></i> VIEW </button></a></div>-->
                    <div class="pull-right m-t-10 cls100"> <button class="btn btn-primary  " id="view" >VIEW</button></div>
                    ...
                    <div id="add" class="pull-right m-t-10 cls110"><a href="<?php echo base_url() ?>index.php?/coupons/createReferal"><button id="show-modal" class="btn btn-info  btn-cons m-t-10" ><i class="fa fa-plus"></i> CREATE </button></a></div>
