        ...
        <script>
            $(document).ready(function () {
                ...
                langdata.push(engdata);
                    ...
                    $.ajax({
                        url: "<?php echo base_url('index.php?/PolicyController') ?>/website_update_terms",
                        type: "POST",
                        data: {terms: terms},
                        dataType: 'json',
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label col-md-4" style="color: #0090d9;"><?php echo $this->lang->line('heading_termPage'); ?>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a target="_new" href="<?php echo base_url(); ?>/appWebPages/website/website_Termsen.html">Preview</a> 
                                            </label>
                                    </div>
                                        ...
                                        if ($val['Active'] == 1) {
                                            ...
                                            <div class="form-group policy">
                                                <label for="" class="control-label col-md-4" style="color: #0090d9;"><?php echo $this->lang->line('heading_termPage'); ?> (<?php echo $val['lan_name']; ?>)
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <!-- <a target="_new" href="<?php echo base_url(); ?>/appWebPages/website/website_Terms<?php echo $val['lan_id']; ?>.html">Preview</a> -->
                                                     </label>
                                            </div>
