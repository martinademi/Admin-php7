        ...
        <script>
            $(document).ready(function () {
                ...
                langdata.push(engdata);
                    ...
                    $.ajax({
                        url: "<?php echo base_url('index.php?/PolicyController') ?>/store_update_terms",
                        type: "POST",
                        data: {terms: terms},
                        dataType: 'json',
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label col-md-4" style="color: #0090d9;"><?php echo $this->lang->line('heading_termPage'); ?>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a target="_new" href="<?php echo base_url(); ?>/appWebPages/Store/store_Termsen.html">Preview</a> 
                                            </label>
                                    </div>
