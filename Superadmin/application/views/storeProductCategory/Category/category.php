    ...
    $(document).ready(function () {
        ...
        $('#bdelete').click(function () {
            ...
            if (val.length < 0 || val.length == 0) {
                $('#displayData').modal('show');
                $("#display-data").text("<?php echo $this->lang->line('please_select_cateory'); ?>");
            } else if (val.length == 1 || val.length > 1)
            {
                $(".modalPopUpText").text("<?php echo $this->lang->line('Delete_cateory'); ?>");
                $("#display-data").text("");
                var BusinessId = val;
                var size = $('input[name=stickup_toggler]:checked').val()
                            ...
                            $.ajax({
                                ...
                                success: function (response)
                                {
                                    if (response.msg == 1) {
                                        ...
                                        {
                                            $('#addmodal').modal('show');
                                            $('.modalPopUpText').text('<?php echo $this->lang->line('Category_Added_successfully'); ?>');
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-left: 8px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 16px;"><?php echo $this->lang->line('Store_Product_Categories'); ?></strong>
        </div>

        <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">

            <li id= "0" class="tabs_active " style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/0"><span><?php echo $this->lang->line('Pending_Approval'); ?></span></a>
            </li>
            <li id= "1" class="active tabs_active" style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/1"><span><?php echo $this->lang->line('Approved'); ?></span></a>
            </li>
          
            <li id= "2" class="tabs_active" style="cursor:pointer">
                <a   class="changeMode" data="index.php?/ProductCategory/operationCategory/table/2"><span><?php echo $this->lang->line('Deleted'); ?></span></a>
            </li>

            <div class="pull-right m-t-10 cls111"> <button class="btn btn-info " id="approve"><?php echo $this->lang->line('Approve'); ?></button></div>
			
            <div class="pull-right m-t-10 cls111"> <button class="btn btn-danger" id="bdelete" ><span><?php echo $this->lang->line('Delete'); ?></button></a></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4" >
                        <button type="button" class="btn btn-success pull-right" id="btnApprove" data-dismiss="modal"><?php echo $this->lang->line('Yes'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4" >
                        <button type="button" class="btn btn-success pull-right" id="btnReject" data-dismiss="modal"><?php echo $this->lang->line('Yes'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4" >
                        <button type="button" class="btn btn-success pull-right" id="btnBan" data-dismiss="modal"><?php echo $this->lang->line('Yes'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="error-box modalPopUpText" id="errorboxdataErr" ><?php echo $this->lang->line('Invalid_Selection'); ?></div>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-sm-4" ></div>
                    <div class="col-sm-8" >
                        <div class="pull-right m-t-10"><button type="button" data-dismiss="modal" class="btn btn-default btn-cons" id="cancel"><?php echo $this->lang->line('OK'); ?></button></div>
