...
<script>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/OrderItemtypecontroller/data_details/1',
            "bJQueryUI": true,
        ...
        $("#yesAdd").click(function () {
            ...
            if (bname == '' || bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/addBrand",
                    type: "POST",
                    dataType: 'json',
                    data: {orderName: Name, brandDescription: Description, bannerImage: bimg,type:type},
                    success: function (result) {
                        console.log('--------',result)
                        if (result.flag == 1) {
                            $('#addModal').modal('hide');
                            ...
                            $('#errorModal').modal('show')
                            $(".modalPopUpText").text('Order Name already exist');
                            $('#yesAdd').prop('disabled', false);
                        }
                    }
                });
...
//        $('#edit').click(function () {
        $(document).on('click', '#btnEdit', function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/getBrand",
                type: "POST",
                dataType: 'json',
                data: {Id: editval},
                success: function (result) {
...
<?php } ?>
                    ...
                    //cool
                       $("input[name=edititemType][value="+ result.data.type+"]").prop("checked",true);
        ...
        $("#yesEdit").click(function () {
            ...
            var type = $("input:radio[name=edititemType]:checked").val();
            ...
            if (Bname == '' || Bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/editBrand",
                    type: "POST",
                    data: {Id: editval, orderName: Name, brandDescription: Desc,bannerImage: editbimg,logoImage: editlogoimg,type:type},
                    success: function (result) {
                        console.log(result);
                        if (result == "true") {
        ...
        $("#yesActivate").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/activateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    ...
                    if (res.flag == 0) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/OrderItemtypecontroller/data_details/0',
                            "bJQueryUI": true,
                            "sPaginationType": "full_numbers",
                            "iDisplayStart ": 20,
                            "oLanguage": {
        ...
        $('#yesdeactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/deactivateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
           ...
           $('#yesDelete').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/OrderItemtypecontroller') ?>/deleteSymtom",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    console.log(JSON.parse(result));
        ...
        <div class="panel panel-transparent ">
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                <li id= "my1" class="tabs_active active" style="cursor:pointer">
                    <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/OrderItemtypecontroller/data_details/1" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                </li>

                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/OrderItemtypecontroller/data_details/0" data-id="0"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>

                  <li id= "my3" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode deleted_" data="<?php echo base_url(); ?>index.php?/OrderItemtypecontroller/data_details/2" data-id="0"><span><?php echo $this->lang->line('heading_delete'); ?></span> <span class="badge bg-red"></span></a>
                </li>
                ...
                <div class="pull-right m-t-10 cls110"> <button style="margin-top:10px;" class="btn btn-success pull-right m-t-10" id="add"><?php echo $this->lang->line('button_add'); ?> </button></a></div>
            </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="fname" class="col-sm-5 control-label">Item Type</label>
                        <div class="col-sm-6">
                        <label class="radio-inline">
                                <input style="margin-left: -17px;margin-top:1px;" type="radio" name="itemType" value="1" checked>Grocery
                                </label>
                                <label class="radio-inline">
                                <input style="margin-left: -17px;margin-top:1px;" type="radio" name="itemType" value="2">Non-Grocery
                                </label>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                    	...
                    	<div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                            <label class="radio-inline">
                                    <input style="margin-left: -17px;margin-top:1px;" type="radio" name="edititemType" value="1" >Grocery
                                    </label>
                                    <label class="radio-inline">
                                    <input style="margin-left: -17px;margin-top:1px;" type="radio" name="edititemType" value="2">Non-Grocery
                                    </label>
                            </div>
...
<div class="modal fade stick-up" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="error-box" id="errorboxactivate" style="text-align:center;font-size: 14px;">Delete</div>
                </div>
            </div>
            <br>
            <div class="modal-footer">
