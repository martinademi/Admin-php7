...
//            return $this->_getStatusMessage(70, $deleteAllSessionsQry);
        ...
        $update = $location->update(array('user' => (int) $this->User['entityId']), array('$set' => array('status' => (int) $args['ent_status'], 'inBooking' => 1)));
    ...
    protected function getApptStatus($args) {
        ...
        if ($args['ent_appnt_dt'] != '') {
            ...
            if ($args['ent_user_type'] == '1') {
                ...
                $selectStatusQry = "select a.status,a.appointment_id,a.payment_status,a.user_device,(select status from master where mas_id = '" . $this->User['entityId'] . "') as master_status from appointment a where a.mas_id = '" . $this->User['entityId'] . "' and a.appointment_dt = '" . $args['ent_appnt_dt'] . "' and a.status != '10'";
            } else {
