                            ...
                            <div class="panel panel-transparent">
                                <div class="panel-heading">
                                    ...
                                    <div class="row clearfix">
                                        <div class="pull-left">
                                            <div class="col-md-6">
                                             <button id="collectAmount" style="background-color: rgb(129, 130, 181);border-color: rgb(129, 130, 181);" class="btn btn-warning btn-cons m-b-10 m-l-10 pull-left" type="button" > <span class="bold">Collect</span>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($payrolldata as $result) {
                                                        ...
                                                        <tr role="row"  class="gradeA odd">
                                                            <td class="v-align-middle "> <p><?php echo $slno; ?></p></td>
                                                            <td class="v-align-middle"> <p><?php echo $result->opening_balance; ?></p></td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header clearfix text-left">
                ...
                <h5><strong  style="color:#3a8fc8">COLLECT AMOUNT</strong></h5>
<!--                <p>We need payment information inorder to process your order</p>-->
            </div>
            <div class="modal-body">
                <form id="form-work" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate" action="<?php echo base_url() ?>index.php?/superadmin/collectedAmount/<?php echo $mas_id ?>" method="post">
                    <div class="form-group-attached">
             
                        <input type='hidden' name='ctime' id="hdate" value==''>
                        <input type='hidden' name='currunEarnigs' value='<?php echo $dueAmount; ?>'>
...
<?php echo $rupee ?> <span id="due_amt"><?php echo $dueAmount; ?></span>
                            </div>
                        </div>

                        <div class="form-group r_amount">
                            <label for="position" class="col-sm-3 control-label">Enter Amount To Be Collected </label>
                            <div class="col-sm-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8  p_amount">
                        ...
                        <button type="button" id="submit_form" style="background-color:rgb(129, 130, 181);border-color: rgb(129, 130, 181);" class="btn btn-warning">Collect</button>
