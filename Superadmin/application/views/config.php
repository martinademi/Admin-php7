...
define('AMAZON_AWS_ACCESS_KEY', 'AKIAIIOGFMWO5FEQLRBQ');
define('AMAZON_AWS_AUTH_SECRET', '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');
define('bucketName', 'dayrunner');
define('region', 'us-west-2');
define('AMAZON_URL', 'https://s3-us-west-2.amazonaws.com/');

define('ServiceLink', 'https://admin.uberfortruck.com/');

define('APILink', 'https://api.uberfortruck.com/');
define('GodsviewLink', 'https://birdsview.uberfortruck.com/#/login');

define('wallet_api_url', 'https://api.uberfortruck.com/wallet/');


define('channel', 'bookingChn');//used in all booking and on going page
define('Appname', 'TRUCKR');
...
define('STANDALON_OR_MANAGED', true);
define('APP_SERVER_HOST', 'https://admin.uberfortruck.com');
define('APP_PIC_HOST', 'https://admin.uberfortruck.com/pics/');
...
define('username','Dayrunner');
define('password','ShmdeUGtdbwg5esN');
define('database','Dayrunner');
...
$config['base_url'] = 'https://admin.uberfortruck.com/';
