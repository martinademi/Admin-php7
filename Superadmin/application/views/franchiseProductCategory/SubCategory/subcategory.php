    ...
    <div class="content">
        ...
        <ul class="whenclicked nav nav-tabs  bg-white">
            ...
            <li id= "0" class="tabs_active" style="cursor:pointer">
                <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/ProductSubCategory/datatable_subcategory/<?php echo $bid1; ?>/0" data-id="0"><span>In-active</span> <span class="badge bg-red"></span></a>
            </li>
