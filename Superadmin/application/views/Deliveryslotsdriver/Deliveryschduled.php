...
//            }
    ...
    function dateTimeReturn(month,stTime){
            ...
            d.setMonth(d.getMonth()+mon);
                    ...
                    console.log(dformat);
                        ...
                        function callDataTable(zoneId, status){
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliverydriverslots/datatable_getProviderDetails/'+zoneId+'/'+status+'/'+offset+'/<?php echo $zoneDeliveryId; ?>',
                                "bJQueryUI": true,
        ...
        //     // var valid = $(this).attr('data-id');
        //     // $.ajax({
        //     //         url: "<?php echo base_url() ?>index.php?/Deliverydriverslots/getSlotSchduled",
        //     //         type: "POST",
        //     //         data: {
        //     //             whId:valid
        //     //         },
        ...
        $('#yes').click(function(){
            ...
            if(val!=0 || val !='' || val!=null){
             ...
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliverydriverslots/deleteSchduled",
                    type: "POST",
                    data: {
                        whId:val
                    },
        ...
        $('#yesSlot').click(function(){
            ...
            if(val!=0 || val !='' || val!=null || date!="" || sTime!="" || eTime!=""){
             //  console.log("val",val);
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliverydriverslots/deleteParticularSlot",
                    type: "POST",
                    data: {
                        whId:val,
                        date: date,
        ...
        $('#addSlot').click(function(){
            ...
            if($("#pDate").val() == '' )
            {
                ...
                var zoneId = '<?php echo $zoneId; ?>'
            $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliverydriverslots/addSlotSchduled",
                    type: "POST",
                    data: {
                        objId:objId,
                        slotDate:slotDate,
        ...
        $("#insert_cat_group").click(function () {
           ...
           // console.log("offset",offset);
            ...
            //    return;
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliverydriverslots/addSchduled/<?php echo $zoneId;?>/<?php echo $cityId;?>",
                    type: "POST",
                    data: {
                        //BusinessId:fid,
                        stTime:stTime,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliverydriverslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/'+offset+'/<?php echo $zoneDeliveryId; ?>',
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
//                  $('#big_table_processing').hide();
        ...
        $('.changeMode').click(function () {
            ...
            {
               targetUrl = "<?php echo base_url(); ?>index.php?/Deliverydriverslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/"+offset ;
            } else if($(this).attr('data-id') == 2) {
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliverydriverslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/2/"+offset ;
            }
            else{
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliverydriverslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/3/"+offset ;
            }
...
//            e ndDate: date,
        ...
        // driver click
        $(document).on('click','.driverDeliverydriverslots',function () {
        
            var zoneId = $(this).attr('data-zoneid');
            var cityId = $(this).attr('data-id');
        
            window.location.href="<?php echo base_url();?>index.php?/Deliverydriverslots/slots/"+zoneId+"/"+cityId    ;
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            ...
            <strong style="font-size: 12px;margin-left: 15px;">DRIVER DETAILS</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="pull-left col-sm-6" >
                        ...
                        <div class="">
                            <ul class="breadcrumb" style="background:white;margin-top: 0%;">
                                ...
                                <li><a class="active" href="<?php echo base_url() ?>index.php?/Deliveryslots/slots/<?php echo $zoneId;?>/<?php echo $cityId;?>" class="">Delivery Slots</a> </li>
                                <li><a class="active" href="#" class="">Driver</a> </li>
                            </ul>
                        </div>
