...
<script>
    ...
    function moveUp(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>index.php?/CouponCode/getCalimsData",
            type: "POST",
...
$(document).on('click','.inputTripLogs',function ()
   {
    var userId = $(this).attr('userId');
        ...
        $.ajax({
                    ...
                    data: {                  
                        ...
                        if (json.data.length == 0) {
                            $("#modalData").append('<span style="font-size: 15px !important; text-align: center !important; color: coral !important;">Unable to get user details</span>');
                            $("#userDetails").modal();
                        }else{
                            var tableData = 
        ...
        var settings = {
            ...
            "iDisplayLength": 20,
            "bProcessing": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/CouponCode/getCalimsData',
            "bJQueryUI": true,
