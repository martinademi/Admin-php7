...
<script>
        ...
        var settings = {
         ...
         "bProcessing": true,
         "bServerSide": true,
         "sAjaxSource": '<?php echo base_url() ?>index.php?/Referral/datatable_refererHistory/<?= $refId?>',
         "bJQueryUI": true,
        ...
        <!--<div class="container-md-height m-b-20">-->
            <div class="panel panel-transparent">
                <ul class="breadcrumb" style="">
                    ...
                    <li>
                        <a href="<?php echo base_url() . 'index.php?/Referral/refferalHistory/' . $refData['campainId'];?>">Referral History</a>
                    </li>
