    ...
    $(document).ready(function () {
        ...
        $.each(lan, function (ind, val) {
            var html = '<div class="form-group form-group-default required cat_lan_' + val.code + '">\
                            ...
                            <input type="text" required name="cat_name[' + val.code + ']" id="cat_name_' + val.code + '" value="" class="form-control" >\
                        </div>';
        ...
        $.each(lan, function (ind, val) {
            ...
            var html = '<div class="form-group form-group-default required cat_lan_' + val.code + '">\
                            <label>Description (' + val.name + ')</label>\
                                                <textarea required name="desc[' + val.code +']" id="desc_name' + val.code +'" class="desc_name1"></textarea></div>';
...
<div class="content">
    <div class="" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner" style="transform: translateY(0px); opacity: 1;">
                <h5 class="" style="color:#2a3f54;font-weight:900"><?= strtoupper($this->lang->line('heading_customersHelpText'));?></h5>
            </div>
        </div>
    </div>
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            ...
            <li>
                <a href="#" class="active">
                   <?= $ttl_cat ?><?= ucwords($this->lang->line('category'));?>
                </a>
            </li>
        </ul>
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form name="supportext" action="<?= base_url() ?>index.php?/helpText/operations/insert" method='post'novalidate>
                            ...
                            <div class="form-group-attached">
                                <div class='col-sm-12'>
                                    ...
                                    <div class='col-sm-3'>
                                        ...
                                        <div class="checkbox check-success disabled">
                                            ...
                                            <label for="checkbox0"><?= $ttl_cat ?><?= ucwords($this->lang->line('english'));?></label>
                                        </div>
                                    </div>
                                    <?php
                                    foreach ($language as $val) {
                                        ...
                                        <div class='col-sm-3'>
                                            <div class="checkbox check-success <?= $landis ?>">
                                                <input type="checkbox" class='lan_check' value="<?= $val['code'] ?>" id="checkbox<?= $val['code'] ?>" data-id='<?= $val['name'] ?>' <?= $landis ?> <?= $s ?>>
                                ...
                                <div class='col-sm-6'>
                                    <div class="form-group form-group-default required maincat">
                                        <label><?= $ttl_cat ?><?= $ttl_cat ?><?= ucwords($this->lang->line('label_category'));?> (<?= $ttl_cat ?><?= ucwords($this->lang->line('english'));?>)</label>
                                        <input type="text" required name='cat_name[en]' id="cat_name" class="form-control">
                                    ...
                                    <?php if ($cat_id == '') { ?>
                                        <div class="form-group form-group-default input-group">
                                            <label>
                                                <?= ucwords($this->lang->line('label_has_sub_category'));?>
                                            </label>
                                    ...
                                    <div class='has_scat'>
                                        ...
                                        <div class="form-group form-group-default required maindesc">
                                            <label><?= ucwords($this->lang->line('label_description'));?> (<?= ucwords($this->lang->line('english'));?>)<a target="_new" href="">Preview</a></label>
                                            
                                            <textarea name="desc[en]" id="Terms"><?PHP echo $allData['Terms']; ?></textarea>
                                                <script>
