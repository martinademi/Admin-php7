...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.driverSupport', function ()
        {
            ...
            success: function (result) {
                ...
                $.each(result.sub_cat, function (ind, val) {
                    ...
                    scat_tbl.row.add([
                        ...
                        "<a class='btn btn-default' href='<?= base_url()?>index.php?/helpText/getsubDescription/"+result.cat_id+"/"+val.id.$oid+"' style='background: #0090d9;border-color: #0090d9;color: white;font-size: 10px;'><i class='fa fa-eye'></i>View</a>\
                            <a style='background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;' class='btn btn-default cls111' href='<?= base_url()?>index.php?/helpText/Subcat_editDriver/"+result._id.$oid+"/"+val.id.$oid+"'  data-id=''><i class='fa fa-edit '></i> Edit</a>\
...
//       window.location.href="<?php echo base_url() ?>index.php?/utilities/getDescription/"+cat_id;
    ...
    function delcat(rowid){
        ...
        $('#yesConfirmDelete').click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/helpText/support_actionDriver/del",
                type: "POST",
    ...
    function delscat(rowid){
        if (confirm("Are you sure you want to Delete?")) {
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/helpText/support_actionDriver/subdel",
                type: "POST",
...
<div class="content">
    <div class="" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="brand inline" style="transform: translateY(0px); opacity: 1;">
                <strong class="" style="color: #0090d9;">DRIVER HELP TEXT</strong>
            </div>
        </div>
    </div>
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <!-- <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/utilities/support_catDriver'>
                                        <button class='btn btn-primary cls110' id='add_new_cat' style="margin: 10px 0px;">
                                             <?= ucwords($this->lang->line('add'));?>
                                        </button>
                                    </a>
                                </div> -->
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/helpText/support_catDriver'>
                                        <button class='btn btn-primary cls110' id='add_new_cat' style="margin: 10px 0px;">
                                             <?= ucwords('add');?>
                                        </button>
                                    </a>
                                            ...
                                            foreach ($suppText as $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        <a class="driverSupport"  style="cursor: pointer" data-id="<?php echo $val['_id']['$oid'];?>"> <?php echo implode($val['name'],','); ?> </a>
                                                        <?php
//                                                            $elan = array();
//                                                            $elang = array($val['name']['en']);
//                                                            foreach($val['name'] as $ind => $val1)
//                                                                array_push($elan, $ind);
//                                                            foreach ($language as $val2) 
//                                                                if(array_search($val2['code'], $elan) != false)
//                                                                    array_push($elang,$val['name'][$val2['code']]);
//                                                            echo implode(", ", $elang);
                                                        ?>
                                                    ...
                                                    <td style="text-align:left">
                                                         ...
                                                         if($val['has_scat'])
                                                        {
                                                            ...
                                                            if ($count!=0)
                                                            {
                                                                echo "<a href='" . base_url() . "index.php?/helpText/supportTextDriverSubCategory/" . $val['cat_id'] . "'>
...
//                                                        } 
                                                        ...
                                                        <?php
//                                                        if ($val['has_scat'])
//                                                            echo "<a href='" . base_url() . "index.php?/utilities/support_catDriver/0/" . $val['cat_id'] . "'>
//                                                                        <button class='btn btn-default cls110' id='add_new_cat' style='background: #2196f3;border-color: #2196f3;color: white;font-size: 10px;'>
//                                                                             Add Subcat 
//                                                                        </button>
//                                                                    </a><br/>";
                                                        ?>
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/helpText/support_editDriver/<?= (String)$val['_id']['$oid']?>' data-id='<?= $val['cat_id'] ?>'>
            ...
            <form id='grp_form' action=''>
                ...
                <div class="modal-body m-t-50">
                    <div class="form-group-attached">
                        <div class="row">
                            <table class="table table-striped table-bordered table-hover" id="subcat_table" style="margin-bottom: 20px;">
                                <thead>
                                    <tr>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="width:10%;text-align: center;">DRIVER SUPPORT TEXT</th>
                        </tr>
                    </thead>
