...
<!--            <div class="brand inline" style="transform: translateY(0px); opacity: 1;">
                <strong class="" style="color: #0090d9;"><?= strtoupper($this->lang->line('driversupporttext'));?></strong>
            </div>-->
            <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
                <li>
                    <a class="active" href="<?= base_url() ?>index.php?/helpText/helpTextDriver">DRIVER <?= strtoupper($this->lang->line('supporttext'));?></a>
                </li>
                <li>
                    <a href="#" class="active">
                         SUB CATEGORY
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/helpText/support_catSubDriver/0/<?php echo $catId ?>'>
                                            ...
                                            foreach ($suppTextCustomer['sub_cat'] as $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        ...
                                                        <a class="driverSupport"  style="cursor: pointer" data-id="<?php echo $val['id']['$oid'];?>"> <?php echo implode($val['name'],','); ?> </a>
                                                    </td>
                                                     <td class="" style="text-align:left;">
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/helpText/Subcat_editDriver/<?=$suppTextCustomer['_id']['$oid']?>/<?= (String)$val['id']['$oid']?>/<?=$suppTextCustomer['cat_id']?>' data-id='<?= $val['cat_id'] ?>'>
