...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.helpSupport', function ()
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('index.php?/helpText') ?>/getSubHelpSupportLanguage",
                data: {helpId: subcatId},
                dataType: "JSON",
    ...
    <div class="" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            ...
            <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
                <li>
                    <a class="active" href="<?= base_url() ?>index.php?/helpText"><?= strtoupper($this->lang->line('heading_customersHelpText'));?></a>
                </li>
                <li>
                    <a href="#" class="active">
                         SUB CATEGORY
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/helpText/support_helpText/0/<?php echo $catId ?>'>
                                ...
                                <div class="panel-body no-padding">
                                    <table class="table table-striped table-bordered table-hover demo-table-search" id="help_table">
                                        ...
                                        <tbody>
                                            <?php
                                            $l = 1;
                                            foreach ($helpTextCustomer['sub_cat'] as $val) {
                                                ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        <a class="helpSupport"  style="cursor: pointer" data-id="<?php echo $val['id']['$oid'];?>"> <?php echo $val['name']['en']; ?> </a>
                                                    </td>
...
//                                                        }
                                                        ?>
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url() ?>index.php?/helpText/Subcat_editCustomer/<?= (String) $helpTextCustomer['_id']['$oid'] ?>/<?= (String) $val['id']['$oid'] ?>/<?= (String) $helpTextCustomer['cat_id'] ?>' data-id='<?= $val['cat_id'] ?>'>
