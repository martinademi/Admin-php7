    ...
    <div class="" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner" style="transform: translateY(0px); opacity: 1;">
                <strong class="" style="color: #0090d9;">STORE HELP TEXT</strong>
            </div>
        </div>
    </div>
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/helpText/support_catStore'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        ...
                                                        if($val['has_scat'])
                                                        {
                                                            ...
                                                            if ($count!=0)
                                                            {
                                                                echo "<a href='" . base_url() . "index.php?/helpText/supportTextStoreSubCategory/" . $val['cat_id'] . "'>
...
//                                                                    </a><br/>";
                                                        ?>
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/helpText/support_editStore/<?= (String)$val['_id']['$oid']?>' data-id='<?= $val['cat_id'] ?>'>
