...
//                </div>');
    ...
    $(document).ready(function () {
        ...
        $.each(lan, function (ind, val) {
            var html = '<div class="form-group form-group-default required cat_lan_' + val.languageId + '">\
...
<div class="content">
    ...
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            ...
            <li>
                <a href="#" class="active">
                    <?= $ttl_cat ?><?= ucwords($this->lang->line('heading_edit')); ?> 
                </a>
            </li>
        </ul>
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form action="<?= base_url() ?>index.php?/helpText/operations/update" method='post' novalidate>
