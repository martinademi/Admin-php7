...
<div class="content">
    ...
    <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/helpText/helpTextDriver/<?php echo $catid; ?>">Driver Help</a>
            </li>
            <li>
                <a href="#" class="active">
                    Edit 
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form action="<?= base_url() ?>index.php?/helpText/support_actionDriver" method='post' novalidate>
