    ...
    <div class="container-fluid container-fixed-lg">
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form name="supportext" action="<?= base_url() ?>index.php?/utilities/support_actionCustomer" method='post' novalidate>
                    <div class="panel-heading">
                            ...
                            <div class="form-group-attached">
                                ...
                                <div class='col-sm-6'>
                                    <div class="form-group form-group-default required maincat">
                                        ...
                                        <input type="text" required name='cat_name[en]' id="cat_name" class="form-control" required>
                        ...
                        <div class="panel-footer bg-white">
                            <div class='row'>
                                <button class='btn btn-primary pull-right' type='submit' name='add_new_cat' onclick="this.style.display = none" id="enableBtn">
                                    Save
                                </button>
                            </div>
                        </div>
