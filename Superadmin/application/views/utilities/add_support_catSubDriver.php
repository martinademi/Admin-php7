    ...
    $(document).ready(function () {
        ...
        $.each(lan, function (ind, val) {
            var html = '<div class="form-group form-group-default required cat_lan_' + val.langCode + '">\
                            ...
                            <input type="text" required name="cat_name[' + val.langCode + ']" id="cat_name_' + val.langCode + '" value="" class="form-control" >\
                        </div>';
        ...
        $.each(lan, function (ind, val) {
            ...
            var html = '<div class="form-group form-group-default required cat_lan_' + val.langCode + '">\
                            <label>Description (' + val.lan_name + ')</label>\
                                                <textarea required name="desc[' + val.langCode +']" id="desc_name' + val.langCode +'" class="desc_name1"></textarea></div>';
...
<div class="content">
    ...
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/utilities/supportTextDriver">Driver Support</a>
            </li>
            <li>
                <a href="#" class="active">
                     <?= $ttl_cat ?>Sub-Category
                </a>
            </li>
        </ul>
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form name="supportext" action="<?= base_url() ?>index.php?/utilities/support_actionDriver/0/<?php echo $cat_id; ?>" method='post'novalidate>
                    <div class="panel-heading">
                                    ...
                                    foreach ($language as $val) {
                                        ...
                                        <div class='col-sm-3'>
                                            <div class="checkbox check-success <?= $landis ?>">
                                                <input type="checkbox" class='lan_check' value="<?= $val['langCode'] ?>" id="checkbox<?= $val['langCode'] ?>" data-id='<?= $val['lan_name'] ?>' <?= $landis ?> <?= $s ?>>
                        ...
                        <div class="panel-footer bg-white">
                            <div class='row'>
                                <button class='btn btn-primary pull-right' type='submit' name='add_new_cat' onclick="this.style.visibility= 'hidden';" >
                                    Save
                                </button>
                            </div>
                        </div>
