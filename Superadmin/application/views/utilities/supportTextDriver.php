...
//       window.location.href="<?php echo base_url() ?>index.php?/utilities/getDescription/"+cat_id;
    ...
    function delcat(rowid){
         ...
         $('#yesConfirmDelete').click(function(){ 
             ...
             $.ajax({
                url: "<?php echo base_url() ?>index.php?/utilities/support_actionDriver/del",
                type: "POST",
    ...
    <div class="" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="brand inline" style="transform: translateY(0px); opacity: 1;">
                <strong class="" style="color: #0090d9;">DRIVER SUPPORT TEXT</strong>
            </div>
        </div>
    </div>
...
//                                                            echo implode(", ", $elang);
                                                    ...
                                                    <td style="text-align:left">
                                                         ...
                                                         if($val['has_scat'])
                                                        {
                                                            ...
                                                            if ($count!=0)
                                                            {
                                                                echo "<a href='" . base_url() . "index.php?/utilities/supportTextDriverSubCategory/" . $val['cat_id'] . "'>
...
//                                                                    </a><br/>";
                                                        ?>
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/utilities/support_editDriver/<?= (String)$val['_id']['$oid']?>' data-id='<?= $val['cat_id'] ?>'>
