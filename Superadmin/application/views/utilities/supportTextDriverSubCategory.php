...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.driverSupport', function ()
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('index.php?/utilities') ?>/getSubCustomerSupportLanguage",
                ...
                $.each(result.sub_cat, function (ind, val) {
                    ...
                    scat_tbl.row.add([
                        ...
                        "<a class='btn btn-default' href='<?= base_url()?>index.php?/utilities/getsubDescription/"+result.cat_id+"/"+val.id.$oid+"' style='background: #0090d9;border-color: #0090d9;color: white;font-size: 10px;'><i class='fa fa-eye'></i>View</a>\
                            <a style='background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;' class='btn btn-default cls111' href='<?= base_url()?>index.php?/utilities/Subcat_editDriver/"+result._id.$oid+"/"+val.id.$oid+"'  data-id=''><i class='fa fa-edit '></i> Edit</a>\
...
$('#yesConfirmDelete').click(function(){
    $.ajax({
                url: "<?php echo base_url() ?>index.php?/utilities/support_actionDriver/subdel",
                type: "POST",
...
<!--            <div class="brand inline" style="transform: translateY(0px); opacity: 1;">
            ...
            <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
                <li>
                    <a class="active" href="<?= base_url() ?>index.php?/utilities/supportTextDriver">DRIVER <?= strtoupper($this->lang->line('supporttext'));?></a>
                </li>
                <li>
                    <a href="#" class="active">
                         SUB CATEGORY
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/utilities/support_catSubDriver/0/<?php echo $catId ?>'>
                                            ...
                                            foreach ($suppTextCustomer['sub_cat'] as $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        <!-- <a class="driverSupport"  style="cursor: pointer" data-id="<?php echo $val['id']['$oid'];?>"> <?php echo $val['name']['en']; ?> </a> -->
                                                        <a class="driverSupport"  style="cursor: pointer" data-id="<?php echo $val['id']['$oid'];?>"> <?php echo implode($val['name'],','); ?> </a>
                                                    </td>
                                                     <td class="" style="text-align:left;">
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/utilities/Subcat_editDriver/<?=$suppTextCustomer['_id']['$oid']?>/<?= (String)$val['id']['$oid']?>/<?=$suppTextCustomer['cat_id']?>' data-id='<?= $val['cat_id'] ?>'>
