...
<!--            <div class="inner" style="transform: translateY(0px); opacity: 1;">
            ...
            <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
                <li>
                    <a class="active" href="<?= base_url() ?>index.php?/utilities/supportTextCustomer">Customer Support Sub Category</a>
                </li>
                <li>
                    <a href="#" class="active">
                         Edit
                        ...
                        <div class="row panel panel-default" style="border: 0;">
                            <div class="panel-heading" style="background:white;">
                                ...
                                <div class='pull-right'>
                                    <a href='<?= base_url() ?>index.php?/utilities/support_catSubCustomer/0/<?php echo $catId ?>'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                     ...
                                                     <td class="" style="text-align:left;">
                                                        <a class='btn btn-default cls111' style="background: #5bc0de;border-color: #5bc0de;color: white;font-size: 10px;" href='<?= base_url()?>index.php?/utilities/Subcat_editCustomer/<?=$suppTextCustomer['_id']['$oid']?>/<?= (String)$val['id']['$oid']?>/<?=$suppTextCustomer['cat_id']?>' data-id='<?= $val['cat_id'] ?>'>
