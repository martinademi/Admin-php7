...
<div class="content">
    ...
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/utilities/supportTextCustomer">Support Text</a>
            </li>
            <li>
                <a href="#" class="active">
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form action="<?= base_url() ?>index.php?/utilities/support_actionCustomer" method='post'>
...
<?php } ?>
                                    <div class='has_scat'>
                                        <div class="form-group form-group-default required maindesc">
                                            ...
                                            <textarea  name="desc[0]" id="editor1hoik" class="form-control nhas_scat" rows="5" ><?php echo $data['desc'][0]?></textarea>
