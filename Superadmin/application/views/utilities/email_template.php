...
<!--    <div class="jumbotron  no-margin" data-pages="parallax">
 ...
 <div class="container-fluid container-fixed-lg"></div>
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb">
            <li>
                <a href="#" class="brand inline active"><strong style="width: auto; font-size: 12px;">EMAIL TEMPLATES</strong></a>
            </li>
        </ul>
                            ...
                            <form role="form" id="template_form" class="form-horizontal" method="post" action="<?php echo base_url() ?>index.php?/utilities/email_template_action">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-success" type="submit" id="btn_save">Save</button>
                                    </div>
                                </div>
                            </form>
                        </section>
