        ...
        $("#yesAdd").click(function () {
            ...
            else if (accepts == "" || accepts == null)
            {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: 'json',
                    data: {name: name, profilePic: $('#ImageUpload').val(), storeId: storeId, email: email, mobile: mobile, password: $('#password').val(), accepts: accepts, countryCode: countryCode, storeName: storeName, cityId: cityId, cityName: cityName},
                    success: function (result) {
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_CityList" style="color:red"></div>
                    </div>
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_StoresList" style="color:red"></div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_name" style="color:red"></div>
                    </div>
                    <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_mobile" style="color:red"></div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="radio" class= " col-sm-2 accepts error-box-class" name="accepts"  id="accepts1"  value="1"> 


                            <label class="col-sm-2 control-label">Delivery</label>
                            <input type="radio" class=" col-sm-2 accepts error-box-class" name="accepts"  id="accepts2"  value="2"> 

                            <label class="col-sm-2 control-label">Both</label>
                            <input type="radio" class=" col-sm-2 accepts error-box-class" name="accepts"  id="accepts3"  value="3"> 


                        </div>
                        <div class="col-sm-3" id="text_accepts" style="color:red"></div>
                    </div>
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_ImageErr" style="color:red"></div>
                    </div>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_FranchiseList" style="color:red"></div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3" id="text_edit_StoresList" style="color:red"></div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label">Name<span class="MandatoryMarker">*</span></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control error-box-class" id="editname" minlength="3" value="" placeholder="Enter your name" required="">  
                            <div class="col-sm-3" id="text_edit_name" style="color:red"></div>
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label">Email<span class="MandatoryMarker">*</span></label>
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-3" id="text_edit_email" style="color:red"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-3" id="text_edit_mobile" style="color:red"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label class=" col-sm-2 control-label">Pickup</label>
                            <input type="radio" class= "col-sm-2 editaccepts error-box-class" name="editaccepts"  id="editaccepts1"  value="1"> 


                            <label class="col-sm-2 control-label">Delivery</label>
                            <input type="radio" class=" col-sm-2 editaccepts error-box-class" name="editaccepts"  id="editaccepts2"  value="2"> 

                            <label class="col-sm-2 control-label">Both</label>
                            <input type="radio" class=" col-sm-2 editaccepts error-box-class" name="editaccepts"  id="editaccepts3"  value="3"> 

                            <div class="col-sm-3" id="text_edit_accepts" style="color:red"></div>
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="col-sm-3 control-label">Profile Image<span class="MandatoryMarker">*</span></label>
                        ...
                        <div class="col-sm-3" id="text_editImageErr" style="color:red"></div>
                    </div>
