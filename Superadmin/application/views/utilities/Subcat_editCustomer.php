...
//                </div>');
    ...
    $(document).ready(function () {
        // console.log('id------->',<?php echo $edit_id; ?>);
        // console.log('id------->',<?php echo $scat_id; ?>);
        // console.log('catid------->',<?php echo $catid; ?>);
...
<div class="content">
    ...
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/Utilities/supportTextCustomerSubCategory/<?php echo $catid; ?>">Customer Support Sub Category</a>
            </li>
            <li>
                <a href="#" class="active">
                    Edit 
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form action="<?= base_url() ?>index.php?/utilities/support_actionCustomer/0/<?php echo $cat_id; ?>" method='post' novalidate>
