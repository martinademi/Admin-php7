    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/utilities/datatable_canreasonDispatcher',
                "bJQueryUI": true,
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto;">
            <strong>CANCELLATION REASONS FOR DISPATCHER</strong>
    ...
    <div class="modal-dialog">
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div id="addReasonsError" class="modalPopUpText" style="text-align: center;color: red;"></div>
                <div class="modal-footer">
