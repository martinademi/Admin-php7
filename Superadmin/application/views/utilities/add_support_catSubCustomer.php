...
<div class="content">
    ...
    <div class="container-fluid container-fixed-lg">
        <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/utilities/supportTextCustomer">Customer Support Text</a>
            </li>
            <li>
                <a href="#" class="active">
                     Sub Category
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form name="supportext" action="<?= base_url() ?>index.php?/utilities/support_actionCustomer/0/<?php echo $cat_id; ?>" method='post'novalidate>
