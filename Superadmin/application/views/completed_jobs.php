...
//            console.log(topic);
        ...
        setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/superadmin/datatable_completed_jobs',
                "bJQueryUI": true,
        ...
        $('#searchData').click(function () {
            if ($("#start").val() && $("#end").val())
            {
                ...
                var settings = {
                    ...
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": '<?php echo base_url(); ?>index.php?/superadmin/datatable_completed_jobs/' + startDate + '/' + endDate,
                    "bJQueryUI": true,
                    "sPaginationType": "full_numbers",
                    "iDisplayStart ": 20,
                    "oLanguage": {
...
<div class="page-content-wrapper" style="padding-top: 20px">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto;
            ...
            <strong style="color:#0090d9;">COMPLETED ORDERS</strong>
        </div>
