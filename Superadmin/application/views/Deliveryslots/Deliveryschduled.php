...
//            }
    ...
    function dateTimeReturn(month,stTime){
            ...
            d.setMonth(d.getMonth()+mon);
                    ...
                    console.log(dformat);
                        ...
                        function callDataTable(zoneId, status){
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryslots/datatable_getProviderDetails/'+zoneId+'/'+status+'/'+offset,
                                "bJQueryUI": true,
        ...
        //     // var valid = $(this).attr('data-id');
        //     // $.ajax({
        //     //         url: "<?php echo base_url() ?>index.php?/Deliveryslots/getSlotSchduled",
        //     //         type: "POST",
        //     //         data: {
        //     //             whId:valid
        //     //         },
        ...
        $('#yes').click(function(){
            ...
            if(val!=0 || val !='' || val!=null){
             ...
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryslots/deleteSchduled",
                    type: "POST",
                    data: {
                        whId:val
                    },
        ...
        $('#yesSlot').click(function(){
            ...
            if(val!=0 || val !='' || val!=null || date!="" || sTime!="" || eTime!=""){
             //  console.log("val",val);
             $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryslots/deleteParticularSlot",
                    type: "POST",
                    data: {
                        whId:val,
                        date: date,
        ...
        $('#addSlot').click(function(){
            ...
            if($("#pDate").val() == '' )
            {
                ...
                var zoneId = '<?php echo $zoneId; ?>'
            $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryslots/addSlotSchduled",
                    type: "POST",
                    data: {
                        objId:objId,
                        slotDate:slotDate,
        ...
        $("#insert_cat_group").click(function () {
           ...
           // console.log("offset",offset);
            ...
            if(noofdelivery =='' || parseInt(noofdelivery) == 0){
                catStatus = false;
                $("#noofdeliveryErr").text("Please Enter no of delivery");
            }
            ...
            //    return;
                $.ajax({
                    url: "<?php echo base_url() ?>index.php?/Deliveryslots/addSchduled/<?php echo $zoneId;?>/<?php echo $cityId;?>",
                    type: "POST",
                    data: {
                        //BusinessId:fid,
                        stTime:stTime,
        ...
        // setTimeout(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/'+offset,
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                // "aoColumns": [
...
//                  $('#big_table_processing').hide();
        ...
        $('.changeMode').click(function () {
            ...
            {
               targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1/"+offset ;
            } else if($(this).attr('data-id') == 2) {
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/2/"+offset ;
            }
            else{
                targetUrl = "<?php echo base_url(); ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/3/"+offset ;
            }
...
//            e ndDate: date,
        ...
        // driver click 
        $(document).on('click','.driverdeliverySlots',function () {
        
            var zoneId = $(this).attr('data-zoneid');
            //var zoneDeliveryId = $(this).val();
            var zoneDeliveryId = $(this).attr('data-id');                      
            var slotId='<?php echo $cityId;?>';  
           
             window.location.href="<?php echo base_url();?>index.php?/Deliverydriverslots/slots/"+zoneId+"/"+slotId+"/"+zoneDeliveryId;
           
        });

        // driver click
        $(document).on('click','.orderCapacity',function () {
        
            var zoneId = $(this).attr('data-zoneid');
            var zoneDeliveryId = $(this).val();
            var slotId='<?php echo $cityId;?>';  
            window.location.href="<?php echo base_url();?>index.php?/Ordercapacityslots/slots/"+zoneId+"/"+slotId;
           
        });

         // driver assign modal
         $(document).on('click','.driverAssignSlot',function () {
         
         var zoneId = $(this).attr('data-zoneid');
         var zoneDeliveryId = $(this).val();
         var slotId='<?php echo $cityId;?>';
        
         window.location.href="<?php echo base_url();?>index.php?/DeliveryAssignDriver/slots/"+zoneId+"/"+zoneDeliveryId+"/"+slotId;
...
<div class="page-content-wrapper">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            ...
            <strong style="font-size: 12px;margin-left: 15px;">DELIVERY SLOTSS</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="form-group">
                       <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                            <li id= "1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?>" style="cursor:pointer">
                                <a class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/1" data-id="1"><span>ACTIVE</span><span class="badge createdSchedule" style="background-color: #5bc0de;"></span></a>
                            </li>
                            <li id= "2" class="tabs_active <?php echo ($status == 2 ? "active" : ""); ?>" style="cursor:pointer">
                                <a  class="changeMode" data="<?php echo base_url(); ?>index.php?/Deliveryslots/datatable_getProviderDetails/<?php echo $zoneId; ?>/2" data-id="2"><span>EXPIRED</span><span class="badge NotcreatedSchedule" style="background-color: indianred;"></span></a>
                            </li>                     
                       </ul>
                ...
                <div class="pull-left col-sm-6" >
                        ...
                        <div class="">
                            <ul class="breadcrumb" style="background:white;margin-top: 0%;">
                                ...
                                <li><a class="active" href="#" class="">Delivery Slots</a> </li>
                            </ul>
                        </div>
