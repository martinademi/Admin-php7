...
<!--                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text"  id="color" name="color" required="required" class="form-control error-box-class">
                                        </div>
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <input type="file" accept="image/*" class="form-control error-box-class" style="height: 37px;" name="certificate" id="regcertificate">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="file" accept="image/*" class="form-control error-box-class" style="height: 37px;" name="insurcertificate" id="motorcertificate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="file" accept="image/*" class="form-control error-box-class" name="carriagecertificate" id="contractpermit">
                            ...
                            <div class="padding-20 bg-white col-sm-9">
                                <ul class="pager wizard ">
                                    <li class="next" id="nextbutton">
                                        <button class="btn btn-primary pull-right" type="button" onclick="movetonext()">
                                            <span>Next</span>
                                        </button>
                                    </li>
                                    <li class="hidden" id="finishbutton">
                                        <button class="btn btn-primary pull-right" type="button" onclick="submitform()" >
                                            <span>Finish</span>
                                        </button>
                                    </li>
