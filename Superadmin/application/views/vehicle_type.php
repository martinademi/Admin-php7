...
//                                alert("changed");
        ...
        $(document).on('click', '.pricing', function ()
        {
            ...
            var m = '<?php echo unserialize(DistanceMetric)[$appConfigData['mileage_metric']]; ?>';
//            var m = 'Miles';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup bg-white" style="padding: 0.5%;">
                        ...
                        <div class="pull-right m-t-10 cls111" style="margin-right: 1%;"> <button class="btn btn-danger btn-cons " id="delete_vehicletype"><?php echo BUTTON_DELETE; ?></button></a></div>
                        <div class="pull-right m-t-10 cls111"> <button class="btn btn-info btn-cons" id="edit_vehicletype"><?php echo BUTTON_EDIT; ?></button></a></div>
                        <div class="pull-right m-t-10 cls110"><a href="<?php echo base_url() ?>index.php?/superadmin/vehicletype_addedit/add"> <button class="btn btn-primary btn-cons" ><?php echo BUTTON_ADD; ?></button></a></div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row" style="  margin-left: 7%;">
                    <label class="control-label col-md-5 col-sm-5 col-xs-5" for="first-name">Load Bearing Capacity (<?php echo unserialize(WeightMetric)[$appConfigData['weight_metric']]; ?>)</label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
...
<form id="form_uploadImage"  enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php?/superadmin/uploadVehicleTypeImage">
