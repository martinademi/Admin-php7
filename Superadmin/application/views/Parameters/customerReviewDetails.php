...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php?/parametersController/datatable_customerreviewdetails/<?php echo $driverId; ?>',
            "bJQueryUI": true,
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content">
        ...
        <!-- <div class="brand inline" style="  width: auto;color:#0090d9;margin-left: 30px;padding-top: 20px;">
            <strong><a href="<?php echo base_url(); ?>index.php?/parametersController/driver_review/1">CUSTOMER REVIEW & RATING</a> => </strong>
            <strong><a href="#">CUSTOMER REVIEW DETAILS</a>=> </strong>
            <strong><a href="#"><?php echo $customerName;?></a> </strong>
        </div> -->

        <div class="brand inline" style="  width: auto; margin-top: 60px;">
            <strong style="font-size: 12px;margin-left: 15px;">CUSTOMER REVIEW & RATING</strong>
        </div>
                            ...
                            <div class="pull-left col-sm-6" >
                                ...
                                <div class="">
                                    <ul class="breadcrumb" style="background:white;margin-top: 0%;">
                                        <li><a class="active" href="<?php echo base_url() ?>index.php?/parametersController/customer_review/1" class="">Customer Review & Details</a> </li>
                                        <li><a class="active" href="#" class=""><?php echo $customerName;?></a> </li>
                                    </ul>
                                </div>
                            </div>
