...
?>
        ...
        $('.radio-success').click(function ()
        {
            if ($(this).attr('id') == 'Freelancer')
            {
                ...
                $('#selected_driver').load('<?php echo base_url() ?>index.php?/superadmin/ajax_call_to_get_types/freelanceDrivers', {accoutType: 1});

            } else
            {
                $('#selected_driver').empty().append('<option>Select</option>');
                $('#company_select').prop('disabled', false);
                $('#selectedOwnerType').val('2');
                $('#selected_driver').prop('disabled', true);
            }
        });
...
//            {
//
//                $("#colorErr").text('Please enter color of vehicle');
//                astatus = false;
//            } 
        ...
        <div class="bg-white" data-pages="parallax">
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <!-- Tab panes -->
                    <form id="addentity" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php?/superadmin/editNewVehicleData/<?php echo $vehId; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane padding-20 slide-left active" id="tab1">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"><img src="<?php echo $vehicleData['image']; ?>" style="width: 35px;height:35px;" class="vehicleImage style_prevu_kit"></div>
...
<!--                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">Color<span style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-6">
                                            <input type="text"  id="color" name="color" required="required" class="form-control error-box-class" value="<?php echo $vehicleData['color']; ?>">
                                        </div>

                                        <div class="col-sm-3 error-box" id="colorErr"></div>
                                    </div>-->
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                         ...
                                         <div class="col-sm-1"><img src="<?php echo $vehicleData['regCertImage']; ?>" style="width: 35px;height:35px;" class="registationCertificate style_prevu_kit"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"><img src="<?php echo $vehicleData['motorInsuImage']; ?>" style="width: 35px;height:35px;" class="motorCertificate style_prevu_kit"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"><img src="<?php echo $vehicleData['permitImage']; ?>" style="width: 35px;height:35px;" class="PermitCertificate style_prevu_kit"></div>
