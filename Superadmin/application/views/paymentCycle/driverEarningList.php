...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php?/superadmin/datatable_referralEarningList/<?php echo $driverID;?>/<?php echo $cycleID;?>',
            "bJQueryUI": true,
...
<div class="page-content-wrapper" >
    ...
    <div class="content">
          <ul class="breadcrumb" style="margin-top: 5%;">
            ...
            <li>
                <a href="#" class="active">REFERRAL DEATILS</a>
            </li>
             </ul>
