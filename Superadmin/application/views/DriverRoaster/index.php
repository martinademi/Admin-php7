...
// category  to get sub cat and for filter
        ...
        $('#zoneFilter').change(function(){           
            ...
            $('#shiftName').load("<?php echo base_url('index.php?/DriverRoaster') ?>/getshiftTimings", {zoneId: zoneId});            
        ...
        $('#searchData').click(function () {
            startDate=$('#start').val();
            endDate=$('#end').val();
            filterData(cityId,zoneId,startDate,endDate);
          ...
          $('#shiftTimings').change(function(){           
            ...
            filterData(cityId,zoneId,startDate,endDate,shiftTimimgs);                      
        });
        ...
        $(document).on('click', '.unassignShift', function () {
            driverId=$(this).val();            
        ...
        // function for filter
        function filterData(cityId='',zoneId='',startDate='',endDate='',shiftTimimgs=''){
            $('#big_table_processing').show();
            $('.cs-loader').show();
            var table = $('#big_table');
            $('#big_table').fadeOut('slow');
            ...
            var settings = {
                ...
                'fnServerData': function (sSource, aoData, fnCallback)
                {
                    ...
                    if(cityId !='' && zoneId !='' &&  startDate!='' && endDate!=''){
                        // && shiftTimimgs != ''
                        console.log('innnnn');
        ...
        $("#unassignShifts").click(function () {

            driverId=driverId;

            $.ajax({                    
                    url: "<?php echo base_url('index.php?/DriverRoaster/unassignShift');?>",
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        driverId:driverId
                            ...
                            <div class="panel panel-transparent">
								...
								<!-- city filter -->
                                    ...
                                    <div class="col-sm-1 hide_show" >
                                     ...
                                     <!-- Shift timings -->
                                     <div class="col-sm-2" style="margin-left:35px;display:none">
                                    ...
                                    <div class="col-sm-1 hide_show pull-right">
                                        <a href="<?php echo base_url() ?>index.php?/DriverRoasterAdd"> 
                                            <button class="btn btn-info" style="width: 125px !important;;margin-left: -26px;" type="button">Create Driver Roaster</button>
                                        </a>
                                    </div>
...
<!-- Modal -->
<div id="unassignModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary pull-right" id="unassignShifts" style="margin:0;">Yes</button>
      </div>
    </div>
