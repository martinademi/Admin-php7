...
<div class="page-content-wrapper">
    ...
    <div class="content">
        <div class="brand inline" style="  width: auto;
             ...
             padding-top: 45px;
             padding-bottom: 10px;">
            <strong style="color:#0090d9;"> Edit Dispensary</strong><!-- id="define_page"-->
        </div>
        <!-- START JUMBOTRON -->
        <div class="bg-white">
            ...
            <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" id="mytabs">
                <li class="tabs_active active" id="firstlitab" onclick="managebuttonstate()">
                    <a id="tb1"><i id="tab1icon" class=""></i> <span><?php echo DETAILS;?></span></a>
                </li>
                            ...
                            <div class="tab-pane padding-20 slide-left active" id="tab1">
                                <div class="row row-same-height">
                                    <div class="form-group"id="bussiness_txt">
                                        ...
                                        <label for="fname" class="col-sm-2 control-label"><?php echo DISPENSARY_NAME;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">  
...
//                                         print_r($val);
                                        ...
                                        <div class="form-group" >
                                            <label for="fname" class=" col-sm-2 control-label"> <?php echo DISPENSARY_NAME. ' (' . $val['lan_name'] . ')'; ?> <span class="MandatoryMarker">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text"  id="businessname_<?= $val['lan_id'] ?>" name="Businessname<?= $val['lan_id'] ?>" value="<?php echo $storeData['name'][$val['lan_id']];?>" class=" businessname form-control error-box-class" >
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo OWNER_NAME;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                            <input type="text"  id="ownername" name="Ownername" value="<?php echo $storeData['ownerName'];?>" class="form-control error-box-class" >
                                        </div>
                                        <div class="col-sm-3" id="text_ownername" style="color:red"></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label "><?php echo OWNER_PHONE;?></label>
                                        <div class="col-sm-6">
                                            <input type="tel" maxlength="10" id="phone" name="Phone" value="<?php echo $storeData['ownerPhone'];?>" class="form-control error-box-class phoneWidth" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo OWNER_EMAIL;?>L<span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                            <input type="text"  id="email" name="Email" value="<?php echo $storeData['ownerEmail'];?>" class="form-control error-box-class" >
                                        </div>
...
<!--                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label "><?php echo BUSINESS_PHONE;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                            <input type="tel" maxlength="10"  id="businessNumber" name="businessNumber" value="<?php echo $storeData['businessNumber'];?>" class="form-control classRight phoneWidth" onkeypress="return isNumberKey(event)" required="">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo WEBSITE;?></label>
                                        <div class="col-sm-6">
                                            <input type="text"  id="website" value="<?php echo $storeData['website'];?>" name="Website"  class="form-control error-box-class" >
                                        </div>
                                    </div>

                                    <div class="form-group" id="description_txt">

                                        <label for="fname" class="col-sm-2 control-label"><?php echo DESCRIPTION;?></label>
                                        <div class="col-sm-6">
                                    ...
                                    foreach ($language as $val) {
                                        ?>
                                        <div class="form-group" >
                                            <label for="fname" class=" col-sm-2 control-label"><?php echo DESCRIPTION;?> (<?php echo $val['lan_name']; ?>)</label>
                                            <div class="col-sm-6">
                                    ...
                                    <?php } ?>
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo COUNTRY;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo CITY;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                            <div id='CityList'>
                                    ...
                                    <div class="form-group" id="Address_txt" >
                                        ...
                                        <label for="fname" class="col-sm-2 control-label "><?php echo BUSINESS_ADDRESS;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control entityAddress" id="entityAddress_0" placeholder="Business Address" name="Address[0]"  aria-required="true"  onkeyup="getAddLatLong1(this)"></textarea>
                                        </div>
...
//                                         print_r($val);
                                        ?>
                                        <div class="form-group" >
                                            <label for="fname" class=" col-sm-2 control-label"><?php echo ADDRESS;?> (<?php echo $val['lan_name']; ?>) <span class="MandatoryMarker">*</span></label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group" id="Address_txt" >
                                        ...
                                        <label for="fname" class="col-sm-2 control-label "><?php echo BILLING_ADDRESS;?></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo SERVICE_ZONES?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6">
...
<!--                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">POS-ID</label>
                                        <div class="col-sm-6">
                                            <input type="test"  id='posID' name="posID" class='errr11 form-control posID'>

                                        </div> 
                                        <div class="col-sm-offset-3 col-sm-6 error-box text_err" id="posIDErr" style=""></div>                                       
                                    </div>-->
                            ...
                            <div class="tab-pane slide-left padding-20" id="tab2" style="border: 2px">
                                <div class="row row-same-height">
                                    <h6 class="textAlign"><?php echo DRIVER_SETTINGS;?></h6>
                                    <hr>

                                    <!--<div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php DRIVERS_TYPE;?></label>
                                        <div class="col-sm-6">
                                            <input type="checkbox" class="drivers_" name="select_driver" id="grocerDriver" value="1" >&nbsp;&nbsp;<label><?php echo COMPANY_POOL;?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" class="drivers_" name="select_driver" id="storeDriver" value="2" >&nbsp;&nbsp;<label><?php echo DISPENSARY_POOL;?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <hr>
                                    <h6 class="textAlign"><?php echo PRICE_SETTINGS;?></h6>
                                    <hr>


                                    <div class="form-group">

                                        <label for="fname" class="col-sm-2 control-label"><?php echo PRICING_MODEL;?></label>
                                        <div class="col-sm-6">
                                            <input type="radio" class="pricing_" name="price" value="0" >&nbsp;&nbsp;<label><?php echo ZONAL_PRICING;?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" class="pricing_" name="price"  value="1" >&nbsp;&nbsp;<label><?php echo MILEAGE_PRICING;?></label>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo MINIMUM_ORDER_VALUE;?> (<?php echo $appConfig['currency']; ?>)</label>
                                    ...
                                    <div class="form-group pos_relative2">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo THRESHOLD_VALUE;?> (<?php echo $appConfig['currency']; ?>)</label>
                                        <div class="col-sm-6 pos_relative2">
                                            <span class="abs_text"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" class="form-control" id="freedelVal" onkeypress="return isNumberKey(event)" placeholder="Threshold Value" name="FreeDeliveryAbove"  aria-required="true" <?PHP echo $enable; ?>>
                                        </div>
                                    ...
                                    <div class="form-group basefare" >
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <label for="fname" class="col-sm-2 control-label"><?php echo BASE_FARE;?> (<?php echo $appConfig['currency']; ?>)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group range">
                                            ...
                                            <label for="fname" class="col-sm-2 control-label"><?php echo RANGE;?> (<?php echo $appConfig['currency']; ?>)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group Priceperkm">
                                            ...
                                            <label for="fname" class="col-sm-2 control-label"><?php echo PRICE;?>/<?php echo $appConfig['distance']; ?> (<?php echo $appConfig['currency']; ?>)</label>
                                            <div class="col-sm-6">
                                    ...
                                    <hr>
                                    <h6 class="textAlign"><?php echo SERVICE_SETTINGS;?></h6>
                                    <hr>

                                    <div class="form-group" >
                                        <label for="fname" class="col-sm-2 control-label"><?php echo ORDER_TYPE;?><span class="MandatoryMarker">*</span></label>
                                        <div class="col-sm-6" id="accepts" >
                                            <input type="radio" name="Accepts" onclick="acceptselect();" class="accepts" id="accepts_1" value="1"><label><?php echo PICKUP;?></label>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="Accepts" onclick="acceptselect();" class="accepts" id="accepts_2" value="2"><label><?php echo DELIVERY;?></label>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="Accepts" onclick="acceptselect();" class="accepts" id="accepts_3" value="3"><label><?php echo BOTH;?></label>
                                        </div>
                                        <div class="col-sm-3" id="text_accepts"></div>
                                    </div>

                                    <hr>
                                    <h6 class="textAlign"><?php echo PAYMENT_SETTINGS;?></h5>
                                        <hr>

                                        <div class="form-group Pickup">
                                            <label for="fname" class="col-sm-2 control-label"><?php echo PAYMENT_METHOD_FOR_PICKUP;?><span class="MandatoryMarker">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="checkbox" class="Pcheckbox_" name="payment[]" id="Pcash" value="1" >&nbsp;&nbsp;<label><?php echo CASH;?></label> 

                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" class="Pcheckbox_" name="payment[]" id="Pcredit_card" value="2" >&nbsp;&nbsp;<label><?php echo CREDIT_CARD;?></label> 
                                        ...
                                        <div class="form-group  Delivery">
                                            <label for="fname" class="col-sm-2 control-label"><?php echo PAYMENT_METHOD_FOR_DELIVERY;?><span class="MandatoryMarker">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="checkbox" class="Dcheckbox_" name="payment[]" id="Dcash" value="1" >&nbsp;&nbsp;<label><?php echo CASH;?></label> 

                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" class="Dcheckbox_" name="payment[]" id="Dcredit_card" value="1" >&nbsp;&nbsp;<label><?php echo CREDIT_CARD;?></label> 
            ...
            function profiletab(litabtoremove, divtabtoremove)
            {
                ...
                if (BusinessName == "" || BusinessName == null) {
                    ...
                    $("#text_email").text("");
                     $("#text_ownername").text("")
                    $("#text_businessname_0").text(" ");
                    $("#text_password").text("Password should be greater than 6 characters");
                    pstatus = false;
                } 
                    ...
                    $("#text_email").text("");
                     $("#text_ownername").text("")
                    $("#text_businessname_0").text(" ");
                    $("#text_entityAddress_0").text("Please select the business address");
                    pstatus = false;
                }
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body"><div class="form-group" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control" id="entityAddress1" placeholder="Address.." name="FData[businessAddress][0]"   onkeyup="getAddLatLong(this)"><?PHP echo $ProfileData['Address'][0]; ?></textarea>
