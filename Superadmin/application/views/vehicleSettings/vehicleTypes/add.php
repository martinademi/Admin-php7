...
<div class="page-content-wrapper">
    ...
    <ul class="breadcrumb" style="margin-left: 0px;margin-top: 5%; ">
        ...
        <li ><a href="#" class="active"><?php echo $this->lang->line('ride_details'); ?></a>
        </li>
                        ...
                        <div class="tab-pane padding-20 slide-left" id="tab2">
                            <form id="secondTabForm" method="post" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php?/vehicle/insert_vehicletype"  enctype="multipart/form-data">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        <label for="seatingCapacity" class="col-sm-2 control-label"><?php echo $this->lang->line('lable_seatig_capacity'); ?><span style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-3">
                                  ...
                                  <!--  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="address" class="col-sm-2 control-label"><?php echo $this->lang->line('label_is_towing_booking'); ?></label>
                                        <div class="col-sm-2">

                                            <div class="switch">
                                                <input id="isTowingEnable" name="isTowingEnable" class="cmn-toggle cmn-toggle-round" type="checkbox" style="display: none;">
                                                <label for="isTowingEnable"></label>
                                            </div>
                                        </div>
                                    </div>-->
