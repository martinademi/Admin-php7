...
Class Mongo_db {
    ...
    public function update($collection = "", $options = array()) {
        ...
        try {
//            $options = array_merge($options, array('w' => $this->write_concerns, 'j' => $this->journal, 'multi' =>TRUE));
     ...
     * @param type $operation - array of aggregate object
     * @return array $returnObj - array of document returns in aggregate command
     */
...
//                $returnObj[] = json_decode(json_encode($document), True);
//            }
            return $cursor;
